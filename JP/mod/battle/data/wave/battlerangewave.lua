...
ys.Battle.BattleRangeWave.Ctor = function (slot0)
	slot0.super.Ctor(slot0)
end

ys.Battle.BattleRangeWave.SetWaveData = function (slot0, slot1)
...
ys.Battle.BattleRangeWave.DoWave = function (slot0)
