...
function slot0.init(slot0)
	slot1 = slot0._tf:Find("bg")
	slot0.bgTF = slot1:GetComponent(typeof(Image))
	...
	slot1[MULTRES] = slot0:findTF("blur_panel/left_panel/toggles/talent")
	slot0.toggleTFs = {
	...
	slot1(slot0.toggleTFs[2], slot0.contextData.mode ~= CommandRoomScene.MODE_SELECT)

	slot1[MULTRES] = CommanderTalentPanel.New(slot0.talentTF)
	slot0.panels = {
