...
function slot0.Ctor(slot0, slot1, slot2)
	...
	slot5 = slot0._tf:Find("frame/bg/content/list/1/icon/iconImg")
	slot5 = slot0._tf:Find("frame/bg/content/list/2/icon/iconImg")
	slot5 = slot0._tf:Find("frame/bg/content/list/3/icon/iconImg")
	slot0.sprites = {
		slot5:GetComponent(typeof(Image)).sprite,
		slot5:GetComponent(typeof(Image)).sprite,
		slot5:GetComponent(typeof(Image)).sprite
	}
end
