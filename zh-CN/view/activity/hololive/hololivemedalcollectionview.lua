...
function slot0.UpdateView(slot0)
	...
	for slot7 = 1, #slot0.taskGroup, 1 do
		...
		slot18 = slot0.medalListItems[uv0[slot7]]:Find("icon")
		slot18:GetComponent(typeof(Image)).enabled = slot14
