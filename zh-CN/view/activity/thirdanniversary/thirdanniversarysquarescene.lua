...
function slot0.didEnter(slot0)
	...
	slot0.InitFacility(slot0._map, slot0._upper, "nvpukafeiting", function ()
		uv0.upgradePanel:Set(uv0.activity, 1)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "xiaolongbaodian", function ()
		uv0.upgradePanel:Set(uv0.activity, 2)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "zhajihanbaodian", function ()
		uv0.upgradePanel:Set(uv0.activity, 3)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "heguozidian", function ()
		uv0.upgradePanel:Set(uv0.activity, 4)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "gangqvchenlieshi", function ()
		pg.m02:sendNotification(GAME.GO_MINI_GAME, 13)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "shujvhuigu", function ()
		uv0:emit(ThirdAnniversarySquareMediator.GO_SCENE, SCENE.SUMMARY)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "xianshijianzao", function ()
		uv0:emit(ThirdAnniversarySquareMediator.GO_SCENE, SCENE.GETBOAT, {
			projectName = "new",
			page = 1
		})
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "huanzhuangshandian", function ()
