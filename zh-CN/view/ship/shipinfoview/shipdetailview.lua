...
function slot0.InitDetail(slot0)
	...
	slot2 = slot0.recordPanel
	slot2 = slot0.recordPanel
	slot1[MULTRES] = slot2:Find("frame/container/record_3/record_btn")
	slot0.recordBtns = {
	...
	slot2 = slot0.recordPanel
	slot2 = slot0.recordPanel
	slot1[MULTRES] = slot2:Find("frame/container/record_3/equipments")
	...
	slot2 = slot0.recordPanel
	slot2 = slot0.recordPanel
	slot1[MULTRES] = slot2:Find("frame/container/record_3/equip_btn")
...
function slot0.InitEvent(slot0)
	...
	onButton(slot0, slot0.lockBtn, function ()
		...
		uv0:emit(ShipMainMediator.ON_LOCK, {
			slot4:GetShipVO().id
		}, slot4:GetShipVO().LOCK_STATE_LOCK)
	end, SFX_PANEL)
	onButton(slot0, slot0.unlockBtn, function ()
		...
		uv0:emit(ShipMainMediator.ON_LOCK, {
			slot4:GetShipVO().id
		}, slot4:GetShipVO().LOCK_STATE_UNLOCK)
	end, SFX_PANEL)
...
function slot0.OnSelected(slot0, slot1)
	if slot1 then
		slot8 = slot0.detailPanel
		slot8 = slot0.detailPanel
		slot7[MULTRES] = slot8:Find("equipments")

		pg.UIMgr.GetInstance():OverlayPanelPB(slot0._parentTf, {
			pbList = {
				slot8:Find("attrs"),
				slot8:Find("equipments")
			},
