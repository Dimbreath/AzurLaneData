...
function slot0.init(slot0)
	...
	slot0.targetTpl = {}
	slot1 = slot0.shootAreaTF

	for slot5 = 1, slot1:Find("tpl").childCount, 1 do
...
function slot0.flushTarget(slot0, slot1)
	...
	for slot6, slot7 in ipairs(slot0.targetCount) do
		for slot11 = 1, slot7, 1 do
			if not slot0.cell[math.random(3)][math.random(6)] and slot1 then
				while slot0.cell[math.random(3)][math.random(6)] or slot1 and slot2[slot12] >= 4 do
