...
开始，随着挑战次数的增加，每次挑战消耗的石油会从
<color=#92fc63>40</color>点逐渐减少至<color=#92fc63>1</color>点。(不会消耗挑战次数)
...
（浅水重炮舰参加战列舰的课程，维修舰、运输舰可以
参加驱逐与巡洋的课程，航战可以参加航母与战列舰
的课程，潜艇、潜母参加驱逐的课程，超巡参加巡洋
的课程）
...
被邀请者：
回归指挥官：
在2020年9月3日至9月17日维护期间没有过登录行为的
指挥官
新人指挥官：
在2020年9月17日至10月12日维护期间新注册的指挥官
满足被邀请资格的指挥官在活动期间登录可在特别活动页
内输入邀请者的UID参与活动
邀请者：
2020年9月3日至9月17日维护前有过登录行为的指挥官
...
1.发现主题
·您可以按照时间、热度排序浏览最新、最热的主题，也
可以通过随机按钮挑选6个主题进行查看
·可以使用他人主题的ID进行直接搜索来寻找主题
·可以对喜欢的主题进行点赞与收藏操作

2.保存并分享自定义主题
※<color=#92fc63>更新前的主题需要在管理界面再次保存才会出现在我的
主题列表中</color>
·最多可以保存5个自定义主题，并分享其中的2个，其他
玩家可以浏览您分享的主题并使用它们
·也可以复制主题的ID，主动将它分享给其他玩家
·在已经上传2个主题的情况下，上传其他主题，或者更新
已经上传的主题，需要先取消分享后再次进行分享
·取消分享或删除主题会清除该主题的点赞与收藏数

3.收藏其他玩家的主题
·最多可以收藏30个主题
·当其他玩家删除或取消分享该主题时，该主题将从我的
收藏列表中移除]]
			}
		}
	},
...
择角色后保持已获得数量不变。]]
	...
	guild_office_tip = {
		tip = {
			...
			{
				info = "10.军需筹备可获取的<color=#92fc63>大舰队资金</color>和<color=#92fc63>筹备进度</color>存在每日上\n限，达到上限后。军需筹备将无法继续提供<color=#92fc63>大舰队资金</color>与\n<color=#92fc63>筹备进度</color>，但是可以正常获得<color=#92fc63>舰队币</color>。"
			},
			{
				info = "11.军需筹备的<color=#92fc63>每日上限次数</color> 为：大舰队人数上限*3 次"
			},
			{
				info = "12.大舰队补给：由舰队司令，副司令花费大舰队资金购\n买的成员福利。"
			},
			{
				info = "13.购买大舰队补给需要消费一定量的大舰队资金，购买\n后<color=#92fc63>14</color>天内，所有大舰队成员每天可领取<color=#92fc63>1</color>份大舰队补给。"
			},
			{
				info = "14.新加入大舰队的成员，当天无法获得大舰队补给，加\n入大舰队第二天，可获得第<color=#92fc63>1</color>份补给(如果该大舰队有购买\n补给)。"
			},
			{
				info = "15.单个成员的大舰队补给最多可储存<color=#92fc63>3</color>份，超过<color=#92fc63>3</color>份未领\n取将无法获得新的大舰队补给。"
			}
		}
	},
...
需要收集「特装原型」进行兑换
 ...
 ■ 「特装原型」可通过以下途径获取：
通过特装原型周常任务，完成每日日常任务每周可以获得
「特装原型」400个
还可以通过出击击破主线、活动、作战档案、主线困难
关卡的BOSS、完成科研项目或退役非改造海上传奇
稀有度角色获得
...
仅当队伍先锋中有未被击破的轻巡或驱逐时，战斗中该
编队将带有反潜声呐侦测敌方潜艇
在反潜声呐侦测范围内的敌方潜艇将被暴露，直至其脱离
反潜声呐侦测范围（部分特殊情况除外）

反潜声呐探索范围的计算方式：
计算反潜探索范围所使用的所有反潜值，仅取船坞角色详
情的白色字体属性部分
1、基础声呐范围
根据先锋编队的驱逐和轻巡角色的反潜值和公式，计算
各自的基础侦测直径：
驱逐基础侦测直径 = 反潜值 / 2 - 32
...
计算各自的基础侦测直径后，取其中的最大基础侦测直径
作为队伍的基础侦测范围

2、额外声呐范围
除基础声呐范围外，还可以通过其他方式增加额外的声呐
范围
基础范围与额外范围相加后，形成实际的反潜声呐侦测范
围
 ·将主力编队所有角色的反潜值合计后，根据公式计算成
额外范围
...
③0点后，重新进入大型作战将使重置生效，指挥官需要
重新部署舰队至大型作战

·<color=#92fc63>重置后大型作战的变化</color>
①重置后大型作战各海域将恢复至未压制状态，所有港口
都默认开放，进入海域后指挥官舰队位于利维浦港口。
未完成的塞壬要塞海域、深渊海域、隐秘海域、安全海域
将会消失
②重置后各个港口的日常任务将会重置，指挥官已经接取
的日常任务将会消失
③重置后大型作战港口将恢复至初始状态。在一个大型
作战周期内，每个港口「补给」随机刷新的商品总体相同
，仅在出现顺序上有所差异；若已于当前周期兑换完所有
的商品，需等到大型作战<color=#92fc63>下一次重置</color>后进行刷新
④重置不会影响海域探索(收集星星)的任务完成进度
⑤重置后，「适应性调整-攻击」、「适应性调整-耐久」
、「适应性调整-恢复」的相关数值将恢复至初始状态
⑥重置后，行动力将恢复至<color=#92fc63>初始状态（200点）</color>

·<color=#92fc63>储物舱与特别兑换商店</color>
①重置后「储物舱」将恢复至初始状态。「储物舱」内
未使用道具将会转化为相应数量的「战备物资兑换券」
指挥官可以点击<color=#92fc63>道具-查看详情</color>查询具体道具的兑换比例
②重置后特别兑换商店中的商品的可兑换次数恢复至初始
状态，指挥官可以使用「战备物资兑换券」进行兑换
③其中，「特别兑换商店」可兑换道具<color=#92fc63>「战役信息记录仪
」</color>。「战役信息记录仪」需在「储物舱」使用，可用于
解除所有海域间的移动限制，跳过重复调查过程，获得所
有海域的<color=#92fc63>调查奖励</color>(不包含压制奖励)
调查奖励包含以下内容：
「适应性调整-攻击」×90、「适应性调整-耐久」×90、
「适应性调整-恢复」×90、「能源补给箱」×45、
