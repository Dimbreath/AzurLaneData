...
·信号接收器的可靠性毋庸置疑，指挥官在离港期间仍会正常接收信号

信号定位
·我们可以对接收到的求救信号进行定位，找到这个信号的来源海域
...
·信号强度每增强1档，可收到的求救信号数量上限增加1件，可定位的海域也能增加1章
·指挥官需要先通关该章节的所有关卡后才能在对应章节搜索到海域救援行动
·信号强度等级越高，完成救援可获得的奖励会变得越丰厚
·以S评价完成当前可定位到的最高章节的救援行动时，信号强度会增强1档
·信号强度决定了指挥官可以存储的信号数量上限，每个信号强度对应一件信号存储上限数量
