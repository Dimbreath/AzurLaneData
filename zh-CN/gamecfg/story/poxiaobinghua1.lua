return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "不过嘛，总体来说没什么大碍，也按时赶到了……咦，苏维埃同盟呢，这次紧急集结不是她下的命令么？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 705050,
			nameColor = "#a9f548",
			say = "很不巧，苏维埃同盟已经在昨天起程去圣彼得伯格开会了，现在这里由我负责。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "最近碧蓝航线正在进行NA海域的大型作战的准备工作。北方联合海军是否参与，参与到何种程度，以什么形式参与，这些都是需要苏维埃同盟参与的重大决定。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 705050,
			nameColor = "#a9f548",
			say = "事关重大，苏维埃同盟本来计划亲自带指挥官过去，可是圣彼得伯格的会议实在推不掉，这件事就只好靠我们来办了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
