...
slot0.Battle.DivingOxyState = class("DivingOxyState", slot0.Battle.IOxyState)
slot0.Battle.DivingOxyState.__name = "DivingOxyState"
slot2 = slot0.Battle.DivingOxyState
