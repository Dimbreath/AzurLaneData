...
function slot0.checkCondition(slot0, slot1)
	...
	if slot0.stepConfig.condition.arg[1] == uv0 then
		slot6.protocol = slot5[2]
		slot6.func = slot2.condition.func
		slot4, slot3 = slot0:checkPtotocol({}, slot1)
	end
...
function slot0.doNextStep(slot0, slot1, slot2)
	...
	slot4.view = slot3.view[#slot3.view]
	slot4.code = slot2
