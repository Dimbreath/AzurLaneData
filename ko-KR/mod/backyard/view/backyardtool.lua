...
function slot0.turnTransformLocalPos(slot0, slot1, slot2)
...
function slot0.createImage(slot0, slot1, slot2, slot3, slot4)
...
function slot0.createAlphaImage(slot0, slot1, slot2, slot3, slot4)
	slot5 = GameObject(slot0)
	slot5:AddComponent(typeof(Image)).raycastTarget = slot1
...
function slot0.getPaths(slot0, slot1, slot2, slot3, slot4)
