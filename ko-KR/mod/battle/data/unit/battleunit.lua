...
function slot9.Tag(slot0, slot1)
	...
	slot3.tagID = slot0._tagIndex
	slot3.requiredTime = slot1:GetLockRequiredTime()
...
function slot9.Detected(slot0, slot1)
	...
	slot8.duration = (slot0._sonarDuration - (pg.TimeMgr.GetInstance():GetCombatTime() - slot0._sonarDetectedStartTime)) * 0.5
...
function slot9.HandleDamageToDeath(slot0)
	slot1.damageReason = uv0.UnitDeathReason.DESTRUCT
...
function slot9.UpdateHP(slot0, slot1, slot2, slot3, slot4)
	...
	slot0:DispatchEvent(uv2.Event.New(uv3.UPDATE_HP, slot13))
...
function slot9.RemoveAutoWeapon(slot0, slot1)
	...
	while 1 <= #slot0._autoWeaponList do
...
function slot9.DispatchChat(slot0, slot1, slot2, slot3)
	slot4.content = HXSet.hxLan(slot1)
