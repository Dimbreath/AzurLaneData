...
function slot7.GetPushPower(slot0)
...
function slot7.InitCldComponent(slot0)
	...
	slot4.type = uv0.Battle.BattleConst.CldType.BULLET
	slot4.IFF = slot0:GetIFF()
	slot4.UID = slot0:GetUniqueID()
