...
function slot0.warpspecialEffect(slot0, slot1)
	...
	if type(slot1.effect_attr) == "table" then
		for slot8, slot9 in ipairs(slot1.effect_attr) do
			slot12[1] = uv0.STRENGTHEN_TYPE_ATTR
			slot12[2] = slot9
			slot12[3] = slot3[slot4 + 1] or ""
	...
	if slot1.effect_breakout ~= 0 then
		slot7[1] = uv0.STRENGTHEN_TYPE_BREAKOUT
		slot7[2] = slot1.effect_breakout
		slot7[3] = slot3[slot4 + 1] or ""
	...
	if type(slot1.effect_skill) == "table" then
		slot7[1] = uv0.STRENGTHEN_TYPE_SKILL
		slot7[2] = slot1.effect_skill
		slot7[3] = slot3[slot4 + 1] or ""
	...
	if type(slot1.change_skill) == "table" then
		slot7[1] = uv0.STRENGTHEN_TYPE_CHANGE_SKILL
		slot7[2] = slot1.change_skill
		slot7[3] = slot3[slot4 + 1] or ""
	...
	if type(slot1.effect_base) == "table" then
		slot7[1] = uv0.STRENGTHEN_TYPE_BASE_LIST
		slot7[2] = slot1.effect_base
		slot7[3] = slot3[slot4 + 1] or ""
	...
	if type(slot1.effect_preload) == "table" then
		slot7[1] = uv0.STRENGTHEN_TYPE_PRLOAD_COUNT
		slot7[2] = slot1.effect_preload
		slot7[3] = slot3[slot4 + 1] or ""
	...
	if type(slot1.effect_dialog) == "table" then
		slot7[1] = uv0.STRENGTHEN_TYPE_DIALOGUE
		slot7[2] = slot1.effect_dialog
		slot7[3] = slot3[slot4 + 1] or ""
	...
	if slot1.effect_skin ~= 0 then
		slot7[1] = uv0.STRENGTHEN_TYPE_SKIN
		slot7[2] = slot1.effect_skin
		slot7[3] = slot3[slot4 + 1] or ""
	...
	if type(slot1.effect_equipment_proficiency) == "table" then
		slot7[1] = uv0.STRENGTHEN_TYPE_EQUIPMENTPROFICIENCY
		slot7[2] = slot1.effect_equipment_proficiency
		slot7[3] = slot3[slot4 + 1] or ""
...
function slot0.getShipVO(slot0)
	slot2.configId = tonumber(slot0.id .. "1")
...
function slot0.specialStrengthens(slot0)
	for slot5, slot6 in ipairs(slot0.strengthenConfig) do
		if slot6.special == 1 then
			slot9.des = slot6.special_effect
			slot9.extraDes = slot6.extra_desc
			slot9.level = slot6.lv
...
function slot0.getTotalAdditions(slot0)
	...
	for slot6, slot7 in ipairs(Ship.PROPERTIES) do
		...
		slot1[slot7] = slot8 + (slot0:attrSpecialAddition()[slot7] or 0)
	end
