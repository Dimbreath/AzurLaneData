...
function slot0.updateExchangeList(slot0, slot1, slot2, slot3)
	...
	slot7.exchangeList = Clone(slot0.exchangeList)
	slot7.flashTime = slot2
	slot7.flagShipFlashTime = slot1
...
function slot0.updateExchangeItemList(slot0, slot1, slot2)
	...
	slot6.flashTime = slot0.nextRefreshItemTime
	slot6.exchangeItemList = slot2
...
function slot0.updateExchangeShip(slot0, slot1, slot2)
	...
	slot6.index = slot1
	slot6.exchangeShip = Clone(slot2)
...
function slot0.getDrawCount(slot0)
	slot1.drawCount1 = slot0.drawCount1
	slot1.drawCount10 = slot0.drawCount10
...
function slot0.removeBuildShipByIndex(slot0, slot1)
	...
	slot6.index = slot1
	slot6.buildShip = slot0.data[slot1]:clone()
