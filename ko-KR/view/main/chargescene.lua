		...
		if not slot1.goods:isMonthCard() then
			if not slot1.goods:isGiftBox() then
				if slot1.goods:isItemBox() then
					...
					slot12.price = numberFormat(slot1.goods:getConfig("money"), ",")
				...
				elseif slot1.goods:isGem() then
					slot6 = numberFormat(slot1.goods:getConfig("money"), ",")
					...
					slot10.price = numberFormat(slot1.goods:getConfig("money"), ",")
