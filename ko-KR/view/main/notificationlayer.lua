...
slot0.FORM_COMMON = 0
slot0.FORM_BATTLE = 1
slot1.send = ChatConst.ChannelWorld
slot3[1] = ChatConst.ChannelAll
slot1.recv = IndexConst.Flags2Bits({})
slot0.ChannelBits = {}
...
function slot0.init(slot0)
	...
	slot2[1] = ChatConst.ChannelAll
	slot2[2] = ChatConst.ChannelWorld
	slot2[3] = ChatConst.ChannelPublic
	slot2[4] = ChatConst.ChannelFriend
	slot2[5] = ChatConst.ChannelGuild
	slot0.textSprites = {}
...
function slot0.didEnter(slot0)
	...
	if slot0.currentForm == uv0.FORM_BATTLE then
		...
		slot5.groupName = slot0:getGroupName()
...
function slot0.appendOthers(slot0, slot1, slot2)
	...
	if slot1.player.id == slot0.player.id then
		...
		slot1.isSelf = true
		slot8.__index = slot1.player.__index
