...
function slot0.didEnter(slot0)
	...
	onButton(slot0, slot0:findTF("top/help"), function ()
		...
		slot2.helps = pg.gametip.newplayer_help_tip.tip
...
function slot0.initToggles(slot0)
	slot1[1] = slot0:findTF("phase1", slot0.togglesTF)
	slot1[2] = slot0:findTF("phase2", slot0.togglesTF)
...
function slot0.switchPage(slot0, slot1)
	...
	if slot1 == slot0.phaseId and function ()
		...
		slot13.activity_id = slot0.activity.id
