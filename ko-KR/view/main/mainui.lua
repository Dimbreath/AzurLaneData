...
function slot0.displayShipWord(slot0, slot1)
	...
	if string.split(slot1, "_")[1] == "main" then
		slot4, slot6, slot5 = ShipWordHelper.GetWordAndCV(slot0.flagShip.skinId, slot3[1], tonumber(slot3[2]), nil, slot0.flagShip:getIntimacy() / 100 + (slot0.flagShip.propose and 1000 or 0))
