...
function slot0.OnInit(slot0)
	...
	onButton(slot0, slot0.helpBtn, function ()
		if pg.gametip.comic_help then
			...
			slot2.helps = pg.gametip.comic_help.tip
...
function slot0.checkAward(slot0)
	...
	if #slot1:getActivityById(ActivityConst.JAVELIN_COMIC_PUZZLE_TASK).data1_list == #slot0.puzzleIDList and slot1.data1 == 0 then
		slot5.activity_id = ActivityConst.JAVELIN_COMIC_PUZZLE_TASK
