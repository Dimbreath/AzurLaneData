...
function slot0.OnFirstFlush(slot0)
	...
	onButton(slot0, slot0.bg:Find("help"), function ()
		...
		slot2.helps = pg.gametip.pocky_help.tip
...
function slot0.SetAction(slot0, slot1)
	...
	if slot2:GetComponent("SpineAnimUI") then
...
function slot0.OnUpdateFlush(slot0)
	...
	if slot0.usmLRQ and slot0.usmLRQ.name ~= (slot0.startDay < slot0.GetCurrentDay() and "juu_factory_rest" or "juu_factory") then
		slot0.usmLRQ:Stop()
...
function slot0.UpdateTaskList(slot0)
	...
	slot24.type = slot23[1]
	slot24.id = slot23[2]
	slot24.count = slot23[3]
...
function slot0.UpdatePTList(slot0)
	...
	slot3 = slot0.ptData
	slot12, slot13 = slot3:GetResProgress()
