...
function slot0.didEnter(slot0)
	...
	onButton(slot0, slot0._helpBtn, function ()
		...
		slot2.helps = pg.gametip.help_newyear_feast.tip
	...
	onButton(slot0, slot0.btn_shouce_help, function ()
		slot2.type = MSGBOX_TYPE_HELP
		slot2.helps = pg.gametip.help_newyear_stamp.tip
	...
	slot0:InitFacility(slot0.divination, function ()
		slot4.id = ActivityConst.CYGNET_BATHROBE_PAGE_ID
...
function slot0.UpdateView(slot0)
	...
	setText(slot0.yinhuaceTimes, string.format("%02d", slot2.usedtime))
