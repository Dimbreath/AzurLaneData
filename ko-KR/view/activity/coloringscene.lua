...
function slot0.didEnter(slot0)
	...
	onButton(slot0, slot0.btnHelp, function ()
		...
		slot2.helps = i18n("coloring_help_tip")
...
function slot0.updateCells(slot0)
	...
	slot4:AddPointClickFunc(function (slot0, slot1)
		...
		if uv2:getState() == ColorGroup.StateColoring then
			function slot6()
				slot3.activityId = uv0.activity.id
				slot3.id = uv1.id
				slot3.cells = uv0:searchColoringCells(uv1, uv2, uv3, uv0.selectedColorIndex)
