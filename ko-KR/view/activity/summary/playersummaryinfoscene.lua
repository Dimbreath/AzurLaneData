...
function slot0.initSummaryInfo(slot0)
	...
	slot1[1] = SummaryPage1.New(slot0:findTF("page1", slot0.pageContainer))
	slot1[2] = SummaryPage2.New(slot0:findTF("page2", slot0.pageContainer))
	slot1[3] = SummaryPage3.New(slot0:findTF("page3", slot0.pageContainer))
	slot1[4] = SummaryPage4.New(slot0:findTF("page4", slot0.pageContainer))
	slot1[5] = SummaryPage4.New(slot0:findTF("page4_1", slot0.pageContainer))
	slot1[MULTRES] = SummaryPage5.New(slot0:findTF("page5", slot0.pageContainer))
	slot0.pages = {}
