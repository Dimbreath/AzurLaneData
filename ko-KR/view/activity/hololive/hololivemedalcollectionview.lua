...
function slot0.AddListener(slot0)
	...
	onButton(slot0, slot0.helpBtn, function ()
		...
		slot2.helps = pg.gametip.hololive_dalaozhang.tip
...
function slot0.DataSetting(slot0)
	if #slot0.activatableIDList > 0 then
		...
		if slot2 then
			slot6.id = slot2
			slot6.actId = ActivityConst.HOLOLIVE_MEDAL_COLLECTION
...
function slot0.GetFinal(slot0)
	if #slot0.activeIDList == #slot0.allIDList and slot0.actMedal.data1 ~= 1 then
		slot4.activity_id = ActivityConst.HOLOLIVE_MEDAL_COLLECTION
