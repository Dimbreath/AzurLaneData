...
function slot0.createDecoration(slot0, slot1)
	slot2.go = slot1
	slot2.maskTF = slot0:findTF("mask", slot1)
	slot2.iconImg = slot0:findTF("icon", slot1):GetComponent(typeof(Image))
	slot2.comfortableTF = slot0:findTF("comfortable/Text", slot1)
	slot2.newTF = slot0:findTF("new_bg", slot1)
	slot2.add = slot0:findTF("Add", slot1)
	slot2.count = slot0:findTF("count", slot1)
	...
	function slot2.updateTheme(slot0, slot1, slot2)
