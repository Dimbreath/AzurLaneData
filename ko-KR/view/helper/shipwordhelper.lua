...
function slot12(slot0, slot1, slot2, slot3)
	...
	if uv4(slot8) and not slot7 then
		if slot3 then
			slot3[1] = true
		end
...
function slot0.GetWordAndCV(slot0, slot1, slot2, slot3, slot4)
	slot5 = nil
	slot7[1] = slot2
	slot11, slot9 = uv0(slot0, slot1, {}, slot4, {
		false
	})
	...
	if not uv4(slot0, slot1, slot2) then
		slot10, slot11 = uv5(slot0, slot1, slot7, not slot6[1])
...
function slot0.ExistDifferentExWord(slot0, slot1, slot2, slot3)
	...
	return not uv3(uv2(slot0, slot5, {}, slot3)) and slot6 ~= uv2(slot4, slot5, {}, slot3)
end

function slot0.ExistExCv(slot0, slot1, slot2, slot3)
	slot7[1] = slot2
	slot4, slot5 = uv0(slot0, slot1, {}, slot3)
