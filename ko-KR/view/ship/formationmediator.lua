...
function slot0.register(slot0)
	...
	slot0:bind(uv0.CHANGE_FLEET_SHIP, function (slot0, slot1, slot2, slot3, slot4)
		...
		slot20.onShip, slot20.confirmSelect, slot20.onSelected = uv1.getDockCallbackFuncs(uv0, slot1, slot2, slot4)
		slot20.shipVOs = Clone(slot9)
		slot20.activeShipId = slot7
		slot20.selectedMin = slot5
		slot20.leastLimitMsg = i18n("ship_formationMediator_leastLimit")
		slot20.quitTeam = slot6
		slot20.teamFilter = slot4
		slot20.leftTopInfo = i18n("word_formation")
		slot20.flags = slot8
		slot20.preView = uv0.viewComponent.__cname
...
function slot0.getDockCallbackFuncs(slot0, slot1, slot2, slot3)
	...
	return function (slot0, slot1)
		...
		slot7.content = i18n("ship_formationMediator_quest_replace", slot4.defaultName)
		slot7.onYes = slot1
...
function slot0.getDockCallbackFuncsForExercise(slot0, slot1, slot2, slot3)
	...
	return function (slot0, slot1)
		...
		slot3, slot4 = uv0.checkChangeShip(uv1, uv2, slot0)
