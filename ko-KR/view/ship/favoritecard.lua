...
function slot1(slot0)
	slot1 = {
		go = slot0,
		tr = tf(slot0),
		icon = slot1.tr:Find("icon"),
		iconImg = slot1.icon:GetComponent(typeof(Image)),
		stars = findTF(slot1.tr, "stars"),
		starTpl = findTF(slot1.stars, "star"),
		name = findTF(slot1.tr, "name"):GetComponent(typeof(Text)),
		unkonwn = findTF(slot1.tr, "unkonwn"),
...
function slot0.update(slot0, slot1, slot2, slot3)
	...
	for slot11, slot12 in pairs(slot4) do
		slot15.configId = slot11 * 10 + 1

		slot12:update(Ship.New({}), slot2[slot11])
...
function slot0.updateBound(slot0)
	...
	slot1 = slot0.favoriteVO
	slot2 = slot0.favoriteVO
	slot3 = slot2:getConfig("award_display")[slot1:getNextAwardIndex(slot0.awards)] and slot2[slot1] or slot2[#slot2]
	slot6.type = slot3[1]
	slot6.id = slot3[2]
	slot6.count = slot3[3]
	...
	slot4 = slot0.favoriteVO
	slot0.starCount.text = slot0.favoriteVO:getStarCount(slot0.shipGroups) .. "/" .. (slot4:getConfig("level")[slot1] or slot4[#slot4])
end
