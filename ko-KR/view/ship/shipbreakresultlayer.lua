...
function slot0.updateStatistics(slot0)
	...
	slot17, slot18, slot22 = ShipWordHelper.GetWordAndCV(slot1.skinId, ShipWordHelper.WORD_TYPE_UPGRADE, nil, nil, slot1:getIntimacy() / 100 + (slot1.propose and 1000 or 0))
