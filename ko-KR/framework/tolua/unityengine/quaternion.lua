...
function slot22.SetFromToRotation(slot0, slot1, slot2)
	...
	elseif slot3 < -0.999999 then
		...
		slot27[1] = -slot1.x * slot1.x + slot7[1] * slot7[1] + -slot4[1] * slot4[1]
		slot27[2] = slot11 + slot17 + slot23
		slot27[3] = slot12 + slot18 + slot24
		slot26[1] = {}
		slot27[1] = slot11 + slot17 + slot23
		slot27[2] = -slot1.y * slot1.y + slot7[2] * slot7[2] + -slot4[2] * slot4[2]
		slot27[3] = slot13 + slot19 + slot25
		slot26[2] = {}
		slot27[1] = slot12 + slot18 + slot24
		slot27[2] = slot13 + slot19 + slot25
		slot27[3] = -slot1.z * slot1.z + slot7[3] * slot7[3] + -slot4[3] * slot4[3]
		slot26[3] = {}
		...
		slot12[1] = slot3 + slot6 * slot4.x
		slot12[2] = slot8 - slot4.z
		slot12[3] = slot9 + slot4.y
		slot11[1] = {}
		slot12[1] = slot8 + slot4.z
		slot12[2] = slot3 + slot5 * slot4.y * slot4.y
		slot12[3] = slot10 - slot4.x
		slot11[2] = {}
		slot12[1] = slot9 - slot4.y
		slot12[2] = slot10 + slot4.x
		slot12[3] = slot3 + slot7 * slot4.z
		slot11[3] = {}
...
function slot26(slot0, slot1, slot2)
	...
	if slot3 < 0.95 then
		...
		slot8.x = slot0.x * slot6 + slot1.x * slot7
		slot8.y = slot0.y * slot6 + slot1.y * slot7
		slot8.z = slot0.z * slot6 + slot1.z * slot7
		slot8.w = slot0.w * slot6 + slot1.w * slot7
		slot0 = {}
		...
		slot4.x = slot0.x + slot2 * (slot1.x - slot0.x)
		slot4.y = slot0.y + slot2 * (slot1.y - slot0.y)
		slot4.z = slot0.z + slot2 * (slot1.z - slot0.z)
		slot4.w = slot0.w + slot2 * (slot1.w - slot0.w)
		slot0 = {}
