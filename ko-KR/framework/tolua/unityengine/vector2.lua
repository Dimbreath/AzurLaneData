...
function slot6.Reflect(slot0, slot1)
	...
	slot8.x = slot6 * slot4 + slot2
	slot8.y = slot6 * slot5 + slot3
...
function slot6.Lerp(slot0, slot1, slot2)
	...
	slot4.x = slot0.x + (slot1.x - slot0.x) * slot2
	slot4.y = slot0.y + (slot1.y - slot0.y) * slot2
...
function slot6.MoveTowards(slot0, slot1, slot2)
	...
	if slot5 * slot5 + slot6 * slot6 > slot2 * slot2 and slot7 ~= 0 then
		...
		slot9.x = slot3 + slot5 * slot7
		slot9.y = slot4 + slot6 * slot7
...
function slot6.SmoothDamp(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	return uv2({}, uv3), slot2
end

function slot6.Max(slot0, slot1)
	slot3.x = uv1.max(slot0.x, slot1.x)
	slot3.y = uv1.max(slot0.y, slot1.y)

	return uv0({}, uv2)
end

function slot6.Min(slot0, slot1)
	slot3.x = uv1.min(slot0.x, slot1.x)
	slot3.y = uv1.min(slot0.y, slot1.y)

	return uv0({}, uv2)
end

function slot6.Scale(slot0, slot1)
	slot3.x = slot0.x * slot1.x
	slot3.y = slot0.y * slot1.y
...
function slot6.__div(slot0, slot1)
	slot3.x = slot0.x / slot1
	slot3.y = slot0.y / slot1
...
function slot6.__mul(slot0, slot1)
	if type(slot1) == "number" then
		...
		slot3.x = slot0 * slot1.x
		slot3.y = slot0 * slot1.y
