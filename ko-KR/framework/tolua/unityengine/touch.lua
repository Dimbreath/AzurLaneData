...
function slot5.New(slot0, slot1, slot2, slot3, slot4, slot5, slot6)
	slot8.fingerId = slot0 or 0
	slot8.position = slot1 or uv1
	slot8.rawPosition = slot2 or uv1
	slot8.deltaPosition = slot3 or uv1
	slot8.deltaTime = slot4 or 0
	slot8.tapCount = slot5 or 0
	slot8.phase = slot6 or 0
