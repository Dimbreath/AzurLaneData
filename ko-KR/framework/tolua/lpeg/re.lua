...
slot22 = slot20 * "<-"
slot21 = slot5.C(slot5.R("AZ", "az", "__") * slot5.R("AZ", "az", "__", "09")^0)
...
slot35.Exp = slot20 * (slot5.V("Grammar") + slot5.Cf(slot5.V("Seq") * ("/" * slot20 * slot5.V("Seq"))^0, slot7.__add))
slot35.Seq = slot5.Cf(slot5.Cc(slot5.P("")) * slot5.V("Prefix")^0, slot7.__mul) * (#(slot5.P("/") + ")" + "}" + ":}" + "~}" + "|}" + slot21 * slot22 + -1) + slot17)
slot35.Prefix = "&" * slot20 * slot5.V("Prefix") / slot7.__len + "!" * slot20 * slot5.V("Prefix") / slot7.__unm + slot5.V("Suffix")
slot35.Suffix = slot5.Cf(slot5.V("Primary") * slot20 * ((slot5.P("+") * slot5.Cc(1, slot7.__pow) + slot5.P("*") * slot5.Cc(0, slot7.__pow) + slot5.P("?") * slot5.Cc(-1, slot7.__pow) + "^" * (slot5.Cg(slot25 * slot5.Cc(function (slot0, slot1)
	slot2 = uv0.P(true)
...
slot35.Primary = "(" * slot5.V("Exp") * ")" + slot26 / slot6.P + "[" * slot5.C(slot5.P("^")^-1) * slot5.Cf(slot29 * (slot29 - "]")^0, slot7.__add) / function (slot0, slot1)
...
slot35.Definition = slot21 * slot22 * slot5.V("Exp")
slot35.Grammar = slot5.Cg(slot5.Cc(true), "G") * slot5.Cf(slot5.V("Definition") / function (slot0, slot1)
	slot3[1] = slot0
...
slot40 = {
	...
	match = function (slot0, slot1, slot2)
		...
		return slot3.match(slot3, slot0, slot2 or 1)
	end,
	find = function (slot0, slot1, slot2)
		if not uv0[slot1] then
			slot5[1] = uv2.Cp() * uv1(slot1) / 0 * uv2.Cp() + 1 * uv2.V(1)
			uv0[slot1] = uv2.P({})
		end

		slot4, slot5 = slot3.match(slot3, slot0, slot2 or 1)
