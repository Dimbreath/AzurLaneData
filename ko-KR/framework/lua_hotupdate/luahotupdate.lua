function slot0.FailNotify(...)
	if uv0.NotifyFunc then
		uv0.NotifyFunc(...)
	end
end

function slot0.DebugNofity(...)
...
function slot0.InitFileMap(slot0)
	for slot4, slot5 in pairs(slot0) do
		...
		for slot10 = 0, slot6.Count - 1, 1 do
			if string.match(slot6:get_Item(slot10), ".*\\(.[_a-zA-Z][_a-zA-Z0-9]*)%.lua") ~= nil then
				...
				slot16.SysPath = slot11
				slot16.LuaPath = slot13
...
function slot0.AddFileFromHUList()
...
function slot0.ErrorHandle(slot0)
	uv0.FailNotify("HotUpdate Error\n" .. tostring(slot0))

	uv0.ErrorHappen = true
end

function slot0.BuildNewCode(slot0, slot1)
	io.input(slot0)
...
function slot0.ReplaceOld(slot0, slot1, slot2, slot3, slot4)
...
function slot0.HotUpdateCode(slot0, slot1)
...
function slot0.ResetENV(slot0, slot1, slot2, slot3)
	slot4 = {}
...
function slot0.UpdateUpvalue(slot0, slot1, slot2, slot3, slot4)
...
function slot0.UpdateOneFunction(slot0, slot1, slot2, slot3, slot4, slot5)
...
function slot0.UpdateAllFunction(slot0, slot1, slot2, slot3, slot4)
	if uv0.Protection[slot0] or uv0.Protection[slot1] then
		return
	end
