...
function slot10()
	slot0.handlers = uv0.New()
	slot0.pre_emits = uv0.New()
	slot0.post_emits = uv0.New()
	slot0.blocked_handlers = {}
	slot0.subevents = {}
...
function slot8.emit_with_accumulator(slot0, slot1, slot2, ...)
	...
	slot7.event_name = slot1
	slot7.accumulator = slot2
	slot8[MULTRES] = ...
	slot7.args = {}
