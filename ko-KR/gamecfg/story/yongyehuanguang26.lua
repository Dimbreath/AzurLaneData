return {
	...
	scripts = {
		...
		{
			say = " 퍼시어스가 딱 맞춰 지원을 와주었다. 그리고 함재기가 투하한 폭탄이 오히려 도이칠란드의 몸을 관통했다. 넓은 해수면 위에서만 공허한 물보라가 일었다.",
			side = 2,
			dir = 1,
		...
		},
		{
			...
			dir = 1,
			actor = 403040,
			say = "놀랐지? 하등 동물들! 우리 메탈 블러드의 과학 기술은 세계 제일이야!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			side = 2,
			dir = 1,
			say = "방자한 웃음소리와 함께 도이칠란드의 몸이 점점 투명해지다가 마지막에는 완전히 사라졌다.",
			effects = {
				{
					active = false,
					name = "speed"
		...
		},
		{
			side = 2,
			dir = 1,
			say = " 거의 동시에 티르비츠, 샤른호르스트, 그나이제나우, 히퍼….나머지 메탈 블러드 주력들도 환영처럼 도이칠란드를 따라 함께 사라졌다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = " …레이더를 속이는 것뿐만 아니라 우리의 눈도 속였어. 메탈 블러드에서 이미 우리가 모르는 개념의 방해 설비를 완성한건가…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
