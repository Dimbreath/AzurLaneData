return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "지휘 체계가 없는 세이렌은 강하지만 작전은 단순하지. 물론 나도 알고 있었지만…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "동쪽 방어도 순조로웠으면 좋겠네요. 그쪽은 우리보다 훨씬 심각할 테니까요…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "걱정 마라. 잠시 엔터프라이즈가 없다고 해도 에식스가 지휘를 맡았으니 괜찮을 거다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "포대가 파괴되었군… 역시 순조롭지는 않은 건가. 리노, 브레머튼. 전선의 상황은?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "모든 것을 바쳐서라도 파나마 요새를 파괴하겠다, 아무래도 죽으라는 명령을 받은 것 같군…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "필요하다면 인간형 지휘함도 버릴 수 있다. 세이렌의 사전에는 동료애 같은 건 존재하지 않는 모양이군.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "세이렌의 지휘 시스템이 드디어 등장한 모양이니… 계속 도박을 할 수는 없지.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
