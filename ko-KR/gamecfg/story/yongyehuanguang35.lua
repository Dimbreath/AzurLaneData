return {
	...
	scripts = {
		...
		},
		{
			side = 2,
			dir = 1,
			say = " 스캐빈저의 빛줄기가 해수면 위에서 거리낌없이 내려쬐고 있었다. 밸리언트와 하우는 그것과 맴돌면서, 필살의 시기를 기다리고 있었다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 205100,
			say = "…인정할게. 예전에는 널 쉽게 봤어. 아무리 믿을만한 구석이 없어보여도, 어쨌든 세이렌의 고급형인데…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = " '아무리 믿을만한 구석이 없어보여도'라는 말은 쓸데없는 거야! 흥! 진작에 이랬으면 그런 헛고생은 필요없었을텐데.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "어쨌든 데이터도 거의 수집됐고, 내가 시간이 없어서 넌 한방에 처리해줄게!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			side = 2,
			dir = 1,
			say = " 스캐빈저가 멀지 않은 곳에 있는 밸리언트를 겨눠 주포를 작동시켰다. 하지만 빛무리가 오히려 명중하기 전, 위기일발의 순간을 벗어나게 만들었다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 201330,
			say = " 하우…시야와 레이더 상에서 모두 스캐빈저의 종적을 찾을 수가 없어!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
