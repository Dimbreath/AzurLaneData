	...
	scripts = {
		{
			...
			actor = 408060,
			nameColor = "#ff5c5c",
			say = "으윽…U-81, 나의 대어가 방금 심해폭탄에 명중당했어!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 408070,
			say = " 으…양산형 함대도 곧 못버티겠어. 철수를 생각해볼 때가 됐지?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 202270,
			nameColor = "#a9f548",
			say = "후우…하지만 제 생각에는 이번 습격 후 정말 끝난 것 같아요. 메탈 블러드도 수면 밑에 더 큰 규모의 늑대들을 매복시키진 않았을 거에요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 202270,
			nameColor = "#a9f548",
			say = " 극지 선단 36척의 운송선 중, 4척이 침몰했고, 3척은 엔진을 잃었으며, 그외 몇 척은 경미한 손상을 입었어요…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 202270,
			nameColor = "#a9f548",
			say = "상대방은 그래도 여전히 오랫동안 바다에서 사는 늑대들이니까요… 이글님, 너무 자책마세요. 우리는 최선을 다했어요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
