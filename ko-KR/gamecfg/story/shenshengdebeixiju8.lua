return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "안녕하세요. 전보를 받고 바로 로열 본섬에서 출발했답니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "밤에도 명령을 내릴 수 있는 장비가 필요해요. 제 함재기들이 멀리서도 볼 수 있도록 말이죠.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "부족해요. 비상 시에 확실히 구분할 수 있는 것이 필요한데… 어디어디, 생각을 해봐야겠네요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
