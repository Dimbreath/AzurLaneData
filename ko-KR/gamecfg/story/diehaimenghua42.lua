return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900230,
			actorName = "컴파일러",
			say = "중재 기관의 현재 임무는 「코드 G」에 대항하는 것, 그리고 잔해가 각 실험장에 미치는 영향을 줄이는 것. 오히려 자신이 이렇게 큰 소리를 내면 어떡해.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "퓨리파이어",
			say = "그래. 나중에 잔해와 관련된 귀찮은 일은 모두 중재 기관에 떠넘길 수 있어. 그러면 우리도 방해받지 않고 실험할 수 있을 거야~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
