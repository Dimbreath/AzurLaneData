return {
	...
	scripts = {
		...
		},
		{
			...
			say = "자재는 그냥 제공된 게 아니다냥. 이번 이벤트로 번 만큼, 확실히 회수할테다냥.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "으음, 다른 차원의 게임 기술……처음 느껴보는 데이터뿐이라 신선하구나! 이걸 참고로 새 장비를 만들 순 없겠나?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		{
			say = "뭐…… 게임업계의 여신이라면, 게임 디스크 정도는 당연히 늘 갖고 다니지…… 아하하하하하. (우연치않게 갖고 있었다고 이제 와서 말할 순 없지……)",
			side = 0,
			bgName = "bg_story_school",
			dir = 1,
			actor = 10100020,
		...
		},
		{
			...
			say = "저도 감복했습니다… 클래스가 다른 '기획력' 과 '프로듀서력' 이에요…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "알아서 어떻게 좀 해보세요, 에요…… 여기도 지금 다 써버린 겁니다!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		{
			say = "우후후후…… 아직 멀었네요, 신병이라 그런 거겠죠? 전략 FPS에서 이 언니에게 이길 수 있을 거라 생각했나요?",
			side = 0,
			bgName = "bg_story_school",
			dir = -1,
			actor = 10100040,
		...
		},
		{
			...
			actor = 301110,
			actorName = "{namecode:13}",
			say = "네푸네푸가 허둥지둥하는 사이에 '고~올!' '위닝 런' 은 이이 이카즈치 님 거라고~!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		{
			say = "몇 판을 한다 해도 넵튠이 지는 건 불 보듯 뻔해. 이 애들이 더 잘 하는걸.",
			side = 0,
			bgName = "bg_story_school",
			dir = 1,
			actor = 10100020,
		...
		{
			say = "네에 네에 여기로 오십쇼~ 엘리자베스! 어떤 게 좋아~? ",
			side = 1,
			bgName = "bg_story_school",
			dir = 1,
			actor = 10100010,
