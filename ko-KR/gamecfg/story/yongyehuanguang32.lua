return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actor = 201330,
			say = " 음…왠지 약간 이상한 곳이 있는 것 같아서. 아마도 내가 생각이 많은 것 뿐일거야…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 201330,
			say = " 이번 세이렌이 노스 유니온의 봉쇄선을 뚫은 것은 분명 매우 강한 화력이 집중되어서겠지…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 201330,
			say = " 그렇지만 지금은 수량이 많고, 인트루더가 조금 귀찮은 것 외에 뭔가가 빠진 것 같아…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "통신기",
			say = " 드디어 발견했나? 둔한 녀석들. 기다리다 못참을 뻔했네!",
			dialogShake = {
				speed = 0.09,
				x = 10,
				number = 2
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = " 바렌츠해의 인트루더…넌 네 스스로를 얼음바다 속에서 얼어 있게 할 생각이야?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = " 안타깝게도 자메이카가 호송 함대에 배치되었어. 안그랬으면 둘이 교류가 되었을 것 같은데…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
