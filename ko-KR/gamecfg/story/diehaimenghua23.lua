	...
	scripts = {
		{
			...
			actor = 307080,
			nameColor = "#a9f548",
			say = "만약 머릿속의 정보가 정말이라면, 이 세계에는 세이렌도 잔해도 존재하지 않아. 그저 각 진영 사이에 다툼이 존재할 뿐이지.",
			flashin = {
				delay = 0.5,
				dur = 0.5,
				black = true,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "신석 해약도, 하늘 기원제도 없어. 나는 그저 서둘러 건조되어서 곧 무너질 것 같은 전선에 투입된 존재지.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "엣, 그런가! 시나노님만 그런게 아니라 다들 정신이 없구나…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "벌써 저녁 10시니까 졸려… 유키카제는 졸립지 않아?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "흐흥~ 유키카제님이 세 방향을 돌아봤지만 적은 발견하지 못했어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "이상하네… 분명히 이글 유니온 잠수함의 레이더 신호를 포착했는데, 추격을 포기한건가… 그러면 남은 한쪽도 잘 부탁해.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "유키카제의 운이 너무 좋아서 적도 피해간 거라고 해야 하나……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "적이 수면 아래로 들어간다! 시나노님, 잠수함 한 척일 뿐이니 나에게 맡겨줘!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
