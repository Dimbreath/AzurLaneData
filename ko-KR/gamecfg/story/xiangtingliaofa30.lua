return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actorName = "？？？",
			say = "우리의 판단이 옳았던 모양이야, 안티오코스가 고의로 감춰놓은 이 시간의 특이점은…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actorName = "？？？",
			say = "어리석기는! 뉴욕항 습격은 그저 안티오코스가 너흴 이곳으로 속여 끌고 오려는 음모였을 뿐이다, 너희는 처음부터 평범한 기계에게 이용당한 것이다!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "다들 집중~! 버뮤다 삼각지대에 출현한 \"특이점은 이미 성공적으로 닫혔어요!\" (우리가 한 건 아니지만)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
