return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "반짇고리는 방금 서포크가 일하다가 단추가 떨어져서 꿰매려고 준비한 거였어. 다행히 아직 가지고 있었지~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "옷이 너무 얇은 거 아니야? 음... 옷이 불편하면, 움직이기도 불편할텐데...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "응? 지휘관 왜 그래? 방금 전부터 계속 이상한 것 같은데?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "하지만, 나중에 그래도 기회를 잡아서 이 일에 대해 얘기를 나눠보자...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
