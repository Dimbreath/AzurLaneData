return {
	...
	scripts = {
		...
		{
			say = "그것은 이번 연습함대에 폐하가 편성되었기 때문이옵니다.",
			side = 1,
			bgName = "star_level_bg_103",
			dir = 1,
			actor = 202120,
		...
		},
		{
			...
			bgName = "star_level_bg_103",
			dir = 1,
			say = "……지금의 그나이제나우는 도이칠란트의 말을 따랐다기보단, 그대로 말을 적당히 받아쳐 준 것뿐인 거 같은데……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_103",
			dir = 1,
			say = "도이칠란트의 이런 태도에는 이미 익숙하다는 반응이었다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
