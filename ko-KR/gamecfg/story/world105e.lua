return {
	...
	scripts = {
		...
		},
		{
			side = 2,
			dir = 1,
			say = "무심코 먼 곳에 있는 잔해와 눈이 마주쳤다... 입꼬리는 살짝 올라가 있었지만 눈은 전혀 웃고 있지 않았다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107060,
			nameColor = "#a9f548",
			say = "대체 무슨 일이 일어났던 거지? 쿄카와 잔해, 그리고 세이렌은 무슨 관계가 있는 거야?!",
			effects = {
				{
					active = false,
					name = "memoryFog"
		...
		},
		{
			...
			actor = 9707010,
			actorName = "？？？",
			say = "꽤 많이 알고 있는 모양인데. 안티오코스가 너희를 끌어들이는 수단인가...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			side = 2,
			dir = 1,
			say = "하지만 잔해의 말이 맞아. 우리 속도로는 쫓아갈 수 없어... 일단 지금은 지휘부에 보고부터 하자.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
