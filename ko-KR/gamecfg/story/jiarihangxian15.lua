return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actor = 10600030,
			say = "여러분과 지휘관 님 덕분에 무사히 돌아갈 수 있게 되었습니다…감사합니다!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 10600070,
			say = "기회가 된다면, 꼭 비너스 제도에 초대하고 싶어요~ 차라리…우리랑 같이 돌아가는 건 어때요? 지휘관 님, 그리고 함선 여러분~?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "그동안 아카시가 도와줘서 고마웠어, 아카시! 아, 지휘관 님과 다른 여러분들도 물론~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
