return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = " 하아…그러면 정말 대단히 고맙네! 그저 비행기 몇대인데, 뭐 신기할 것이 있다고! 함대를 방공대형으로 놓고, 저것들을 모두 떨어뜨려!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 401020,
			say = " 필요없게 됐어. 히퍼, Z36, 우리의 작전은 끝났으니 철수 준비해.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 401020,
			say = "계획 외의 세이렌 함대가 끼어들려고 오나봐. 우린 적당히 물러나자고.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 202080,
			nameColor = "#a9f548",
			say = " 메탈 블러드 함대가 철수하기 시작했어. 역시 대형 함대의 손상 위험을 더 이상 지고 싶지 않아서인가…?",
			flashout = {
				dur = 0.5,
				black = true,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = " 메탈 블러드 함대가 도망가려 하면 도망가게둬. 우리는 상대해야할 더 큰 방해물이 있어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
