return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 603020,
			nameColor = "#a9f548",
			say = "차라가 도와드릴 것이라도 있나요? 너무 고민하지 않아도 돼요. 어떤 것이든 괜찮으니까요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 603020,
			nameColor = "#a9f548",
			say = "그렇다면 지휘관님, 먼저 제 다리에 누워주세요. 긴장하지 말고 편안하게요.",
			flashout = {
				dur = 0.5,
				black = true,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "차라의 서비스가 끝나기 전까지 지휘관님은 잠들어선 안된다고요?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
