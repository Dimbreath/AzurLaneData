return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "창춘의 기술 지원과 내 실험 덕분에 시대를 앞서 나간 ‘안샨 7호’가 드디어 성공했어!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "맞아! 연발 폭죽을 아주아주 많이 모아서 만든 거라고! 여기에 불을 붙이면……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "핑하이랑 닝하이 만두 빚는 거 도와주러 간 것 아니야? 왜 여기서 놀고 있는 건데!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "음… 그러니까… 유키카제, 무츠키. 계속할까? ‘안샨 7호'는 아직 있으니까.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
