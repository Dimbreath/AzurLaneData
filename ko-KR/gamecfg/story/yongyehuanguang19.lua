return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 201330,
			nameColor = "#a9f548",
			say = "하지만 지원 함대는 여전히 유인 작전중이야. 만약 우리가 서둘러 가지 않는다면…그녀들이 위험해져!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = " 윽…호송 함대가 세이렌과 마주치는 것을 보고만 있을 수도 없고…지원 함대를 내버려둘수도 없고…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205100,
			nameColor = "#a9f548",
			say = " 통신기는 어떻게 항상 중요한 순간에 나가버리는 거야! 방금 세이렌이 한 짓인가…화나 죽겠네!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 201330,
			nameColor = "#a9f548",
			say = "응… 모두와 연락이 안되면 그녀들을 철수시킬 수 없어. 이제 어떡해야 하지…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205100,
			nameColor = "#a9f548",
			say = " 만약 지원 물자가 노스 유니온에 도착할 수 없다면, 극지 방어선은 금새 붕괴되버릴거야….",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = " 그때가 되면 극지와 NY해역의 세이렌은 한편이 되어, 로열 네이비를 고립된 섬으로 만들어버릴거야.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205100,
			nameColor = "#a9f548",
			say = "…계속 통신설비를 점검해서 통신이 회복되면, 즉시 본토 방향으로 철수하게 해야지!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = " 시국을 예측하기 어려우니., 이미 이런 상황이니 결정했으면 움직이자고! 나중에 어떻게 폐하께 보고할건지 다시 생각하자고!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 205100,
			nameColor = "#a9f548",
			say = " 책임 같은건. 내가 지면 돼! 세이렌 함대가 또 다가왔어. 온힘을 다해 싸워야해!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
