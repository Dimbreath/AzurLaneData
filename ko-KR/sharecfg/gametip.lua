...
함대를 재배치할 수 있으며, 모든 함선의 내구도 및 사기를 
회복할 수 있습니다.

<color=#92fc63>함대 수리</color>
모든 함대의 사기 및 내구도를 회복하며, 전투 피해 상태를 
제거합니다.
...
잠수함 편대를 배치 및 지원 호출할 수 있습니다. 잠수함대는 
모항 해역에서 배치해야 합니다.
 ]]
			}
		}
...
1. <color=#92fc63>2021.1.21-2021.4.15</color>까지 「히류·META」의 도전이 한
정개방됩니다. 「히류·META」에 도전해 동기화 수치를 누
적하여<color=#92fc63>「히류·META」 캐릭터</color> 및 기타 풍부한 보상을 획득
할 수 있습니다.
 <color=#ff5c5c>주의: 동기화 수치는 기간 종료 후 사라집니다.</color>

2. 「애쉬 비콘 데이터」 획득 및 분석
·대형 작전을 통해 「애쉬 비콘 데이터」를 획득할 수 있으
며, 지정데이터량 도달 후, 분석 및 특정 애쉬 비콘을 발견할 
수 있습니다.
·일일 최대 분석 가능 횟수는 <color=#92fc63>2회</color>이며, 0시마다 초기화됩니
다. 사용하지 않은「애쉬 비콘 데이터」는 보류됩니다.
·매번 분석 시 <color=#92fc63>100</color> 「애쉬 비콘 데이터」가 필요합니다.

3. 자신이 분석한 비콘 도전
·자신이 분석한 비콘에 처음으로 도전 시 연료를 소모하지 않
으며, 두번째 도전부터매번 <color=#92fc63>40</color> 연료를 소모합니다.(도전 횟수
는 소모하지 않습니다.)
...
4. 기타 비콘 도전
·비콘 목록 화면에서 다른 지휘관이 도움을 요청한 비콘에 도
전할 수 있습니다.다른 지휘관의 비콘에 참여하면 전투 종료 
후 입힌 대미지
에 따라 <color=#92fc63>캐릭터 동기화 수치 보상을 획득합
니다</color>.
·매번 도전 시 도전 횟수 1회를 소모하며, 연료는 소모하지 
않습니다.
·매일 총 <color=#92fc63>3</color>회의 도전 횟수가 주어지며, 0시마다 초기화됩
니다.
·동일한 비콘에 최대 누적 30명의 지휘관이 도전할 수 
있습니다.

5. 전투 설명
·비콘·애쉬 도전은 대형 작전 중인 함선만 사용 가능하며, 
지휘냥과 잠수함은사용할 수 없습니다.
·전투 결산 시 경험치를 획득하지 않으며, 함선 감정 수치에 
영향을 주지 않습니다.
·전투 도중 퇴장할 수 없습니다. 만약 네트워크 이상으로 
연결이 끊길 경우:
①자신이 분석한 비콘에 도전 시 40 연료가 소모(첫 번째 도
전 X)되며,이미 입힌 대미지가 집계되지 않습니다.
②비콘 목록 중의 비콘에 도전 시 도전 횟수가 소모되며, 아
무런 보상도획득할 수 없습니다.
...
할 수 있습니다.
·1명의 캐릭터는 매일 최대 <color=#92fc63>30000</color> 스킬 레벨업 경험치를 획
득할 수 있고, 그중 먼저 획득하는<color=#92fc63>60%</color>는 2배의 임무 완성 효
