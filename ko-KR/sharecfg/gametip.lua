 ...
 11. 시즌 종료 후, 모든 유저의 계급과 포인트가 초기화됩니다. ]]
	...
	coloring_help_tip = {
		tip = {
			...
			{
				info = [[
1. 그림 일기에는 각자 해당하는 물감 번호가 있습니다.
물감 번호를 선택하고 터치하면 색칠할 수 있습니다.
2. 그림은 드래그로 확대하거나 축소할 수 있습니다.
3. 물감을 전부 소진하거나 그림일기를 모두 칠할 때까지 
자동으로 색칠합니다.
4. 색칠에는 물감이 소모되며 남은 물감이 0이면 더 색칠할 
수 없습니다.
...
전투 결산 시 지휘관、지휘냥、캐릭터 경험치가  100% 증가합니다, 추가적으로 1회 드랍;
 기분 수치 소모, 호감도 획득 또한 100% 증가합니다.]]
	...
	world_stamina_resetwarning = {
		tip = "주의: 대형 작전이 곧 <color=#ff5c5c>초기화</color>됩니다. 초기화 후\n100 이상의 행동력은 <color=#ff5c5c>보류되지 않으니</color>,\n지휘관 여러분께서는 합리적으로 함대 작전 계획을 세워주세요!"
	},
	world_ship_healthy = {
	...
	world_fleet_choose = {
		tip = "대형 작전 중 전투는 감정 및 연료 소모에 영향을 주지 않습니다."
	},
...
아군 모항 해역 내에서는, 모항 도크에서 대형 작전에 참여할
함대를 재배치할 수 있으며, 모든 함선의 내구도 및 사기를 회복할 수 있습니다.
...
잠수함 편대를 배치 및 지원 호출할 수 있습니다. 잠수함대는 모항 해역에서 배치
해야 합니다.
 ]]
			}
		}
	...
	world_instruction_morale_1 = {
		tip = "$1 행동력을 소모하여 모든 함대의 사기와 내구도를 회복하고, 전투 피해 상태를 제거하시겠습니까?(현재 행동력: $2. 지령 사용 후, 일정 시간 동안 재사용 불가)"
	},
	...
	world_instruction_submarine_2 = {
		tip = "$1 행동력을 소모하여 현재 해역에 잠수함대를 파견하시겠습니까?\n(현재 행동력: $2. 지령 사용 간격이 짧을수록, 행동력 소모가 높아집니다.)"
	},
	...
	world_instruction_submarine_7 = {
		tip = "현재 해역에 배치한 잠수함대의 탄약이 소진되었습니다. $1 행동력을 소\n모하여 탄약을 보충하고 상태를 회복하시겠습니까?\n(현재 행동력: $2. 지령 사용 간격이 짧을수록, 행동력 소모가 높아집니다.)"
	},
	world_instruction_detect_1 = {
		tip = "$1 행동력을 소모하여 현재 해역의 모든 구역을 정찰하시겠습니까?\n(현재 행동력: $2. 지령 사용 간격이 짧을수록, 행동력 소모가 높아집니다.)"
	},
...
1. <color=#92fc63>2021.1.21-2021.4.15</color>까지 「히류·META」의 도전이 한정
개방됩니다. 「히류·META」에 도전해 동기화 수치를 누적하여
<color=#92fc63>「히류·META」 캐릭터</color> 및 기타 풍부한 보상을 획득할 수 있습니다.
 <color=#ff5c5c>주의: 동기화 수치는 기간 종료 후 사라집니다.</color>

2. 「애쉬 비콘 데이터」 획득 및 분석
·대형 작전을 통해 「애쉬 비콘 데이터」를 획득할 수 있으며, 지정
데이터량 도달 후, 분석 및 특정 애쉬 비콘을 발견할 수 있습니다.
·일일 최대 분석 가능 횟수는 <color=#92fc63>2회</color>이며, 0시마다 초기화됩니다. 사용하지 않은
「애쉬 비콘 데이터」는 보류됩니다.
·매번 분석 시 <color=#92fc63>100</color> 「애쉬 비콘 데이터」가 필요합니다.

3. 자신이 분석한 비콘 도전
·자신이 분석한 비콘에 처음으로 도전 시 연료를 소모하지 않으며, 두번째 도전부터
매번 <color=#92fc63>40</color> 연료를 소모합니다.(도전 횟수는 소모하지 않습니다.)
·비콘의 HP가 0이 되면 전투에서 승리하며, 대량의 캐릭터
동기화 수치 보상을 획득합니다.
·분석한 비콘은 <color=#92fc63>24시간</color> 동안 유지되며, 이후 사라집니다.
기타 지휘관들에게 지원을 요청하세요.
·매번 도전 성공 후, 비콘의 난이도가 1단계씩, 총 15
단계까지 상승하며, 단계에 따라 전투 보상도 증가합니다.

4. 기타 비콘 도전
·비콘 목록 화면에서 다른 지휘관이 도움을 요청한 비콘에 도전할 수 있습니다.
다른 지휘관의 비콘에 참여하면 전투 종료 후 입힌 대미지
에 따라 <color=#92fc63>캐릭터 동기화 수치 보상을 획득합니다</color>.
...
5. 전투 설명
·비콘·애쉬 도전은 대형 작전 중인 함선만 사용 가능하며, 지휘냥과 잠수함은
사용할 수 없습니다.
·전투 결산 시 경험치를 획득하지 않으며, 함선 감정 수치에 영향을 주지 않습니다.
·전투 도중 퇴장할 수 없습니다. 만약 네트워크 이상으로 연결이 끊길 경우:
①자신이 분석한 비콘에 도전 시 40 연료가 소모(첫 번째 도전 X)되며,
이미 입힌 대미지가 집계되지 않습니다.
②비콘 목록 중의 비콘에 도전 시 도전 횟수가 소모되며, 아무런 보상도
획득할 수 없습니다.
...
함재기 회피는 함재기, 함재기를 장착한 항공모함의 스탯과 적
대공함의 스탯으로 결정

· 외형 장비는 장비 발사 효과 변경에 사용
(창고를 차지하지 않음) ]]
			}
		}
	},
		...
		tip = {
			{
				info = [[
지원 범위에 관해서
・해역에 출격할 때, 잠수함대 기함의 지원 가능 범위를 
잠수함대의"지원 범위" 로 지칭합니다.

・잠수함대는 지원 범위 내의 적을 향해 자동적으로
이동 및 공격을 통해 적의 전력을 약화시킵니다.

・또한, 아군 함대가 잠수함대의 지원 범위 내에서 적 함대와 
전투를 진행하는 경우,전투 중 "잠수 지원" 이 사용 가능하게 
됩니다.

・잠수함대의 공격은 탄약을 소비하며, "잠수 지원"은 탄약과 
연료를
소모합니다.

・잠수함대의 공격 유무 (즉, 이동의 유무)는 해역 이동 화면 
우측의 태세 변경버튼으로 변경 가능합니다.

지원 범위 레벨 : 
・지원 범위 레벨이 높아지면 자신의 지원 범위가 넓어집니다.

・지원 범위 레벨은 한계 돌파나 장비, 스킬 등을 통해 
상승시킬 수있습니다.]]
			}
		}
	},
...
· 숙련도:
한계 돌파를 3회 진행한 레벨 100 이상의 함선소녀는 출격 시,
얻게 되는 경험치의 일부에 해당하는 양의 숙련도를 
획득할 수 있습니다.

· 대강당 레벨:
대강당의 레벨을 올리면, 숙련도 보유 상한치, 숙련도 소모
속도 및 숙련도 획득 효율이 상승합니다.
...
(모니터함은 전함 수업 참여 가능/ 공작함, 운송함은 구축
함, 순양함 수업 참여 가능/ 항공전함은 항공모함, 전함 수업
참여 가능/ 잠수함, 잠수항모는 구축함 수업 참여 가능, 초갑순양함은 순양
함 수업 참여 가능)

· 수업 참여:
대강당 수업은 최대 12시간 진행되며, 수업 종료 시 소모한 숙련도가 차감되고,
캐릭터는 경험치를 획득합니다.
...
4.연구 항목 일람을 갱신
 · 0시 이후 「항목 갱신」을 터치하면, 연구 항목 일람을 5개 
갱신할 수 있습니다. 
	...
	newplayer_help_tip = {
		tip = {
			...
			},
			{
				...
				{
					info = "1. 이벤트는 시간 제한이 없고, 지휘관이 모든 이벤트 임무를 \n완료할 때까지 개방됩니다."
				},
				{
			...
			{
				info = "1. 이벤트는 레벨 30에 개방되며 화면 좌측 하단의 \n아이콘을 통해 연구 가속, 신병 훈련 이벤트가 표시됩니다."
			},
			{
				info = "2. 이벤트는 시간 제한이 없고, 지휘관이 모든 이벤트 임무를 \n완료할 때까지 개방됩니다."
			},
			{
				info = "3. 현 단계의 모든 임무를 완료하면 최종 이벤트가 개방됩니다."
			},
			{
				info = "4. 신병훈련과 연구 가속 모든 이벤트 임무를 완료하면, 이벤트\n가 닫히게 됩니다.\n"
			}
		}
	},
	newplayer_notice_1 = {
...
11. 9.10~9.24 기간 동안 연습 전투에 참여할 수 있으며, 9월 
30일까지 보상을 수령할 수 있습니다. ]]
			},
			{
				info = [[
...
다음의 조건을 달성하면 대응되는 함선의 <color=#92fc63>기술 Pt</color>를 획득할 
수 있으며, 특정한 <color=#92fc63>스탯 보너스</color>가 해제됩니다:
...
c 특정 함선 레벨 120 달성(기술 Pt 획득, 대응되는 모든 함선 
<color=#92fc63>스탯 보너스</color> 해제)
...
진영 기술 레벨업은 일정 수량의 <color=#92fc63>물자</color>를 소모해야 하며일정 
<color=#92fc63>시간</color> 기다려야 합니다.
진영 기술이 일정 레벨에 도달하면 대응되는 모든 함대 <color=#92fc63>스탯 
보너스</color>가 해제됩니다.<color=#ff5c5c>동시에 하나의 진영 기술 레벨만 높일 
수 있습니다</color>.

*함대 기술&진영 기술의 스탯 보너스는 <color=#ff5c5c>한계 돌파 최대치</color>인 
함선에게만 효과가 발생합니다.

<color=#FFDD00>진영 기술 Pt 계산</color>

진영 기술 Pt는 지휘관이 <color=#92fc63>대응되는 진영</color>의 <color=#92fc63>함대 기술</color>을 해제
하여 획득한기술 Pt의 <color=#92fc63>누적 총합</color>입니다.
...
초대 대상:
복귀 지휘관：
2020년 9월 10일~9월24일 사이에 로그인 이력이 없는
지휘관
신규 지휘관:
2020년 9월 24일~10월19일 사이에 신규 가입한 지휘관
자격에 해당하는 지휘관은 이벤트 기간 동안 로그인 시 특별 
이벤트 페이지에서 UID를 입력해 이벤트에 
참여할 수 있습니다.
초대자: 2020년 9월 10일~9월24일 사이에 로그인 한 이력이 
...
있습니다.]]
	...
	music_juus = {
		tip = {
			...
			{
				info = "1. 이벤트 기간 내 일정 시간마다 모항 캐릭터들이 새로운 \n새해 모션을 배포합니다."
			},
			{
				info = [[
2. 확인 할 수 있는 새로운 정보가 있을 때는 「JUUs」 입구에 
알림이 생깁니다.
3. 좋아요, 퍼가기, 댓글을 통해 참여할 수 있습니다.
<color=#92fc63>주의 사항:</color>좋아요는 취소할 수 없으며, 댓글을 단 이후 
시간이 지나면 회신을 받을 수 있습니다.]]
			}
		}
	},
	doa_collection = {
...
3회 실패하면 게임이 종료됩니다.
2. 스크린 우측의 바에 집중하세요. 바 위의 만쥬가
붉은색 구역에 닿는다면 더미가 무너지고 게임이 종료됩니다.
이벤트 규칙:
이벤트 기간 동안 하루에 한 번 사용 횟수를 얻을 수 있으며 
최대 7회까지 중첩됩니다.
1. 사용 횟수가 있는 상태에서 만쥬 젠가 플레이 시 횟수가 소모
되며 보상을 획득하고 출석 체크를 합니다. 7회 출석 체크하면 
한정 캐릭터 「우라나미」를 획득할 수 있습니다.
2. 사용 횟수는 이스트 글림의 설날 페이지 우측에서 확인할 수 
있으며, 출석 체크 진도는
이스트 글림의 설날 페이지의 진도 
카드를 터치해 확인할 수 있습니다.
3. 사용 횟수가 없는 상태에서 만쥬 젠가를 플레이하면 보상을 
획득할 수 없습니다.
4. 게임을 중간에 중단하면 사용 횟수가 소모되지 않지만
보상을 획득할 수 없습니다.]]
			}
		}
	},
...
「한정 건조」: 2020 설날 한정 캐릭터를 건조할 수 있습니다.]]
	...
	help_chunjie_jiulou = {
		tip = {
			{
				info = [[
1. 이벤트 기간 동안 「만쥬 젠가」, 「그림일기」, 
「세뱃돈 마블」, 「푸슌 대모험」을 통해 세뱃돈을 획득할 수 
있으며, 세뱃돈을 열어 다이아와 풍성한 보상을 획득할 수 
있습니다.
2. 세뱃돈은 일반 세뱃돈과 보너스 세뱃돈으로 나뉩니다. 
총 15개의 보너스 세뱃돈이 있으며, 나머지는 일반 세뱃돈입니다. 
먼저 보너스 세뱃돈을 연 뒤일반 세뱃돈을 열게 됩니다.]]
			}
		}
	},
	special_animal1 = {
...
특별 스테이지에 도전해 승리 시 특별 보상을 획득합니다.]]
	...
	help_chunjie_monopoly = {
		tip = {
			...
			{
				info = "1. 이벤트 첫 날, 5개의 주사위를 획득할 수 있습니다. 이후 매 \n24시간마다 주사위 5개를 획득합니다."
			},
			{
				info = "2. 주사위 5개를 던질 때마다 세뱃돈 1개를 획득합니다. "
			},
			{
				info = "3. 멈춘 칸에 있는 보상을 획득할 수 있으며, 시작 지점을 \n지나갈 때마다 200 물자를 획득합니다. "
			},
			{
				info = "         :일정 수량의 물자 획득",
				icon = {
		...
		tip = {
			{
				info = [[
이벤트 소개:
「쥬쥬 연등회」: 미니게임에 참여해 문제를 맞히고 보상을 
획득하세요. 
1. 매일 1회의 답변 기회가 해제됩니다(최대 14회). 정답을 7회 
맞히면 보상을 획득합니다. 오답 선택 시 일정 시간 대기 후
 다시 답을 선택해야 합니다. 
2. 정답을 맞히면 답변 기회가 소모됩니다. 답변 기회가 없다면 
답을 맞출 수 없습니다. 답을 맞히지 않거나 틀릴 경우, 기회가 
소모되지 않으며, 문제를 변경할 수 있습니다. 
3.보상리스트: 
...
<color=#92fc63>「아카시의 상품권」</color>을 획득합니다.
 ...
 ·동명의 함선 보류 여부 규칙은, 도크 중 <color=#92fc63>위 조건 1~5에 
부합하는 함선</color>에 대해서만 적용
 ·기본적인 우선 선택 대상 순서는 R, SR, N
 ·<color=#92fc63>우선 선택 대상 선택</color>을 통해 희귀도 순서를 변경 또는 삭제 
가능]]
			}
		}
	},
...
현재 <size=28><color=#ff5c5c>$4</color></size> 연료 필요.
	...
	equipment_upgrade_help = {
		tip = {
			...
			{
				info = "·장비 개발은 개발 재료와 물자를 <color=#92fc63>소모</color>하여 특정 장비를\n고급 장비로 변환시키는 시스템입니다."
			},
			{
				info = "·개발을 원하는 장비를 선택하면, 해당 장비 개발 화면\n에 진입합니다."
			},
			{
				info = "·선택된 장비의 다양한 개발 경로를 획득할 시, 전환 버튼을\n사용해 전환할 수 있습니다."
			},
			{
				info = "·재료 장비를 개발을 통해 획득할 수 있을 경우, 좌측의 빠른 \n개발버튼을 통해 해당 화면에 진입할 수 있습니다."
			},
			{
				info = "·장착 중인 장비도 재료 장비가 될 수 있으며, 개발 후의 새로\n운 장비는 바로 장착됩니다.(새로운 장비의 유형을 기존 캐릭터\n가 장착할 수 없을 경우, 창고에 저장됩니다.)"
			},
			{
				info = "·강화된 등급의 장비를 개발 소재로 사용할 경우, 장비 분해\n규칙에 따라 강화 과정 중에 소모된 <color=#92fc63>일부 강화 물자</color>, 및<color=#92fc63>모든 \n강화 재료</color>가반환됩니다."
			}
		}
	},
...
강화 지향 기능에서, 과학 연구 캐릭터 1명을 선택할 수 있습니
다.
연구 완료 시, 해당 캐릭터의 과학 연구 강화 유닛을 추가로 획
득합니다.
캐릭터 선택 후, 캐릭터 전환 기능을 통해 재선택할 수 있습니
다.
선택한 캐릭터 변경 확인 전 되돌아갈 경우, 기존에 선택했던 
캐릭터로 유지됩니다.
각 기수의 강화 지향 기능으로 획득 가능한 최대 강화 유닛 수량
은 300개이며, 캐릭터 재선택후에도 이미 획득한 수량은 변함
없이 유지됩니다.]]
			}
		}
	},
...
부사령관</color>에게 인계됩니다.]]
	...
	guild_event_help_tip = {
		tip = {
			...
			{
				info = "11. 각 유저는 대함대 작전에 매월 2회만 참여 가능하며, 대함대 작전\n진입 즉시 횟수가 차감됩니다."
			},
			{
				info = "12. 모든 사건과 보스전 보상은 <color=#92fc63>작전 보고서</color>로 지급되며, \n작전 보고서는 저장 상한이 있으니, <color=#92fc63>제때 수령</color>해 주시기 \n바랍니다."
			}
		}
	},
...
5. 지휘관은 하루에 <color=#92fc63>1</color>번만 보스와 교전할 수 있습니다.]]
	...
	guild_boss_formation_exist_invaild_ship = {
		tip = "2. 보유한 함선에서 선봉 및 주력함대로 각각 <color=#92fc63>1</color>척 이상 선택해야 합니다.\n"
	},
	guild_exist_unreceived_supply_award = {
		tip = "3. 다른 대함대 멤버의 파견 지원 함선에서 최대 <color=#92fc63>3</color>척까지 선택할 수 있습니다.\n"
	},
	word_shipState_guild_event = {
		tip = "4. 보스의 HP가 0이 되면 대함대 작전이 종료됩니다.\n"
	},
	...
	help_rollingBallGame = {
		tip = "5. 지휘관은 하루에 <color=#92fc63>1</color>번만 보스와 교전할 수 있습니다."
	},
	rolling_ball_help = {
		tip = {
			{
...
축제 광장 화면의 「초대장」 버튼을 
통해 확인할 수 있다.
3. 사용 가능 횟수가 없을 경우 쥬쥬 롤링볼에 참여하면 
출석 횟수를 얻지
못한다.
...
「특장 원형」 획득 가능
메인 해역, 이벤트, 작전 문서, 메인 해역 어려움 스테이지
BOSS 격파, 과학 연구 개발 완료 또는 개조하지 않은
UR 함선 퇴역 시 획득
(개조한 UR 함선 퇴역 시 획득 불가)

매월 획득 가능한 특장 원형 수량은 최대 4000개
매월 1일 0시마다 획득 가능 수량 초기화
*일부 이벤트를 통해 획득하는 특장 원형은 매월 최대치에 
합산하지 않으며, 표시될 것
]]
			}
		}
...
전열 함대에 격파되지 않은 경순양함 또는 구축함이 있을 경우,
해당 편대는 전투 중 대잠수함 소나로 적 잠수함을 탐지한다.
소나 탐지 범위 내의 적 잠수함은 범위를 벗어날 때까지
노출된다(일부 특수 상황 제외).

소나 탐지 범위 계산 방식:
도크 내 캐릭터 상세 화면의 대잠 수치
스탯 부분
1. 기본 탐지 범위
전열 함대의 구축함과 경순양함의 대잠 수치와 공식에 따라 
기본탐지 직경 계산:
...
기본 탐지 직경 계산 후, 최대 기본 탐지 직경이
편대의 기본 탐지 범위가 된다.

2. 추가 탐지 범위
기본 탐지 범위를 제외하고, 기타 방식을 통해 추가 탐지 범위를
늘릴 수 있다.
기본 범위와 추가 범위를 더한 후, 실제 대잠 소나 탐지 범위가
형성된다.
 ·후열에 편성된 모든 캐릭터들의 대삼 수치 합계 후, 공식에 
따라 추가 범위를계산한다.
...
게임이 종료됩니다.]]
	...
	world_joint_exit_battle_tip = {
		tip = "현재 전투를 중단하고 애쉬 비콘으로 이동하시겠습니까?"
	},
	world_boss_get_item = {
	...
	meta_sys_lock_tip = {
		tip = "META 연구실은 대형 작전의 비콘·애쉬 기능 개방 후 열립니다.(미사용)"
	},
	meta_story_lock = {
	...
	world_boss_progress_item_desc = {
		tip = [[
대형 작전에서 수집한 <color=#92fc63>「애쉬 비콘 데이터」</color>를 기록하는 장치. 지정 데이터량 달성 후 데이터에 따라 분석하여 애쉬 비콘을 발견할 수 있다.
...
데이터 기록량: $3]]
	...
	meta_help = {
		tip = {
			...
			{
				info = [[
·META 연구실은 META 캐릭터 획득, 육성을 진행하는 전용 
시스템입니다.
·META 캐릭터는 <color=#92fc63>「에너지 활성화」</color>, <color=#92fc63>「전술 연수」</color>、
<color=#92fc63>「함장 강화」</color>, <color=#92fc63>「정보 동기화」</color> 4개의 시스템 모듈을 
보유하고 있습니다.
·중복으로 획득한 META 캐릭터는 대응되는 캐릭터 
1명으로 자동 전환됩니다.
...
·<color=#92fc63>2021.1.21-2021.4.15</color>까지 「히류·META」의 「정보 동기
화」가한정 개방됩니다. 「비콘·애쉬」 전투를 통해 동기화 
수치를 획득하여, 일정 수치에 도달하면 <color=#92fc63>「히류·META」 캐
릭터</color>를 획득할 수 있습니다.
·META 캐릭터 획득 후 캐릭터의 <color=#92fc63>「정보 동기화」</color> 모듈을 통
해<color=#92fc63>기재된 시간</color> 동안 계속해서 육성 재료를 포함한 풍성한 보
상을 획득할 수 있습니다.
·주의:<color=#ff5c5c>「히류·META」의 「정보 동기화」는 기간 종료 후 
잠시폐쇄되며, 이미 누적된 동기화 수치 역시 사라집니다</color>.

2. <color=#92fc63>에너지 활성화</color>
·META 캐릭터가 지정된 레벨에 도달하면 해당되는 캐릭터 
결정을 사용해 활성화를 진행할 수 있습니다. 활성화 후 캐릭
터의 성급이 상승합니다.
·캐릭터 결정은 「정보 동기화」 보상을 통해 획득할 수 
있습니다.
]]
			},
			{
...
·전술 연수 임무를 완성하여 META 캐릭터의 스킬 레벨업 경
험치를 획득할 수 있고, 일부 임무는 중복으로 완성할 수 있습
니다.
·1명의 캐릭터는 동시에 1가지 스킬의 전술 연수 임무만 진
행할 수 있으며, 각 캐릭터간은 서로 독립되므로, 동시에 진행
할 수 있습니다.
·1명의 캐릭터는 매일 최대 <color=#92fc63>30000</color> 스킬 레벨업 경험치를 획득할 수 있고, 그중 먼저 획
득하는<color=#92fc63>60%</color>는 2배의 임무 완성 효
율을 가집니다.(잔여 횟수가 2회 미만일 시, 적용 안됨)
·임무 유형과 완성 가능 횟수는 스킬 레벨에 따라 상승하고 
갱신됩니다.
]]
			},
			{
...
·META 캐릭터는 함장 강화 재료 소모를 통해 「화력」, 「뇌
장」, 「항공」, 「장전」 4개 속성을 강화시킬 수 있습니다.
·강화는 해당 속성을 상승시키며 강화 진도가 일정 수치에 도
달할 시 추가스탯 상승을 획득합니다.
·함장 강화 재료는 「정보 동기화」 보상 및 대형 작전 내
항구 상점에서 구매하여 획득할 수 있습니다.]]
			}
		}
	},
	...
	meta_pt_notenough = {
		tip = "동기화 수치가 부족합니다. <color=#92fc63>대형 작전</color>의 비콘·애쉬 작전으로 이동하여 획득하세요."
	},
	meta_boss_unlock = {
		tip = "<color=#92fc63>대형 작전</color> 제1장에서 비콘·애쉬 기능 해제 후 캐릭터 획득 오픈!"
	},
	word_take_effect = {
		tip = "적용"
	},
	...
	world_boss_maintenance = {
		tip = "곧 서버 점검이 시작되어, 애쉬·비콘 작전을 진행할 수 없습니다."
	},
	world_boss_inbattle = {
		tip = "현재 비콘·애쉬 작전 중. 이동 불가."
	}
}
