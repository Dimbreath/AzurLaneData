 ...
 11. 시즌 종료 후, 모든 유저의 계급과 포인트가 초기화됩니다. ]],
	...
	coloring_help_tip = {
		...
		tip = {
			...
			{
				info = [[
모든 그림일기의 칸에는 지정된 번호의 물감이 있으며, 
지정된 물감을 선택해 칸을 터치하면 색칠할 수 있습니다.
2. 두번 터치해 색칠칸을 확대 혹은 축소할 수 있습니다. 
3. 물감이 모두 소모되거나 전부 색칠될 때까지 같은 색깔의 
칸은 자동으로 색칠됩니다.
4. 색칠할 때마다 물감이 소모됩니다. 남은 물감이 0이 되면 
색칠할 수 없습니다.
5. 물감은 이벤트 임무 연료 누적 소모로 획득할 수 있습니다.
6. 그림을 완성하면 보상을 획득합니다.
7. 보상 일람:
	그림1: 랜덤 교본T3x2
	그림2: 세뱃돈x1
	그림3: 함포 부속T3x2
	...
	그림6: 세뱃돈x1
	그림7: 안샨x1
8. 모든 그림일기를 완성하면 비어있는 그림일기를 추가로 
획득합니다.
9. 비어있는 그림일기에는 물감 사용 제한이 없으며 물감을 
소모하지 않습니다.
10. 비어있는 그림일기에는 지우개를 사용하거나 리셋할 수 
있습니다.
11. 지우개를 사용하면 지울 칸을 선택할 수 있습니다. 
12. 리셋을 선택하면 지금까지 색칠한 그림일기를 전부 
지웁니다.
13. 이벤트 종료 후 사용하지 않은 물감은 사라집니다.
14. 2월 19일까지 매일 새로운 그림일기가 하나씩 개방되며 
비어있는 그림일기는 2월 20일 이후부터 개방됩니다.]]
			}
		}
	},
	link_link_help_tip = {
