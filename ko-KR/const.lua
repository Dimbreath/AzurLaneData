...
LOCK_COMMANDER_TALENT_TIP = true
...
ERROR_MESSAGE = {
	...
	[4201.0] = "특전 코드의 기한이 만료되었습니다.",
	[4010.0] = "함선 데이터에 에러가 발생했습니다.",
	[4203.0] = "특전 코드가 존재하지 않습니다.",
	[9999.0] = "알 수 없는 에러가 발생했습니다.",
	[4205.0] = "특전 코드 오류,다시 입력해 주세요.",
	[4206.0] = "해당 유형의 보상은 이미 교환되었습니다.",
	[3010.0] = "전투 불능이 된 함선이 존재합니다.",
	[3020.0] = "개방을 위한 스테이지가 아직 클리어되지 않았습니다.",
	[4207.0] = "보상 교환 URL이 없습니다.",
	[4204.0] = "특전 코드가 이미 사용되었습니다.",
	[4050.0] = "동일한 함선입니다.",
	[4040.0] = "출격 함선으로 편성되어 있지 않습니다.",
	[1020.0] = "패스워드가 정확하지 않습니다.",
	[4202.0] = "해당 서버에 사용할 수 없는 코드입니다.",
	[1012.0] = "숫자뿐인 계정입니다."
}
SPECIAL_DATE = {
	{
