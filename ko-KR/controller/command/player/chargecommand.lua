...
function slot0.execute(slot0, slot1)
	...
	slot11.shop_id = slot3

	pg.ConnectionMgr.GetInstance():Send(11501, {}, 11502, function (slot0)
		if slot0.result == 0 then
			if PLATFORM_CODE == PLATFORM_JP or PLATFORM_CODE == PLATFORM_US then
				...
				pg.SdkMgr.GetInstance():SdkPay(uv0:getConfig("id_str"), slot5, slot6, slot7, slot8, uv0:getConfig("subject"), "-" .. slot3.id .. "-" .. slot8, slot3.name, notify_url, order_sign)
			end
