...
function slot0.execute(slot0, slot1)
	...
	if not slot3:getActivityByType(ActivityConst.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2) or slot3:isEnd() then
		return
	end

	slot7.act_id = slot3.id

	pg.ConnectionMgr.GetInstance():Send(26031, {}, 26032, function (slot0)
