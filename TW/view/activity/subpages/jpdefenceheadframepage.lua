slot0 = class("JPDefenceHeadFramePage", import("...base.BaseActivityPage"))
...
function slot0.OnUpdateFlush(slot0)
	if not getProxy(ActivityProxy):getActivityById(ActivityConst.JP_DEFENCE_EXP_ID) or slot1:isEnd() then
