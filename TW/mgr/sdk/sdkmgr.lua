...
pg.SdkMgr.IsBindFaceBook = function (slot0)
	if PLATFORM_CODE == PLATFORM_CHT then
		return slot0:Get("IsBindFaceBook")
	end
end

pg.SdkMgr.IsBindGoogle = function (slot0)
	if PLATFORM_CODE == PLATFORM_CHT then
		return slot0:Get("IsBindGoogle")
	end
end

pg.SdkMgr.IsBindPhone = function (slot0)
	if PLATFORM_CODE == PLATFORM_CHT then
		return slot0:Get("IsBindPhone")
	end
end

pg.SdkMgr.IsBindGameCenter = function (slot0)
	if PLATFORM_CODE == PLATFORM_CHT then
		return false
	end
end

pg.SdkMgr.CanTriggerDeepLinking = function (slot0)
	if PLATFORM_CODE == PLATFORM_CHT then
...
pg.SdkMgr.TriggerDeepLinking = function (slot0)
	slot0:Call("TriggerDeepLinking")
end

pg.SdkMgr.BindSocial = function (slot0, slot1)
	if slot1 == 1 then
		slot0:BindFaceBook()
	elseif slot1 == 2 then
		slot0:BindGoogle()
...
pg.SdkMgr.BindFaceBook = function (slot0)
	slot0:Call("BindFaceBook")
end

pg.SdkMgr.BindGoogle = function (slot0)
	slot0:Call("BindGoogle")
end

pg.SdkMgr.BindPhone = function (slot0)
	slot0:Call("BindPhone")
end

pg.SdkMgr.UnBindFaceBook = function (slot0)
	slot0:Call("UnBindFaceBook")
end

pg.SdkMgr.UnBindGoogle = function (slot0)
	slot0:Call("UnBindGoogle")
end

pg.SdkMgr.UnBindPhone = function (slot0)
