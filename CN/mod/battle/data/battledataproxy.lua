...
function slot8.generatePlayerUnit(slot0, slot1, slot2, slot3, slot4)
	...
	slot3.CreateBattleUnitData(slot5, slot8, slot2, slot1.tmpID, slot1.skinId, slot1.equipment, slot6, slot7, slot0._completelyRepress, slot0._repressReduce, nil, slot1.baseList, slot1.preloasList):InitCurrentHP(slot1.initHPRate or 1)
