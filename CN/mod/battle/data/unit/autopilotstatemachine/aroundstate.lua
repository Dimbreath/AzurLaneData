...
function ys.Battle.AroundState.CalculateDirection(slot0, slot1, slot2)
	...
	if slot0._trailParam.type == slot0.AROUND_TYPE_STAY then
		slot4 = slot0.Stay(slot1, slot3, slot0._trailParam)
...
function ys.Battle.AroundState.Random(slot0, slot1, slot2, slot3)
	...
	slot4 = Vector3.SqrDistance(slot1, Vector3(slot2.x, 0, slot2.z))
	slot5 = (slot3.distance or 1) * ()
	slot6 = slot0._randomCount or 0

	if slot4 < slot5 or slot6 > 30 then
		slot0._referencePoint = slot0.Battle.BattleFormulas.RandomPosNull(slot3)
...
function ys.Battle.AroundState.KeepHorizontal(slot0, slot1)
	...
	elseif slot0.z - slot1.z > 1 then
		...
		return slot0.Battle.AroundState.FaceTo(slot0, slot1)
	end
end
