return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "话说回来在贞德她们出发之前，妳本来想说小心来自圣堂的什么？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 805010,
			say = "被妳听到了啊……贞德之前关于海域违和感的描述，以及现在阿尔及利亚反常的作战部署，让我联想到了一个存放在圣堂中的实验性兵器。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……等等！黎塞留，那些不会恰好就是妳想说的“实验型兵器”的下一阶段吧…？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "妳之前说存放圣堂中存放有武器的时候，我还以为妳指的是舰炮、舰载机一类的东西呢…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 802020,
			say = "黎塞留，妳看到了么？！海面上突然出现了大量奇怪的光墙，我们回去的航线被挡住了！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 805010,
			say = "我已经看到光墙的空隙了…现在绕行回来会耗费大量时间，妳们改变路线，仔细寻找光墙的间隙直接向圣堂前进。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
