return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "果然是这样么…妳这次亲自参与作战，除了确保胜利之外，更多的还是希望可以劝维希教廷的人回心转意吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "很多人是基于信念和誓言才暂且留在维希教廷，并不是我们真正的敌人。如果一定要与她们拼个妳死我活，才是鸢尾最大的悲哀吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			blackBg = true,
			nameColor = "#a9f548",
			say = "我们也衷心希望统一的鸢尾教国能快点回来，为此，包括皇家在内整个碧蓝航线都会坚定的站在妳身边哦，枢机主教黎塞留。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
