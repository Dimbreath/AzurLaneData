return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actor = 805010,
			say = "在这次防御战中妳们做得十分出色，但有些实力上的差距是不可能依靠这种程度的战术就可以弥补的。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 805010,
			say = "妳们肯定能看出来，现在的局势已经“将军”了。继续战斗下去也不会让战斗的结局发生任何改变。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 805010,
			say = "加入自由鸢尾吧，以枢机主教黎塞留之名向妳们保证，我一定会让妳们看到光复祖国的那一天！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 903020,
			say = "黎塞留卿，关于妳邀请我们临阵倒戈加入自由鸢尾的的事，请允许我们郑重拒绝。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 903020,
			say = "教廷舰队全员注意，圣堂舰队指挥、维希教廷骑士阿尔及利亚现在对妳们下达最后的命令。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
