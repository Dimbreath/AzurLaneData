return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "在本次演習中，我們不但向艦隊展現了白鷹先進的航空戰術，而且獲得了許多寶貴的戰鬥數據，可以說取得了圓滿成功。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "背面好像還寫了字……“整裝待發的艾塞克斯”。唔嗯…這張照片看起來確實是這樣的感覺呢。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "還有“偷偷惡作劇的薩拉托加”“正在引導驅逐們的約克鎮”“眺望遠方的企業”……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
