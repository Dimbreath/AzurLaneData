return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "哦？没想到在这里还能遇到聊天的人。妳是谁，妳也同路的人么？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "为了保持所谓的尊严，为了维护所谓的约定，为了承担所谓的责任。除了自沉之外，妳已经没有第二种选择了，对么？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "但是这样的选择只是逃避。妳的自沉改变不了教廷的懦弱，改变不了皇家的背叛，改变不了鸢尾的分裂。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "妳们的牺牲，带来不了任何荣耀。妳们的名字，也不会成为后辈们的荣光。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "或许后辈在提到妳们时，只会用“遗憾”，或者“惋惜”来形容妳们的这次选择吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "这种事，像妳这样聪明的人，在放下一切之后回头看，难道真的看不出来么？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				{
					"<size=51>「我们在天上的父，愿人都尊妳的名为圣」</size>",
					1
				},
				{
					"<size=51>「愿妳的国降临，愿妳的旨意行在地上，如同行度在天上」</size>",
					2.5
				},
				{
				...
				{
					"<size=51>「因为国度，容权柄，荣耀，全是妳的，直到永远」</size>",
					8.5
				},
				{
					"<size=51>「阿门」</size>",
