return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "在侦察机发现拉.加利索尼埃没有和妳在一起的时候，我就识破妳的作战意图了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 805010,
			say = "虽然不知道妳具体打算怎么执行，不过姑且让航空编队将备用舰载机隐藏在云层中待命，如果有伏击的话总会到来吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 903020,
			say = "原本也想过可能不会这么顺利…果然还是骗不到妳么，黎塞留卿。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 805010,
			say = "即便在这种不利的局面下，妳还是进行了一场无愧于教廷骑士之名的出色战斗，对于维希教廷妳已经足够的忠义了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
