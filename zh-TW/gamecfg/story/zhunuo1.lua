return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……咳咳，而光榮前輩，你的任務是接收這邊的飛機防止在本次撤離中受損，可以說已經完成了任務，所以本人批准你單獨行動的請求，並下達護送兩艘運輸船的指令，下次可別忘了檢查油箱。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "是是，總之熱心和阿卡司塔兩位驅逐妹妹也會繼續為你護航。前輩，要是妹妹們受了什麼傷，回去我可要好好跟你談談。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#a9f548",
			say = "前輩你這是說的什麼話，身為前輩愛護後輩，身為航母保護驅逐妹妹們不是理所當然的事嗎？！",
			shake = {
				speed = 8,
				number = 3
			},
