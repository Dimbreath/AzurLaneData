return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 805010,
			nameColor = "#a9f548",
			say = "如果真的是这样就太好了。我还要向教廷汇报协议成功签订的事，就不继续耽误妳的时间了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "妳就放心吧~这次我会派光辉和命运女神连同皇家量产型航空编队在内和妳们一起行动。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "哦对了，有个重要的情报得告诉妳，维希可能暗中向圣堂派了增援舰队。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "唉…真羡慕妳现在可以带领舰队在前线作战。我却只能淹没在比以往数量更夸张的公文里…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "本次作战将会向整个世界展现自由鸢尾和皇家的亲密合作，本王就先在这里预祝妳们一切顺利，作战成功吧！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
