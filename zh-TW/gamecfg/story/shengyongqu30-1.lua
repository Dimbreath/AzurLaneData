return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actor = 903020,
			say = "关于这一点，也许妳们的皇家和白鹰盟友给妳想要的答案吧…她们不是也正在做类似的事么？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 902010,
			say = "切，既然收到了撤退命令就没办法了。抱歉了黎塞留，看来我们现在还不能过去妳们那边，有缘再见吧~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "我能理解，这种计划不是妳能随便透露的事。战斗结束之后我会去直接问伊丽莎白，现在先把注意力集中在作战上！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
