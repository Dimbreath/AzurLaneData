return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "姐姐已经出发前往司令部了，如果有重要的事的话，需要我帮妳们转达么？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "这样啊…那希望妳们都能享受这场茶会。我也有点急事，就先告辞了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			nameColor = "#a9f548",
			say = "妳泡的红茶还是一如既往的好喝，我怎么就泡不出这么美味的茶水来呢…",
			flashout = {
				dur = 1,
				black = true,
				alpha = {
		...
		},
		{
			...
			actor = 903020,
			nameColor = "#a9f548",
			say = "茶水可以反应泡茶人的内心。心静如水，泡出来的茶才会透人心弦。妳行动总是火急火燎的，泡出来的茶品质也会变差啦。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 902010,
			nameColor = "#a9f548",
			say = "原来是这样么？！算啦，就算不会泡茶，只要一直来蹭妳们的喝就行了~",
			dialogShake = {
				speed = 0.09,
				x = 8.5,
				number = 2
		...
		},
		{
			...
			actor = 903020,
			nameColor = "#a9f548",
			say = "妳现在闻到的硝烟不是倔强刚刚弄出来的那些么…算啦，别想这么多了，还要喝茶么？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
