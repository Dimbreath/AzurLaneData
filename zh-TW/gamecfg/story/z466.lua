return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "我們盡了最大努力，直到用盡所有彈藥。敵人若也有自我，應該也會感到驕傲吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "為了確保一切可能入手的戰果。結果上來說，比起撤退的情況，我們給予了敵人更為巨大的打擊不是嗎。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "雖然身為秘書艦，但仍是兵器。仍只是為了戰鬥而生的存在。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task",
			say = "在成為“Z46”之前，我首先是那艘在大戰中被設計建造、背負了眾人期待的“Z46號艦”。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
