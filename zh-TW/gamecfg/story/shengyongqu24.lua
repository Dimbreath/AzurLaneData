return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actor = 807010,
			say = "抱歉喽。黎塞留早就看穿了妳们的计划，这些舰载机都是为了妳特意准备的。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 902010,
			say = "妳之前也没说啊…唉，我还以为妳的意思是让我偷袭不成就就地牺牲报国呢。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 903020,
			say = "………………我用极光之壁掩护妳，快点撤回来。我们现在还有胜算，不要做无谓的牺牲。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 805010,
			say = "光辉、贝亚恩，现在就先让她回去吧。妳们重新整队之后前来同主力舰队汇合，决战的时刻就要到了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
