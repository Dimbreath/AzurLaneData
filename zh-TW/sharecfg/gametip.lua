...
受傷倍率：增加受到的傷害]]
	...
	shop_street_activity_tip = {
		tip = "*活動期間(<color=#A1E400FF>2020.3.26-4.9</COLOR>)每次重整必定出現<color=#A1E400FF>外觀裝備箱</color>"
	},
	twitter_link_title = {
		tip = "</size>"
	},
...
1. 方案艦的研發等級<color=#92fc63>滿級(Lv.30)</color>後才能解鎖相應的《天運
擬合》系統
2. 《天運擬合》共分<color=#92fc63>5</color>個階段，每個階段需要消耗相應的<color=#92fc63>藍
圖</color>提升完成度，完成度達到100%即可解鎖對應的擬合階段
...
艦隊選擇介面點擊<color=#92fc63>「模擬戰」</color>按鈕進行嘗試，「模擬戰」
不消耗石油、心情、「特別挑戰券」
2.進行「EX」演習戰鬥時，中途斷線或者主動退出等中止
戰鬥的情況都會扣除「特別挑戰券」且<color=#ff5c5c>不會獲得任何獎勵</color>
<color=#ff5c5c>請在網路狀態良好的情況下進行「EX 」演習戰鬥</color>
...
1.在活動期間，參與演習戰鬥獲取<color=#92fc63> 「貢獻值」</color>,和本服
玩家協力攻略演習據點，獲取據點階段獎勵和個人貢獻
獎勵
2.本次活動分為「簡單」、「普通」、「困難」、 「EX」
4個難度的演習
3.「簡單」、「普通」、「困難」演習會獲得固定「貢
獻值」,「EX」演習會根據<color=#92fc63>戰鬥中造成的傷害總量</color>獲得
「貢獻值」和獎勵，造成傷害越多「貢獻值」越多，獲得
獎勵越豐厚
4.「簡單」、「普通」、「困難」演習每次通關時可以獲
得額外收益， 額外收益每日有獲得次數上限，每日
「額外收益次數」上限3個難度各為<color=#92fc63>15次</color>
5 .「簡單」、「普通」、「困難」演習每日挑戰次數無限
制，「EX」演習需要消耗<color=#92fc63>1個「特別挑戰券」</color>才可以挑戰
6 .演習戰鬥的出擊隊伍可以通過點擊不同難度的按鈕進行
編成，允許攜帶潛艇和指揮喵
7.活動期間，根據本服所有玩家獲得的「貢獻值」，消耗
「演習據點」的耐久
8.當「演習據點」耐久下降至<color=#92fc63>75%</color>、<color=#92fc63>50%</color>、<color=#92fc63>25%</color>以及<color=#92fc63>完全
耗盡</color>後，會記錄本服達成的里程碑時間，同時，在演習中
獲得過「貢獻值」的玩家可以獲得相應獎勵
...
」為<color=#92fc63>0</color>的情況下，進行演習戰鬥時可以消耗<color=#92fc63>1個</color>「特別挑
...
<color=#D6341D>鐵血</color>陣營科技點<color=#A9F548>+1</color>]]
	...
	blueprint_simulation_confirm_19901 = {
		tip = [[
<size=28>是否開始戰術模擬？(模擬中我方艦船將受到某些特殊加成影響，<color=#D6341D>實際性能以獲得艦船為准</color>）
使用裝備：<color=#A9F548>
...
當前還需要<size=28><color=#ff5c5c>$4 </color></size>石油
	...
	pizzahut_help = {
		tip = {
			{
				info = [[
通关下列指定关卡会获得不同数量<color=#92fc63>「必胜金币」</color>
1.三章及以后的普通主线海域
2.活动关卡「穹顶下的圣咏曲」（EX关卡除外）
活动规则：
1.活动期间玩家获得<color=#92fc63>「必胜金币」</color>后可以在活动页面投入
