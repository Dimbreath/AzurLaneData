...
——完成<color=#92fc63>8次</color>科研項目的研發]],
	...
	[60082] = {
		...
		name = "白鷹主力技術測試I ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>為確保研發工程的順利進行，獲取足夠多的測試數據是非常有必要的，而最真實有效的數據，無疑來自實戰</color>\n\n——使用白鷹主力角色，在任意關卡中累計獲得<color=#92fc63>100萬</color>經驗（不同角色可累加）",
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
	...
	[60085] = {
		...
		count_inherit = 0,
		desc = [[
<color=#a2a2a2><color=#92fc63>「需先完成白鷹主力技術測試I」</color>
研發進入了新的階段，儘管改良後的設計方案在理論上具有更出色的性能，但紙面數據終究不如實戰測試來得可靠</color>

——使用白鷹主力角色，在任意關卡中累計獲得<color=#92fc63>200萬</color>經驗（不同角色可累加）]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
——完成<color=#92fc63>8次</color>科研項目的研發]],
	...
	[60092] = {
		...
		name = "重櫻先鋒技術測試I",
		count_inherit = 0,
		desc = "<color=#a2a2a2>為確保研發工程的順利進行，獲取足夠多的測試數據是非常有必要的，而最真實有效的數據，無疑來自實戰</color>\n\n——使用重櫻先鋒角色，在任意關卡中累計獲得<color=#92fc63>100萬</color>經驗（不同角色可累加）",
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
	...
	[60094] = {
		...
		name = "先鋒技術突破I ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>大量的實戰數據和前沿理論讓研發工作迎來了一次突破，這將會是一件完全不同與以往的工程，但在細節部分還需要參考之前的設計圖進行比照確認</color>\n\n——提交<color=#92fc63>10張</color>驅逐改造圖T2",
		target_id_2 = "",
		sub_type = 1000,
		added_tip = 0,
		story_icon = "",
	...
	[60095] = {
		...
		count_inherit = 0,
		desc = [[
<color=#a2a2a2><color=#92fc63>「需先完成重櫻先鋒技術測試I」</color>
研發進入了新的階段，儘管改良後的設計方案在理論上具有更出色的性能，但紙面數據終究不如實戰測試來得可靠</color>

——使用重櫻先鋒角色，在任意關卡中累計獲得<color=#92fc63>200萬</color>經驗（不同角色可累加）]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
——完成<color=#92fc63>8次</color>科研項目的研發]],
	...
	[60097] = {
		...
		name = "先鋒技術突破II ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>在更多的數據和理論的幫助下，研發工作迎來了一次巨大的突破，在諸多領域應用了全新的技術。但有幾個點，工程師們並沒有達成一致，他們需要以往的技術資料進行參考 </color>\n\n——提交<color=#92fc63>5張</color>驅逐改造圖T3",
		target_id_2 = "",
		sub_type = 1000,
		added_tip = 0,
		story_icon = "",
...
——使用重櫻先鋒角色，在任意關卡中累計獲得<color=#92fc63>240萬</color>經驗（不同角色可累加）]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
——使用鐵血主力角色，在任意關卡中累計獲得<color=#92fc63>240萬</color>經驗（不同角色可累加）]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
——完成<color=#92fc63>12次</color>科研項目的研發]],
	...
	[60117] = {
		...
		name = "主力技術突破II ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>在更多的數據和理論的幫助下，研發工作迎來了一次巨大的突破，在諸多領域應用了全新的技術。但有幾個點，工程師們並沒有達成一致，他們需要以往的技術資料進行參考 </color>\n\n——提交<color=#92fc63>8張</color>戰列改造圖T3",
		target_id_2 = "",
		sub_type = 1000,
		added_tip = 0,
		story_icon = "",
	...
	[60122] = {
		...
		name = "鐵血主力技術測試I ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>為確保研發工程的順利進行，獲取足夠多的測試數據是非常有必要的，而最真實有效的數據，無疑來自實戰</color>\n\n——使用鐵血、自由鳶尾或維希教廷的主力角色，在任意關卡中累計獲得<color=#92fc63>100萬</color>經驗（不同角色可累加）",
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
——使用鐵血、自由鳶尾或維希教廷的主力角色，在任意關卡中累計獲得<color=#92fc63>200萬</color>經驗（不同角色可累加）]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
