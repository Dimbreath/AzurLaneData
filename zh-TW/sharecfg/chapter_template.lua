...
pg.chapter_template = {
	...
	[901] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "伴隨著夜色，重櫻的精銳驅逐艦編隊正悄悄的駛向科隆班加拉島方向，然而，我方的攔截艦隊早已在此守株待兔。",
		difficulty = 4,
		avoid_ratio = 17,
		star_require_2 = 2,
		time = 43200,
	...
	[902] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "雙方的艦隊近距離接觸了，在夜色中，究竟會是重櫻引以為傲的純氧魚雷還是白鷹的巡洋艦炮更勝一籌？",
		difficulty = 5,
		avoid_ratio = 18,
		star_require_2 = 2,
		time = 43200,
	...
	[903] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "海倫娜炮口的火舌照亮了夜晚的海面，她將火力毫無保留地傾瀉在敵人身上，然而，卻也因此暴露了自己的位置...",
		difficulty = 6,
		avoid_ratio = 18,
		star_require_2 = 2,
		time = 43200,
	...
	[904] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "敵方的新型驅逐艦展現出了不同以往的夜戰實力，多枚魚雷準確的命中了海倫娜，戰鬥陷入一片混亂。",
		difficulty = 7,
		avoid_ratio = 19,
		star_require_2 = 2,
		time = 43200,
	...
	[1101] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "一切準備就緒，敵方艦隊的注意力已經被其他幾個方向的支援空襲吸引，在拂曉的陽光下突破防線，登陸布島吧！",
		difficulty = 5,
		avoid_ratio = 19,
		star_require_2 = 2,
		time = 43200,
	...
	[1102] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "航空艦隊偵察機發現了在夜色與暴雨中全速前進的敵方編隊，而能夠攔截敵人的，只有已經疲憊不堪的第39特混艦隊…",
		difficulty = 6,
		avoid_ratio = 20,
		star_require_2 = 2,
		time = 43200,
	...
	[1103] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "“我們的天職便是為友軍保駕護航，克里夫蘭、蒙彼利埃、哥倫比亞、丹佛，所羅門四騎士參上！”",
		difficulty = 7,
		avoid_ratio = 20,
		star_require_2 = 2,
		time = 43200,
	...
	[1104] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "面對敵方的重巡洋艦，四艘克里夫蘭級輕巡洋艦依然不落下風，發揮出了驚人的戰力，無數的炮口焰撕裂了漆黑的夜晚",
		difficulty = 8,
		avoid_ratio = 21,
		star_require_2 = 2,
		time = 43200,
	...
	[10000] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "近日重櫻在馬來海域集結艦隊，司令部已決定組成“Z”艦隊前往馬來海域一探虛實，指揮官將被編入支援艦隊保護“Z”的側翼，請指揮官做好出發準備。",
		difficulty = 4,
		avoid_ratio = 8,
		star_require_2 = 2,
		time = 43200,
	...
	[10001] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "在重櫻的陸航轟炸機面前，威爾斯親王號與反擊號上的防空火力顯得如此的薄弱，戰鬥很快陷入了僵局。",
		difficulty = 5,
		avoid_ratio = 9,
		star_require_2 = 2,
		time = 43200,
	...
	[10002] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "反擊號與威爾斯親王號先後被多發魚雷命中，與此同時，重櫻南遣艦隊的水面部隊也正在緊急趕往戰場...",
		difficulty = 6,
		avoid_ratio = 10,
		star_require_2 = 2,
		time = 43200,
	...
	[1000001] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>重置所有戰術模組，「白方」棋手準時加入棋局， 「黑方」「輕子〈Minor pieces〉」開始移動，行為匹配度：100%",
		difficulty = 3,
		avoid_ratio = 12,
		star_require_2 = 2,
		time = 43200,
	...
	[1000002] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>「白方」採用棄兵開局，獲得較小的「出子〈Development〉」領先優勢，行為匹配度：100%",
		difficulty = 4,
		avoid_ratio = 13,
		star_require_2 = 2,
		time = 43200,
	...
	[1000003] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>「白方」獲得暫時的「主動權〈Initiative〉」，「黑方」開始發動「反擊〈Counterplay〉」，行為匹配度：93.6%",
		difficulty = 5,
		avoid_ratio = 13,
		star_require_2 = 2,
		time = 43200,
	...
	[1000004] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>「白方」獲得「變後〈Promotion〉」，「黑方」採取「穿串〈Skewer〉」行為，行為匹配度：76.2%",
		difficulty = 6,
		avoid_ratio = 14,
		star_require_2 = 2,
		time = 43200,
	...
	[1000005] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>測試被重置，原因不明，特殊保衛系統「風暴螺旋」開啟，所有「棋子〈Piece〉」回歸交匯點，行為匹配度：None",
		difficulty = 5,
		avoid_ratio = 14,
		star_require_2 = 2,
		time = 43200,
	...
	[1000006] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>「白方」將「黑方」保衛者「引離〈Skewer〉」，再次獲得主動權，行為匹配度：None",
		difficulty = 6,
		avoid_ratio = 15,
		star_require_2 = 2,
		time = 43200,
	...
	[1000007] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>警告，測試發現BUG，「黑方」多數「棋子〈Piece〉」出現覺醒反應，建議立刻執行緊急DEBUG",
		difficulty = 7,
		avoid_ratio = 15,
		star_require_2 = 2,
		time = 43200,
	...
	[1000011] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>重置所有戰術模組，「白方」棋手準時加入棋局， 「黑方」「輕子〈Minor pieces〉」開始移動，行為匹配度：98.3%",
		difficulty = 5,
		avoid_ratio = 14,
		star_require_2 = 2,
		time = 43200,
	...
	[1000012] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>「白方」採用棄兵開局，獲得較小的「出子〈Development〉」領先優勢，行為匹配度：97.1%",
		difficulty = 6,
		avoid_ratio = 15,
		star_require_2 = 2,
		time = 43200,
	...
	[1000013] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>「白方」獲得暫時的「主動權〈Initiative〉」，「黑方」開始發動「反擊〈Counterplay〉」，行為匹配度：84.3%",
		difficulty = 7,
		avoid_ratio = 16,
		star_require_2 = 2,
		time = 43200,
	...
	[1000014] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>「白方」獲得「變後〈Promotion〉」，「黑方」採取「穿串〈Skewer〉」行為，行為匹配度：57.9%",
		difficulty = 8,
		avoid_ratio = 17,
		star_require_2 = 2,
		time = 43200,
	...
	[1000018] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Id256>>日誌記錄被中斷>>>檢測到異常數據>>>日誌記錄被覆蓋<<SysLog.Id257>>重置所有戰術模組，「白方」棋手準時加入棋局",
		difficulty = 10,
		avoid_ratio = 18,
		star_require_2 = 2,
		time = 43200,
	...
	[1120021] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "<<SysLog.Undefined>>附加日誌>>「跨越輪迴、突破界限，到達終局<Ending>的挑戰者喲，賭上彼此存在之證明，開始我等最後的廝殺<Game>吧」",
		difficulty = 10,
		avoid_ratio = 18,
		star_require_2 = 4,
		time = 43200,
	...
	[1190001] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "完成護航任務的貝爾法斯特一行，在返航的途中遭遇了新型的塞壬。盡量規避它們的糾纏並取得勝利吧！",
		difficulty = 3,
		avoid_ratio = 8,
		star_require_2 = 2,
		time = 43200,
	...
	[1190002] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "收到緊急電報，第二物資船隊正遭到鐵血艦隊追擊，冰冷的北海再一次成為了戰艦們的狩獵場。",
		difficulty = 4,
		avoid_ratio = 9,
		star_require_2 = 2,
		time = 43200,
	...
	[1190003] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "孤身一艦追擊沙恩霍斯特的貝爾法斯特！誰是獵人，誰又是獵物？命運的捕鼠夾正在悄悄合攏…",
		difficulty = 5,
		avoid_ratio = 10,
		star_require_2 = 2,
		time = 43200,
	...
	[1190004] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "突然出現的新型塞壬和大範圍兵器打亂了參與“鎢”行動的皇家艦隊，嘗試一邊擊退敵人一邊重新合流吧",
		difficulty = 5,
		avoid_ratio = 11,
		star_require_2 = 2,
		time = 43200,
	...
	[1190005] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "不明的大型武器打散了北海的迷霧，“鎢”行動再次啟動，目標——「北方的孤獨女王」鐵必制！",
		difficulty = 6,
		avoid_ratio = 12,
		star_require_2 = 2,
		time = 43200,
	...
	[1190006] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "雖然發現了身份不明的航母卻讓她脫逃了，相對的，被叫做淨化者的塞壬已經被艦隊重重包圍，為了皇家的榮耀，開火！",
		difficulty = 7,
		avoid_ratio = 13,
		star_require_2 = 2,
		time = 43200,
