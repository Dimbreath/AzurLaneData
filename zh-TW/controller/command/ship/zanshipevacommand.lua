...
function slot0.execute(slot0, slot1)
	slot2 = slot1:getBody()
	slot9.ship_group_id = slot2.groupId
	slot9.discuss_id = slot2.evaId
	slot9.good_or_bad = slot2.operation

	pg.ConnectionMgr.GetInstance():Send(17105, {}, 17106, function (slot0)
		slot3 = nil
