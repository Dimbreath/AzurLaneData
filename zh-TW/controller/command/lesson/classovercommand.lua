...
function slot0.execute(slot0, slot1)
	slot2 = slot1:getBody()
	slot8.room_id = slot2.courseID
	slot8.ship_id = slot2.slotVO:GetShip().id

	pg.ConnectionMgr.GetInstance():Send(22006, {}, 22007, function (slot0)
		if slot0.result == 0 then
			...
			for slot8, slot9 in pairs(uv0:GetAttrList()) do
				...
				slot11[1] = pg.attribute_info_by_type[slot8].condition
				slot11[2] = slot9
				slot4[#slot4 + 1] = {}
			end
