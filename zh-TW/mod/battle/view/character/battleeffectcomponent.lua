...
function slot4._AddEffect(slot0, slot1)
	if slot0._effectList[slot1.index or slot0:_GetIndex()] then
		...
		slot5.effect_go = slot4
		slot5.effect_tf = slot4.transform
		slot5.posFun = slot1.posFun
		slot5.rotationFun = slot1.rotationFun
		slot5.startTime = pg.TimeMgr.GetInstance():GetCombatTime()
		slot5.effectFun = slot1.effectFun
		slot3 = {
			currentTime = 0
		}
