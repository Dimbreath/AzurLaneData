...
function slot2.initBarComponent(slot0)
	...
	while 1 <= 5 do
		...
		slot6.progressImage = slot9:GetComponent(typeof(Image))
		slot6.deltaImage = slot10:GetComponent(typeof(Image))
		slot6.progressTF = slot9.transform
		slot6.deltaTF = slot10.transform
	...
	while slot1 <= slot0._HPBarTotalCount do
		...
		slot7 = {
			...
			lowerBound = slot7.upperBound - slot0._stepHP,
