...
function slot3.spawnEnemy(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	slot0._dataProxy:SpawnMonster({}, 1, uv0.UnitType.ENEMY_UNIT, uv1.FOE_CODE)
end
...
function slot3.spawnStrike(slot0, slot1, slot2, slot3, slot4)
	...
	slot5.weaponID = {}
	slot5.attr = {}
	slot5.totalNumber = slot2
	slot5.onceNumber = slot3
	slot5.formation = 10006
	slot5.delay = 0
	slot5.interval = slot4
	slot5.score = 0
