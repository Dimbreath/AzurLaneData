...
function slot1.spawnArea(slot0, slot1)
	...
	if slot1 then
		slot0._flare = slot0._battleProxy:SpawnLastingColumnArea(slot0:GetEffectField(), slot0:GetIFF(), pg.Tool.FilterY(slot0:GetPosition():Clone()), slot3.range, time, function (slot0)
		...
		end, slot4.friendly, slot4.effect_id, not slot1)
	end
