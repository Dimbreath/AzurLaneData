...
function slot8.TirggerBattleStartBuffs(slot0)
	for slot4, slot5 in pairs(slot0._fleetList) do
		...
		for slot14, slot15 in ipairs(slot5:GetUnitList()) do
			...
			if slot15 == slot5:GetFlagShip() then
...
function slot8.initCommanderBuff(slot0)
	...
	for slot5, slot6 in ipairs(slot0) do
		for slot12, slot13 in ipairs(slot6[2]) do
			slot16.id = slot13
			slot16.level = slot6[1]:getSkills()[1]:getLevel()
			slot16.commander = slot7
...
function slot8.SpawnMonster(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	slot11 = uv0.CreateBattleUnitData(slot6, slot3, slot4, slot1.monsterTemplateID, nil, slot8, slot1.extraInfo, nil, slot0._completelyRepress, slot0._repressReduce, slot0._repressEnemyHpRant, nil, nil)

	slot11:SetPosition(uv1.RandomPos(slot1.corrdinate))
	slot11.SetAI(slot11, slot1.pilotAITemplateID or slot7.pilot_ai_template_id)
	...
	slot11.SetMoveCast(slot11, slot1.moveCast == true)
	...
	slot13.type = slot3
	slot13.unit = slot11
	slot13.bossData = slot1.bossData
	slot13.extraInfo = slot1.extraInfo
...
function slot8.UpdateHostileSubmarine(slot0, slot1)
	...
	slot6.count = slot0._enemySubmarineCount
...
function slot8.SpawnVanguard(slot0, slot1, slot2)
	...
	slot6 = slot0._cldSystem

	slot6:InitShipCld(slot4)

	slot6.type = uv0.UnitType.PLAYER_UNIT
	slot6.unit = slot4
...
function slot8.SpawnMain(slot0, slot1, slot2)
	...
	slot7 = slot0._cldSystem

	slot7:InitShipCld(slot6)

	slot7.type = uv1.UnitType.PLAYER_UNIT
	slot7.unit = slot6
...
function slot8.SpawnSub(slot0, slot1, slot2)
	...
	slot8 = slot0._cldSystem

	slot8:InitShipCld(slot7)

	slot8.type = uv2.UnitType.PLAYER_UNIT
	slot8.unit = slot7
...
function slot8.SpawnManualSub(slot0, slot1, slot2)
	...
	slot6.type = uv0.UnitType.SUB_UNIT
	slot6.unit = slot4
...
function slot8.generatePlayerUnit(slot0, slot1, slot2, slot3, slot4)
	...
	slot10.InitCurrentHP(slot10, slot1.initHPRate or 1)
...
function slot8.CreateAircraft(slot0, slot1, slot2, slot3, slot4)
	if slot4 then
		uv0.CreateAircraftUnit(slot0:GenerateAircraftID(), slot2, slot1, slot3):SetSkinID(slot4)
	end
...
function slot8.SpawnLastingColumnArea(slot0, slot1, slot2, slot3, slot4, slot5, slot6, slot7, slot8, slot9, slot10, slot11)
	slot13 = uv0.Battle.BattleLastingAOEData.New(slot0:GenerateAreaID(), slot2, slot6, slot7, slot11)
...
function slot8.SpawnLastingCubeArea(slot0, slot1, slot2, slot3, slot4, slot5, slot6, slot7, slot8, slot9, slot10, slot11, slot12)
	slot14 = uv0.Battle.BattleLastingAOEData.New(slot0:GenerateAreaID(), slot2, slot7, slot8, slot12)
...
function slot8.SpawnEnvironment(slot0, slot1)
	...
	function slot6(slot0)
		for slot5, slot6 in ipairs(slot0) do
			if slot6.Active then
				table.insert({}, uv0._unitList[slot6.UID])
			end
		end
	...
	slot3:SetAOEData((#slot1.cld_data ~= 1 or slot0:SpawnLastingColumnArea(slot9, slot10, slot5, slot1.cld_data[1], slot11, slot6, slot7, false, slot1.prefab, true, slot8)) and slot0:SpawnLastingCubeArea(slot9, slot10, slot5, slot1.cld_data[1], slot1.cld_data[2], slot11, slot6, slot7, false, slot1.prefab, true, slot8))
...
function slot8.SubmarineStrike(slot0, slot1)
	...
	for slot8, slot9 in ipairs(slot2:GetSubList()) do
		if slot8 == 1 then
			...
			slot9:TriggerBuff(uv0.BuffEffectType.ON_SUB_CONSORT)
		end
	end
