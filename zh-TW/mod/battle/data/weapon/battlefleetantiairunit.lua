...
function slot8.flush(slot0)
	...
	for slot6, slot7 in pairs(slot0._crewUnitList) do
		...
		slot10.weight = uv1.AntiAirPowerWeight(slot6:GetAttrByName("antiAirPower"))
		slot10.rst = slot6
		slot1[#slot1 + 1] = {}
	end
...
function slot8.Fire(slot0)
	...
	slot0._dataProxy:SpawnColumnArea(uv1.AOEField.AIR, slot0._host:GetIFF(), slot0._host:GetPosition(), slot0._range * 2, -1, function (slot0)
		slot1 = {}
