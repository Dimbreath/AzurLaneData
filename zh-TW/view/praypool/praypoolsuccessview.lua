...
function slot0.initUI(slot0)
	slot1[1] = slot0:findTF("Ship1")
	slot1[2] = slot0:findTF("Ship2")
	slot0.shipTF = {}
	...
	onButton(slot0, slot0.buildBtn, function ()
		...
		slot8[1] = math.floor(uv0.playerProxy:getData().gold / slot2.use_gold)
		slot8[2] = math.floor(uv0.bagProxy:getItemCountById(uv0.useItem) / slot2.number_1)
		slot8[3] = MAX_BUILD_WORK_COUNT - table.getCount(uv0.buildShipProxy:getRawData())

		uv0.buildMsgBox:show(math.max(1, _.min({})), function (slot0)
...
function slot0.updatePaint(slot0, slot1)
	for slot5 = 1, 2, 1 do
		...
		setPaintingPrefabAsync(slot0:findTF("Paint", slot10), Ship.getPaintingName(slot6), "build", function ()
			...
			slot4.SetFloat(slot4, "_Range", uv2 == 2 and 0.9 or -0.57)
			slot4.SetFloat(slot4, "_Degree", uv2 == 2 and -50 or 50)
...
slot1[2] = Color(0.5568627450980392, 0.5568627450980392, 0.5568627450980392, 1)
slot1[3] = Color(0.1568627450980392, 0.26666666666666666, 0.615686274509804, 1)
slot1[4] = Color(0.32941176470588235, 0.1568627450980392, 0.615686274509804, 1)
slot1[5] = Color(1, 0.8313725490196079, 0.3137254901960784, 1)
slot0.Rarity_To_Light_Color_1 = {}
slot1[2] = Color(0.6235294117647059, 0.6549019607843137, 0.7411764705882353, 1)
slot1[3] = Color(0.34901960784313724, 0.5294117647058824, 0.996078431372549, 1)
slot1[4] = Color(0.9058823529411765, 0.615686274509804, 0.996078431372549, 1)
slot1[5] = Color(0.996078431372549, 0.8705882352941177, 0.3215686274509804, 1)
