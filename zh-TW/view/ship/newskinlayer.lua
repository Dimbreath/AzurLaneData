...
function slot0.showExitTip(slot0)
	slot3.content = i18n("give_up_cloth_change")
...
function slot0.didEnter(slot0)
	...
	slot0.onSwitch(slot0, slot0.changeSkinBtn, table.getCount(slot0.sameShipVOs) > 0)
...
function slot0.paintView(slot0)
	...
	while slot0._shake.childCount > 0 do
		...
		if slot4:GetChild(slot3).gameObject.activeSelf and slot4 ~= slot0._paintingTF and slot4 ~= slot0._bg then
			slot1[#slot1 + 1] = slot4
...
function slot0.openSelectPanel(slot0)
	...
	onButton(slot0, slot0.confirmChangeBtn, function ()
		if not uv0.selectIds or #uv0.selectIds <= 0 then
			slot2.content = i18n("new_skin_no_choose")
