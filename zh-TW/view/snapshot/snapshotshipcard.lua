...
function slot0.flush(slot0)
	if slot0.shipGroup then
		...
		slot4 = slot1:isBluePrintGroup() and "0" or ""
		slot0.imageBg.sprite = GetSpriteFromAtlas("bg/star_level_card_" .. (slot4 .. shipRarity2bgPrint(slot1:getRarity(slot0.showTrans))), "")
