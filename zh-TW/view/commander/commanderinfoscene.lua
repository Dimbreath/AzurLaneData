...
function slot0.init(slot0)
	...
	slot1[1] = slot0:findTF("blur_panel/left_panel/toggles/play")
	...
	slot1[1] = CommanderPlayPanel.New(slot0.playTF)
...
function slot0.opeRenamePanel(slot0, slot1)
	function slot2(slot0)
		slot3.content = i18n("commander_rename_warning", slot0)
...
function slot0.didEnter(slot0)
	...
	onButton(slot0, slot0.helpBtn, function ()
		if uv0.page == uv1.PAGE_DETAIL then
			...
			slot2.helps = pg.gametip.help_commander_info.tip

			pg.MsgboxMgr.GetInstance():ShowMsgBox({})
		elseif uv0.page == uv1.PAGE_PLAY then
			slot2.type = MSGBOX_TYPE_HELP
			slot2.helps = pg.gametip.help_commander_play.tip

			pg.MsgboxMgr.GetInstance():ShowMsgBox({})
		elseif uv0.page == uv1.PAGE_TALENT then
			slot2.type = MSGBOX_TYPE_HELP
			slot2.helps = pg.gametip.help_commander_ability.tip
