...
slot1 = {}
slot2.tag = i18n("friend_resume_ship_count")
slot1[1] = {
	value = "shipCount",
	type = 1
}
slot2.tag = i18n("friend_resume_collection_rate")
slot2.value = {
	"collectionCount"
}
slot1[2] = {
...
slot2.tag = i18n("friend_resume_attack_count")
slot1[3] = {
	value = "attackCount",
	type = 1
}
slot2.tag = i18n("friend_resume_attack_win_rate")
slot2.value = {
	"attackCount",
	"winCount"
}
...
slot2.tag = i18n("friend_resume_manoeuvre_count")
slot1[5] = {
	value = "pvp_attack_count",
	type = 1
}
slot2.tag = i18n("friend_resume_manoeuvre_win_rate")
slot2.value = {
	"pvp_attack_count",
	"pvp_win_count"
}
...
slot2.tag = i18n("friend_event_count")
slot1[7] = {
...
function slot0.display(slot0, slot1)
	...
	slot7.configId = pg.ship_data_statistics[slot1.icon].id

	for slot12 = slot0.resumeStars.childCount, Ship.New({}):getStar() - 1, 1 do
