...
function slot18()
	...
	function slot2(slot0, slot1)
		...
		for slot8 = 1, #slot0, 1 do
			...
			slot13[1] = slot9.x
			slot13[2] = slot9.y
			slot13[3] = table.contains(slot2, slot8) and -1 or 1
	...
	function slot0.RandomMap(slot0, slot1, slot2, slot3, slot4)
		slot5 = {}
...
function slot22(slot0)
	...
	function (slot0)
		...
		slot1.x = slot0.x
		slot1.y = slot0.y
		slot1.color = slot0.color
		slot0.initData = {
			check = false
		}
	end(slot1)

	slot5.__index = uv4(slot1)
...
function slot23(slot0)
	slot1 = {
		...
		GetAroundCells = function (slot0, slot1)
			...
			slot4[1] = Vector2(slot3.x + 1, slot3.y)
			slot4[2] = Vector2(slot3.x - 1, slot3.y)
			slot4[3] = Vector2(slot3.x, slot3.y - 1)
			slot4[4] = Vector2(slot3.x, slot3.y + 1)
			slot4[5] = Vector2(slot3.x - 1, slot3.y - 1)
			slot4[6] = Vector2(slot3.x + 1, slot3.y + 1)
			slot4[7] = Vector2(slot3.x + 1, slot3.y - 1)
			slot4[8] = Vector2(slot3.x - 1, slot3.y + 1)
			slot4[MULTRES] = Vector2(slot3.x, slot3.y)
...
function slot24(slot0, slot1)
	...
	function slot2.onCellTypeChanged(slot0, slot1)
		uv0(uv1, slot0, slot1)
	end
	...
	function slot2.onCellCheckChanged(slot0, slot1)
		uv0(uv1, slot0, slot1)
	end

	function slot2.SetCheck(slot0, slot1)
		setActive(slot0.checkTF, slot1)
	end

	function slot2.GetSprite(slot0)
		slot1 = slot0.cell
		slot3 = slot1.y
	...
	function slot2.GetAnimationKey(slot0, slot1)
		slot2 = ""
...
function slot25(slot0, slot1, slot2)
	...
	function slot3.onCellCreate(slot0, slot1)
		uv0(uv1, slot0, slot1)
	end
	...
	function slot3.onTurnCntUpdated(slot0, slot1)
		uv0(uv1, slot0, slot1)
	end
	...
	function slot3.onHighestUpdated(slot0, slot1)
		uv0(uv1, slot0, slot1)
	end
	...
	function slot3.onDestoryCells(slot0)
		uv0(uv1, slot0)
	end
	...
	function slot3.onCellTip(slot0, slot1)
		uv0(uv1, slot0, slot1)
	end
	...
	function slot3.onMapInitDone(slot0)
		uv0(uv1, slot0)
	end
	...
	function slot3.ResetMap(slot0)
		if slot0.map.calcStep == slot0.map.maxCount then
			return
		end

		slot3.content = i18n("black_white_grid_reset")
	...
	function slot3.AddTipTimer(slot0)
		if slot0.timer then
			slot0.timer:Stop()
		end
	...
	function slot3.StopTipTimer(slot0)
		if slot0.timer then
			slot0.timer:Stop()
	...
	function slot3.ShouldShowStartBg(slot0)
		return not slot0.map:inProcess()
	end

	function slot3.RecordStartBg(slot0)
	end

	function slot3.GetCellTpl(slot0, slot1)
		return slot0.poolMgr:Get(slot1:GetCellColorStr())
	end

	function slot3.AddListener(slot0)
	...
	function slot3.RemoveListener(slot0)
...
function slot0.didEnter(slot0)
	...
	onButton(slot0, slot0.helpBtn, function ()
		...
		slot2.helps = pg.gametip.black_white_grid_notice.tip
	...
	for slot7, slot8 in ipairs(slot0.activityVO:getConfig("config_data")) do
		...
		onButton(slot0, slot10, function ()
			...
			if uv0.mapView then
				if uv0.mapView.map:inProcess() then
...
function slot0.GetMapVO(slot0, slot1)
	slot2 = nil
	slot6.highestScore = table.indexof(slot0.passIds, slot1.id) and slot0.scores[slot3] or 0
	slot6.isFinished = table.contains(slot0.passIds, slot1.id)
	slot6.isUnlock = slot0:isUnlock(slot1)
	...
	if slot0.maps[slot1.id] then
		...
		slot10.id = slot1.id
		slot10.maxCount = slot1.num
		slot10.condition = slot1.condition

		uv0({}):UpdateData(slot6)
	end
...
function slot0.playStory(slot0, slot1)
	if uv0[slot0.mapView.map.id].story and slot2 ~= "" then
		if not pg.StoryMgr.GetInstance():IsPlayed(slot2) then
