...
function slot0.init(slot0)
	...
	slot1[1] = FriendListPage.New(slot0.pages, slot0.event, slot0.contextData)
	slot1[2] = FriendSearchPage.New(slot0.pages, slot0.event)
	slot1[3] = FriendRequestPage.New(slot0.pages, slot0.event)
...
function slot0.wrapData(slot0)
	slot1.friendVOs = slot0.friendVOs
	slot1.requestVOs = slot0.requestVOs
	slot1.searchResults = slot0.searchResultVOs
	slot1.blackVOs = slot0.blackVOs
	slot1.playerVO = slot0.playerVO
