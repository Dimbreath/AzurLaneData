...
function slot0.register(slot0)
	...
	slot3:updateRes(getProxy(PlayerProxy):getData())
	...
	slot0:bind(uv0.ON_ITEM, function (slot0, slot1)
		slot4.type = MSGBOX_TYPE_SINGLE_ITEM
		slot5.type = DROP_TYPE_ITEM
		slot5.id = slot1
		slot5.cfg = pg.item_data_statistics[slot1]
		slot4.drop = {}
...
function slot0.listNotificationInterests(slot0)
	slot1[1] = GAME.UPGRADE_EQUIPMENTS_DONE
