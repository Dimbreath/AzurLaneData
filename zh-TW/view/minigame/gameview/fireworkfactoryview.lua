...
function slot0.didEnter(slot0)
	onButton(slot0, slot0.btn_back, function ()
		...
		elseif uv0:CheckpowderDispensed() and uv0.flagStart then
			slot2.content = i18n("tips_firework_exit")
	...
	onButton(slot0, slot0.btn_help, function ()
		...
		slot2.helps = pg.gametip.help_firework.tip
	...
	slot4.groupName = LayerWeightConst.GROUP_FIREWORK_PRODUCE
...
function slot0.UpdateDispenseBtn(slot0)
	slot0.SetImageSprite(slot0, slot0.btn_load_img, slot0:CheckpowderDispensed() and "btn_loadcompleted" or "btn_load")
	slot0.SetSprite(slot0, slot0.btn_load_text, slot1 and "load_completed" or "load_ready")
