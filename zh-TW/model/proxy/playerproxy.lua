...
function slot0.register(slot0)
	...
	slot0:on(11015, function (slot0)
		...
		for slot5, slot6 in ipairs(slot0.buff_list) do
			slot7.id = slot6.id
			slot7.timestamp = slot6.timestamp
	...
	slot0:on(11503, function (slot0)
		...
		slot5.shopId = slot0.shop_id
		slot5.payId = slot0.pay_id
		slot5.gem = slot0.gem
		slot5.gem_free = slot0.gem_free
