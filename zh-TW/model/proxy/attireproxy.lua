...
function slot0.register(slot0)
	...
	if uv2 then
		slot0.timer = Timer.New(function ()
			for slot5 = 1, 5, 1 do
				slot8.type = slot5 % 2 == 0 and DROP_TYPE_ICON_FRAME or DROP_TYPE_CHAT_FRAME
				slot8.id = ({
					101,
					102,
					201,
...
function slot0.addExpiredTimer(slot0, slot1)
	...
	function slot2()
		...
		if slot1:getAttireByType(slot2:getType()) == uv0.id then
	...
	if slot1:getExpiredTime() - slot4:GetServerTime() > 0 then
...
function slot0.needTip(slot0)
	...
	slot3[1] = slot2.iconFrames
	slot3[2] = slot2.chatFrames
	slot3[3] = slot2.trophys
