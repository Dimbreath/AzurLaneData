...
function slot7(slot0, slot1)
	...
	elseif slot1.drop.type == DROP_TYPE_SHIP then
		setTextEN(slot3, Ship.getWords(slot14, "drop_descrip") or i18n("ship_drop_desc_default"))
	...
	elseif slot1.drop.type == DROP_TYPE_EMOJI then
		setTextEN(slot3, slot1.drop.cfg.item_desc)
	end

	if slot1.intro then
		setTextEN(slot3, slot1.intro)
	end
