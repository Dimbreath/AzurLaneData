return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "사진으로 판단하자면 최소 두 자릿수의 세이렌 편대가 주변 해역을 배회 중이에요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "고작 양동 노선인데 세이렌이 이렇게 대규모의 함대를 보내오다니……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "하지만, 바꿔 말하면…우리 쪽에서 유인할 수 있는 적이 많을수록 엔터프라이즈 선배님 쪽의 압력이 적어진다는 겁니다!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "준비가 충분할 때 전투를 시작하고 싶지만 병사는 전장을 고를 수 없는 법이니…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
