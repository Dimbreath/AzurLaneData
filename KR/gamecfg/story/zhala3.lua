return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 603020,
			nameColor = "#a9f548",
			say = "으…… 트렌토씨는 역시 마이페이스네요. 그저 카라비니에레에게 옷을 골라줬을 뿐인데 말이죠. 친구를 사귄 건 그녀가 노력한 덕분이에요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 603020,
			nameColor = "#a9f548",
			say = "지휘관님, 아직도 트렌토씨의 따뜻함에서 벗어나지 못하고 계신가요? 저도 그녀의 기분을 느껴보고 싶은데요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 603020,
			nameColor = "#a9f548",
			say = "지휘관님의 얼굴, 붉어졌네요. 저와 트렌토씨의 중에, 어느 쪽이 더 마음에 드시나요?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
