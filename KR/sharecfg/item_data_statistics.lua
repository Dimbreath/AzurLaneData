...
* 개명처리에는 별도의 통지가 진행되지 않습니다.]],
	...
	[41314] = {
		display = "애버크롬비 에게 받은 밸런타인 데이 선물",
		rarity = 8,
		type = 1,
		name = "밸런타인 데이 선물",
		shop_id = -1,
	...
	[41438] = {
		display = "몬트필리어 에게 받은 밸런타인 데이 선물",
		rarity = 8,
		type = 1,
		name = "밸런타인 데이 선물",
		shop_id = -1,
