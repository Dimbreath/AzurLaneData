...
pg.shop_template = {
	...
	[70008] = {
		group_type = 0,
		resource_num = 800,
		desc = "함선 소녀 스킨 - 「미래의 Ms.시사이드」를 구입",
		type = 6,
		is_auto_use = 0,
		group_limit = 0,
		group_buy_count = 0,
