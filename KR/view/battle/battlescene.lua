...
function slot0.painting(slot0, slot1, slot2, slot3)
	...
	if slot0._skillPaintings[slot1.id] == nil then
		slot4 = nil
		slot0._skillPaintings[slot1.id] = ys.Battle.BattleResourceManager:GetInstance():InstPainting(((HXSet.isHx() or slot1.painting) and ((slot1.painting_hx ~= "" and slot1.painting_hx) or slot1.painting)) or slot1.prefab)

		setParent(ys.Battle.BattleResourceManager.GetInstance().InstPainting(((HXSet.isHx() or slot1.painting) and ((slot1.painting_hx ~= "" and slot1.painting_hx) or slot1.painting)) or slot1.prefab), slot0._paintingFitter, false)
	end
