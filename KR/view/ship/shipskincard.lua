...
function slot0.loadPainting(slot0)
	...
	setActive(slot0.hideObjToggle, ((HXSet.isHx() or slot0.skin.painting) and ((slot0.skin.painting_hx ~= "" and slot0.skin.painting_hx) or slot0.skin.painting)) or "unknown")
