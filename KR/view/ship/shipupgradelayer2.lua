...
function slot0.init(slot0)
	...
	slot0.breakOutBtn = slot0:findTF("bottom/break_btn", slot0.rightPanel)
	slot0.appendStarTips = slot0:findTF("bottom/panel_title/tip", slot0.rightPanel)
	slot0.tipActive = slot0:findTF("tip_active", slot0.breakOutBtn)
	slot0.tipDeactive = slot0:findTF("tip_deactive", slot0.breakOutBtn)
...
function slot0.updateBreakOutView(slot0, slot1)
	...
	if slot12 + #slot0 < 8 then
		slot11(slot0:findTF("attr_8", slot0.attrs), {
			preAttr = slot6,
			afterAttr = slot7,
