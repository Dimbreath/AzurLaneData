...
slot1[1] = i18n("backyard_backyardScene_comforChatContent1_1")
slot1[2] = i18n("backyard_backyardScene_comforChatContent2_2")
...
function slot0.getSaveData(slot0)
	...
	for slot5, slot6 in pairs(slot0:getPutFurnis()) do
		...
		slot8.id = slot5
		slot8.x = slot7.x or 0
		slot8.y = slot7.y or 0
		slot8.position = Vector2(slot7.x or 0, slot7.y or 0)
		slot8.dir = slot6.dir or 1
		slot8.child = slot6.child or {}
		slot8.parent = slot6.parent or 0
		slot8.shipId = slot6.shipId or 0
		slot1[slot5] = {}
	end
