...
function slot1.ParseTime(slot0, slot1)
	slot2 = tonumber(slot1) / 100 / 100 / 100 / 100
	slot10.year = slot2 / 100
	slot10.month = slot2 % 100
	slot10.day = slot2 % 100
	slot10.hour = slot2 % 100
	slot10.min = slot2 % 100
	slot10.sec = slot2 % 100
...
function slot1.parseTimeFromConfig(slot0, slot1)
	slot4.year = slot1[1][1]
	slot4.month = slot1[1][2]
	slot4.day = slot1[1][3]
	slot4.hour = slot1[2][1]
	slot4.min = slot1[2][2]
	slot4.sec = slot1[2][3]
...
function slot1.inTime(slot0, slot1)
	...
	if #slot1 > 0 then
		function slot4(slot0)
			slot1.year = slot0[1][1]
			slot1.month = slot0[1][2]
			slot1.day = slot0[1][3]
			slot1.hour = slot0[2][1]
			slot1.min = slot0[2][2]
			slot1.sec = slot0[2][3]
