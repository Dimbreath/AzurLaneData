...
pg.activity_template = {
	...
	[616] = {
		...
		config_id = 0,
		is_show = 0,
		config_data = "activity_drop_616",
		title_res_tag = "",
		id = 616,
		config_client = {
			id = 2,
			bg = "loadingbg/bg_build_2_act",
			buildship_tip = "爱斯基摩人 建造概率UP！",
			rate_tip = {
				"<color=#ffde38>超稀有舰船</color>：7%",
				"<color=#d797ff>精锐舰船</color>：12%",
				"<color=#3dc6ff>稀有舰船</color>：26%",
				"普通舰船：55%",
				"<color=#d797ff>爱斯基摩人</color>：1.4%<color=#92FC63>(up!)</color>"
			}
		}
	},
	[617] = {
	...
	[652] = {
		...
		config_id = 0,
		is_show = 0,
		config_data = "activity_drop_652",
		title_res_tag = "",
		id = 652,
		config_client = {
			id = 1,
			bg = "loadingbg/bg_build_1_act",
			buildship_tip = "U-110の出現率UP!",
			rate_tip = {
				"<color=#ffde38>SSレア</color>：7%",
				"<color=#d797ff>Sレア</color>：12%",
				"<color=#3dc6ff>レア</color>：51%",
	...
	[738] = {
		...
		config_client = {
			id = 1,
			bg = "loadingbg/bg_build_1_act",
			buildship_tip = "プリンストンの出現率UP!",
			rate_tip = {
				"<color=#ffde38>SSレア</color>：7%",
				"<color=#d797ff>Sレア</color>：12%",
				"<color=#3dc6ff>レア</color>：51%",
				"ノーマル：30%",
				"<color=#d797ff>プリンストン</color>：1.4%<color=#92FC63>(up!)</color>"
			}
		}
	},
	[750] = {
