...
pg.ship_data_create_material = {
	...
	},
	{
		...
		rate_tip = {
			...
			"<color=#3dc6ff>レア</color>：51%",
			"ノーマル：30%",
			"<color=#ffde38>ザラ</color>：2.0%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>ポーラ</color>：2.0%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>フォーミダブル</color>：2.0%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>リットリオ</color>：0.5%",
			" ",
			"<color=#d797ff>ヴィンチェンツォ・ジョベルティ</color>：2.5%(<color=#92fc63>up!</color>)",
			" ",
