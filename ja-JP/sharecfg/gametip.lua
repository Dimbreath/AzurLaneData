		...
		tip = {
			{
				info = [[
■概要
開放される「おえかき」を完成させることで「お年玉」
や駆逐艦「鞍山」などの報酬を獲得できます。
「絵の具」を使用することで「おえかき」を完成させる
ことができます。
「絵の具」はイベント期間中の「累計燃料消費数」に応
じてクリアできる特殊任務より入手できます。

累計燃料消費数15000で、全ての「おえかき」の完成に
必要な「絵の具」を入手することができます。
...
れます。]]
	...
	link_link_help_tip = {
		tip = {
			...
			{
				info = "1.「サンディエゴスター」を入手できる回数は毎日0:00\nに1回増加します；"
			},
			{
				info = "2.前日イベントに参加しなかった・ミニゲームをクリア\nしなかった場合でも回数が自動で上乗せされます；"
			},
			{
				info = "3.「サンディエゴスター」の入手個数は「何度目の入手」\nかによって、毎回異なります；"
			},
			{
				info = "4.同じキャラアイコンをタップして、下記の条件を満たす\nと、キャラアイコンを消すことができます；"
			},
			{
				info = [[
5.条件：2つのキャラアイコ
ンの間でほかのキャラアイコンを経由することなく、直
線（横・縦）3つ以下で繋げられる場合、キャラアイコン
を消すことができます；]]
			},
			{
				info = "6.すべてのキャラアイコンを消すと、「サンディエゴス\nター」を入手できます；"
			},
			{
				info = "7.「サンディエゴスター」を7日間プレイして18個入手\nすると、改造素材「輝く☆マイク」を入手できます；"
			},
			{
				info = "8.「輝く☆マイク」を入手済み、もしくは「サンディエ\nゴ改」を持っている場合、代わりにアイテム「サンデ\nィエゴ☆スター」を入手できます；"
			}
		}
	},
...
<color=#92fc63>データキー</color>とは、過去開催済みのイベントステージや
再度攻略できる<color=#92fc63>作戦履歴</color>を一定期間開放できるアイテ
ムです。
<color=#92fc63>作戦履歴</color>に実装されるまでに、過去にプレイした際の
ステージの攻略進捗は引き継がれません。]]
			},
			{
				info = "    \n    1.<color=#92fc63>データキー</color>は現状、毎日のデイリー任務で4個手\nに入れることができます"
			},
			{
				info = "    2.<color=#92fc63>データキー</color>は最大60個まで所持できます。60個\n所持している状態で新たに手に入れた超過分の<color=#92fc63>デー\nタキー</color>は自動で削除されます"
			},
			{
				info = "    3.<color=#92fc63>データキー</color>1個につき、<color=#92fc63>作戦履歴</color>の常設イベント\nステージを1回開放することが可能です"
			},
			{
				info = "    4.<color=#92fc63>作戦履歴</color>内のイベントのエクストラステージ以外\nのステージに挑戦できます"
			},
			{
				info = "    5.ステージ挑戦中に艦隊を撤退させても、消費した\nデータキーは返却されません"
			}
		}
	},
...
に得られる「熟練度」が2倍になります]]
	...
	shop_street_activity_tip = {
		tip = "*<color=#A1E400FF>21.2.4-21.2.18</COLOR>では<color=#A1E400FF>装備外装箱</color>が100%出現します"
	},
	twitter_link_title = {
		tip = "連携中のツイッター：$1"
	},
...
科学研究項目左上の「Ⅰ」「Ⅱ」「Ⅲ」マークから確認
できます。

②
研究項目一覧画面右下の「研究指向」選択画面が一新さ
れました。
「研究指向」では、研究項目の出現傾向（最低三つ当該研
究項目が出現する）を「第一期」「第二期」「第三期」
から選択することが可能です。
また、新たに追加された「強化指向」では、特別計画艦
を1隻選択することで、科学研究項目完了時にその艦船の
強化ユニットを追加で入手できます。

研究指向、強化指向の対象は科学研究室のメイン画面下
部の「指向設定」バナーから確認できます。]]
			}
		}
	},
...
任務」を追加しました。
指揮官レベルが30に到達すると、新兵任務画面右下の
「開発」タブが開放されます。
「開放」タブをタップすると、開発ドック関連の任務を
確認することができます。]]
			},
			{
				info = [[
「開発」任務をクリアすると、特別計画艦（一期）の開
発の加速を行えるアイテム「戦術データパック」を入手
できます。
「戦術データパック」は開発ドックにて特定の艦船の
「戦術データ蓄積」任務の経験値に変換できます。]]
			},
			{
				info = "ルール："
			},
			{
				info = [[
1.新兵任務に開催期間はありません
2.現段階（初級・中級・上級）の任務をすべてクリアする
と、チャレンジ任務が開放されます
3.チャレンジ任務をクリアすると、次の段階に進めます
4.全ての任務をクリアし、報酬を受け取ったあと、新
兵任務は消失します]]
			}
		}
	},
...
きます；]]
	...
	world_boss_help = {
		tip = {
			...
			{
				info = [[
イベント期間中、エセックスが率いる「ユニオン演
習艦隊」を相手に戦う「合同演習作戦」特別ステージが
登場します。
...
マップで自由に移動できます。
4.ノーマル海域においては「空襲」、「待ち伏せ」が出
現しなくなります
5.周回モードでは、「出撃確認skip」機能を使用できま
す
6.周回モードでは、<color=#92fc63>自動攻略モード</color>機能を使用できます

自動攻略モードについて
自動攻略モードでは艦隊の移動・戦闘確認・戦闘・
戦闘結果画面確認の挙動が自動で行われます
自動攻略モードのON/OFFは<color=#92fc63>海域選択画面下部のチェッ
クボックス</color>と<color=#92fc63>マップ画面右下のボタンで</color>設定を変更でき
ます

自動攻略モードでは、艦隊の挙動が下記の仕様になりま
す
・敵に向けて<color=#92fc63>自動で</color>移動し、戦闘を仕掛けます
・戦闘を仕掛ける敵の優先順位は<color=#92fc63>【敵中枢艦隊＞人型セ
イレーン艦隊＞近くにいる量産型艦隊】</color>になります
・艦隊の挙動は出撃準備画面の「自動設定」で下記四通
りの設定に変更できます

　道中戦闘：<color=#92fc63>敵中枢艦隊以外の艦隊</color>にのみ戦闘を仕掛け
ます。行動艦隊として海域で移動・戦闘を行います
　中枢戦闘：<color=#92fc63>敵中枢艦隊にのみ</color>戦闘を仕掛けます。敵中
枢艦隊が出現した場合、行動艦隊に切り替えられます
　全戦闘：<color=#92fc63>敵艦隊全て</color>に戦闘を仕掛けます
　待機：敵艦隊に戦闘を仕掛けず、移動しません

※出撃艦隊が2ついる場合、「道中艦隊」と「中枢艦隊」
の組み合わせ、もしくは「全戦闘」と「待機」の組み合
せで設定しなければなりません
　出撃艦隊が1つだけの場合、「全戦闘」で自動設定さ
れます

・戦闘中、潜水支援を行いません
・自動攻略モードは、手動で停止するか、下記の状況が
発生時に停止されます
　艦船のコンディション低下している場合
　資金が備蓄上限を上回った場合
　戦闘可能な量の燃料がない場合
　ドックが満杯になった場合
　戦闘で敗北した場合（もしくは艦隊を維持できない場
合）
　新しい艦船を図鑑に登録した場合]]
			}
		}
...
<color=#FF5C5C>（※2020年7月16日まで常設建造した艦しか出現し
ません）</color>]]
			},
			{
				info = [[
...
ります；]]
	...
	tec_target_catchup_help_tip = {
		tip = {
			...
			{
				info = "強化指向とは、「研究開発室」の「開発指向」で、特別\n計画艦を1隻選ぶことで、科学研究項目完了時にその艦\n船の強化ユニットを追加で入手できる機能になります。"
			},
			{
				info = "■遊び方"
			},
			{
				info = [[
・「強化指向」を有効化するには、「強化指向」で特別
計画艦を1隻選択する必要があります。
・同時に選択できる特別計画艦は1隻のみになります。
選択中の特別計画艦はいつでも変更することができま
す。
・科学研究項目完了時、選択中の特別計画艦に応じてそ
の艦船の強化ユニットを手に入れることができます。
・「強化指向」で入手できる強化ユニット数は特別計画
艦の各期毎に最大300個までです。
]]
			},
			{
				info = [[
※「強化指向」で入手できる特別計画艦1期の強化ユニ
ット数は、1期の特別計画艦6隻合計で最大300個までと
なります。
※「強化指向」とは別に、特定の艦船の強化ユニット
を追加で入手できるイベントが開催される予定です。]]
			}
		}
	},
	tec_speedup_title = {
...
ぞれ入手/前進出来ます。
			...
			{
				info = [[
・開発対象は24時間に1度しか変更できません。また
、開発対象のデフォルト設定は「大艦隊容量＋」にな
ります。
(new!)・毎日の進捗ゲージの進捗可能回数は、大艦隊
メンバー数上限×3になります。進捗可能回数が上限に
達してしまった場合、「物資拠出」を行っても、進捗ゲ
ージが前進することはありません。（個人貢献Ptは獲得
できます）]]
			}
		}
	},
...
が出来ます。
(new!)・毎日の「物資拠出」による大艦隊資金入手可
能回数は、艦隊のメンバー数上限×３になります。大艦
隊資金入手可能回数が上限に達してしまいますと、そ
の日に「物資拠出」を行っても大艦隊資金が増加しませ
ん（個人貢献Ptが増加します）
		...
		tip = {
			{
				info = [[
■概要
三周年の招待状とは、SSR艦船と交換できる記念アイテ
ムになります。
三周年の招待状を入手するには、入手進捗を最後まで進
める必要があります。

■遊び方
・三周年キャンペーンの期間中毎日ゲームにログインす
ると、「ゲーム回数」を1回加算されます。
・ゲーム回数が1回以上所持している状態で、「重桜トラ
ベル」のミニゲーム「饅頭パズル」をプレイすると、ゲ
ーム回数が1回消費され、招待状の入手進捗が1回前進し
ます。
・手に入れた招待状は「倉庫」で使用でき、招待状を使
用すると、SSR艦船を入手できるほか、3周年の記念アイ
テムを入手できます。]]
			}
		}
	},
...
明石のお店で、引き続き購入するのはいかがかにゃ？]]
	...
	ur_exchange_help_tip = {
		tip = {
			...
			{
				info = [[
ブリ集めとは、「特装型ブリMKⅢ」と交換する「特装
コア」を入手できる常設キャンペーンになります。キャ
ンペーン開催期間中、下記の方法で「特装コア」を入手
することができ、また毎月の入手可能個数に上限が存在
します。入手可能数上限は毎月1日0:00にリセットされ
ます。]]
			},
			{
				info = "■「特装コア」の入手方法"
			...
			{
				info = [[
①ウィークリー任務「常設デイリー任務を20/50個クリ
アする」をクリアすると、「特装コア」を大量に入手す
ることが出来ます。
②メイン海域（ノーマル・ハード）、イベント海域、作
戦履歴の常設化イベント海域に出撃し、敵中枢艦隊を撃
破した際、「特装コア」を少し入手することが出来ます。
③科学研究室で科学研究を行うと、「特装コア」を少し
入手することがあります。
④建造で入手したUレア艦船を退役すると、「特装コア」
を入手することができます。]]
			}
		}
	},
...
■概要
味方前衛艦隊に【駆逐艦】【軽巡洋艦】が編成されてお
り、かつ戦闘中戦闘可能な状態でいる場合、敵潜水艦が
味方の「探知範囲」内に入ると自動で「探知済」状態に
なります。
「探知済」状態の敵潜水艦は味方の爆雷攻撃で狙えるよ
うになりますが、「探知範囲」から離れて一定の時間が
経過すると再度「未探知」状態に戻ります。

■探知範囲の計算方法について
味方前衛艦隊の「探知範囲」の広さ（同心円の半径）は
4つの項目で計算されます。
①前衛艦隊【駆逐艦】【軽巡洋艦】のそれぞれ「対潜」
艦船基本ステータスの最大値
②主力艦隊艦船の「対潜」ステータスの合計値
③兵装「ソナー」による「探知範囲」の増加値
④その他海域マップ効果・敵艦スキルなど

※スキルや装備、オフニャ、艦隊技術による「対潜」ス
テータスは探知範囲に影響しません
]]
			}
		}
...
までの期間限定で受領できます。]]
	...
	doa_pt_help = {
		tip = {
			...
			{
				info = [[
イベント期間中、「ヴィーナスPt」を一定数集めると、
「ライセンスランク」を上昇させることができます。
「ライセンスランク」を上昇させると、イベント期間中
、味方艦隊を強化する強化効果を取得することができま
す。
強化効果はそれぞれ2回ずつ取得することができます。]]
			...
			{
				info = [[
・STR　海域における味方艦隊が敵艦隊に与えるダメー
ジを上昇させる
・TEC　戦術教室でスキルレベル上昇の所要時間を短縮
させる
・STM　海域における味方艦隊が得られる経験値を上昇
させる
・APL　寮舎で獲得する経験値を上昇させる]]
			},
			{
				info = "ライセンスランクレベル、強化効果Lvは「累計Pt報酬」\nイベント画面右上で確認することができます。"
			}
		}
	},
	doa_pt_complete = {
		...
		tip = {
			{
				info = [[
■概要
「饅頭雪合戦」とは、駆逐艦たちが投げてくる雪玉を避
けながら、雪玉を駆逐艦に当てることで得点を稼いでい
くミニゲームです。
「饅頭雪合戦」は毎日1試合開放されていき、7試合をク
リアすると、春月のきせかえを入手できます。]]
			},
			{
				info = "■遊び方"
			},
...
・陸奥に駆逐艦たちの雪玉が当たってしまうと、ライフ
が1減少します。ライフが0になるとミニゲームが終了し
ます。
・画面右側に出現する下記のキャラをタップすると、雪
玉を投げて攻撃でき、当たったキャラに応じて得点が
増減します：
　睦月、如月、卯月、文月、夕立、雪風　　+100
　アーク・ロイヤル　+200
　採掘饅頭、白露　-50
・画面右側の「ぼむゲージ」が時間に応じて増加します。
ゲージが満タンの場合、ゲージをタップすると敵の雪玉
を全部消すことができ、さらに雪玉爆撃を行うことがで
きます。
・「終了」をタップするか、もしくはライフが0になると
、ミニゲームが終了します。]]
			}
		}
	},
		...
		tip = {
			{
				info = [[
■概要
「母港正月2021」イベントとは、ミニゲームを楽しみな
がら、「春月」の着せ替えと駆逐艦「Z28」を入手でき
るイベントです。]]
			},
			{
				info = "■ミニゲームについて"
			...
			{
				info = [[
「饅頭雪合戦」をタップすると、ミニゲーム「饅頭雪合
戦」をプレイすることができます。
試合が開放されている状態でゲームをクリアすると、試
合を進捗させることができ、「幸運祈願」可能回数が2
回増加します。
「饅頭雪合戦」を最後まで進めると、駆逐艦「春月」の
着せ替えを入手できます。

「饅頭グルメ」をタップすると、ミニゲーム「饅頭グル
メ」をプレイすることができます。
ゲーム進捗可能回数を所持している状態でゲームをクリ
アすると、収集アイテムを1個入手でき、
さらにアイテムを7つ集めると駆逐艦「Z28」を入手でき
ます。]]
			},
			{
				info = "■幸運祈願"
			...
			{
				info = "幸運祈願回数を所持している状態では、資金5を消費し\nて幸運祈願の行うことが出来ます。"
			},
			{
				info = "■着せ替え"
			},
...
・幸運祈願は同時に一種類しか適用できず、同じ祈願を複
数回行っても効果は上乗せされません。
・幸運祈願の効果は24時間持続します。また、幸運祈願の
効果適用中にもう一回祈願すると、前の祈願の効果・持続
時間が上書きされます。]]
			},
			{
				info = "■注意"
			...
			{
				info = "「幸運祈願可能回数」が0の場合でもお賽銭を入れること\nができますが、幸運祈願を行うことができません。"
			}
		}
	},
		...
		tip = {
			{
				info = [[
■概要
「饅頭グルメ」とは、艦船の買い出しの依頼に応じ、制
限時間内にみんなが欲しがる食べ物を屋台で購入するミ
ニゲームになります。
正しい食べ物を購入すると、制限時間が増加し、得点を
得ることができます。

制限時間終了、もしくはゲームを中断した場合、ゲーム
クリアになります。]]
			},
			{
				info = "■遊び方"
			...
			{
				info = [[
・ゲーム回数を所持している状態でミニゲームをクリア
すると、アイテム「グルメ券」を入手できます。「グル
メ券」を7つ集めると、駆逐艦「Z28」を入手できます。
・「スタート」をタップすると、画面左のキャラに買い
出し内容が表示されます。
・5秒後、買い出し内容の表示が消え、代わりに購入でき
る食べ物の一覧が出現します。
・制限時間内に食べ物のアイコンをタップすると、購入す
る食べ物を選択することができます。また選択済みの食
べ物アイコンをタップすると、選択をキャンセルするこ
とができます。
・食べ物を3種類選択すると、買い出し結果画面が表示さ
れます。
・購入した食べ物が買い出し内容と一致（並び順を含む）
した場合、得点を入手することができます。
・結果画面で「続ける」をタップすると、ミニゲームを継
続することができます。「終了」をタップするか、もしく
は制限時間が0になると、ミニゲームを終了できます。]]
			}
		}
	},
		...
		tip = {
			{
				info = [[
■概要
ミニゲーム「撫順の大冒険Ⅱ」とは、撫順を操作し年獣
饅頭を倒していくゲームです。
ミニゲームは2.4-2.10に毎日1ステージが開放され、最
初の6ステージを1回目クリアすると「お年玉」、そして
最終ステージをクリアすると駆逐艦「撫順」を入手でき
ます。

また、手に入れたお年玉は「饅頭の年玉」で開封できま
す。

■遊び方
1.画面右から左へと移動する年獣饅頭が「攻撃可能エリ
ア」内に入ると、画面左右のA・Bボタンがあるエリアを
タップすることで年獣饅頭を攻撃できます。
 ※「攻撃可能エリア内」で年獣饅頭がいない場合ボタン
をタップすると空振りしてしまう場合があります。
2.年獣饅頭はサイズによって倒すのに必要な攻撃回数が
異なり、またそれぞれの年獣饅頭を倒す際に得られるス
コアも異なります
 小型年獣饅頭：10pt
 中型年獣饅頭：20pt
 大型年獣饅頭：30pt
3.年獣饅頭を倒すと、画面下部のエネルギーゲージが上
昇します。エネルギーゲージが満タンになると、A・Bボ
タンを連打することで大量のスコアを手に入れることが
できます。
4.年獣饅頭が撫順に接近すると、画面上部のHPが減少し
ます。画面上部のHPがゼロになるか、ゲームを「終了」
ボタンで終了すると、ゲームクリアになります。]]
			}
		}
	},
...
母港春節
「撫順の大冒険Ⅱ」：ミニゲームで年獣を倒し、駆逐艦
「撫順」をGET！
「応瑞春遊記」：毎日ログインして「タップで前進」を
押し、「お年玉」と応瑞の着せかえをGET!
「おえかき」：絵を完成させ、駆逐艦「鞍山」をGET!
「饅頭の年玉」：ミニゲームなどで手に入れた年玉はこ
こで開封可能！
		...
		tip = {
			{
				info = [[
■簡易まとめ
・セイレーン作戦のストーリー4章をクリアすると、毎
月1日0時に下記の動作が行われます。
　　①エリアの「確保」状況がリセットされます。
　　②指揮官行動力と艦船の「適応調整」がリセットさ
れます。
　　③セイレーン作戦専用アイテムが削除され、一部ア
イテムは「備蓄物資交換券」に変換されます。
　・セイレーン作戦トップ画面の「ショップ」で下記の
アイテムを購入可能です。
　　①「燃料」を5000を消費し、便利アイテム「セイレ
ーン海域情報」を購入できます。
　　②「備蓄物資交換券」を消費し、様々なアイテムを
購入できます。
・「セイレーン海域情報」は「アイテム」で使用すると
、
　セイレーン作戦専用資源/アイテムを大量に入手し、
さらにエリア移動制限を解除できます。

■リセットの条件
セイレーン作戦の「リセット」は、セイレーン作戦四章
全てのストーリーをクリアしていると、
毎月1日0:00にセイレーン作戦の海域確保状況・ステー
タスがリセットされます。

リセットの反映は、0：00以降「セイレーン作戦」トッ
プ画面に移行する際に行われます。
すでに配置済みの艦隊は「リバープール」エリアに戻さ
れます。

■リセットされるコンテンツ
セイレーン作戦のリセット発生時、下記のコンテンツが
リセットされます。

①各エリアの確保状況
セイレーン作戦における、各エリアの「確保」状況がリ
セットされます。
また、各エリアの「確保報酬」（エリアマップ一覧での
エリア情報画面に表示される報酬）が再度取得できます
。
※各エリアの「星集め」こと「探索実績」はリセットさ
れません。

下記リセットショップ（特殊補給）でアイテム「セイレ
ーン海域情報」を購入し、
セイレーン作戦の「アイテム」画面で使用することで、
エリアを一括で開放し確保報酬を全部入手することがで
きます。

セイレーン海域情報を使用することで貰えるアイテムま
とめ：
適応調整・攻撃×90
適応調整・耐久×90
適応調整・回復×90
...
※ランダムで出現する「海域の敵全撃破で出現するアイ
テム」は受け取れません。

②艦隊の「セイレーン作戦」におけるステータス
セイレーン作戦にて展開中の艦隊の残り耐久、特殊状態
、適応調整の数値がリセットされます。
