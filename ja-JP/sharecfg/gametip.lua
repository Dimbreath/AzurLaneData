...
ると、報酬を入手することができます。
・おえかき完成の報酬一覧：
No.1 ランダム教科書T2×2、資金×300 
No.2 ランダム改造図T2×2、燃料×100  

No.3 ランダムパーツT2×3、資金×300 
No.4 限定家具x1 
No.5 防御教科書T3×2、資金×300 
No.6 汎用強化パーツT3×3、燃料×100 
No.7 z23の着せ替え  
・イベント終了後、未使用の絵の具はリセットされます
・12月16日（水）まで毎日新しい絵が一枚ずつ解放さ
れます。]]
			}
		}
	},
...
に得られる「熟練度」が2倍になります]]
	...
	shop_street_activity_tip = {
		tip = "*<color=#A1E400FF>21.1.21-21.2.3</COLOR>では<color=#A1E400FF>装備外装箱</color>が100%出現します"
	},
	twitter_link_title = {
		tip = "連携中のツイッター：$1"
	},
...
を開封し、報酬を入手できます。
・「年玉」は「四天王大冒険・撫順編」「四天王大冒険・
鞍山編」「東煌すごろく」「饅頭タワー」を遊ぶことで
入手できます。
・入手した「年玉」を開封する際は「年玉・大」から優先
的に開封されます。開封すると、ダイヤなどの報酬をラ
ンダムで獲得できます。
・「年玉・大」は最大で15個入手できます]]
			}
		}
