...
ると、報酬を入手することができます。
・おえかき完成の報酬一覧：
No.1 ランダム教科書T3 x2 No.2 年玉×1 
No.3 艦砲パーツT3x2  No.4 年玉×1 
No.5 汎用パーツT3 x3 No.6 年玉×1 
No.7 駆逐艦「鞍山」
...
・1月27日（月）まで毎日新しい絵が一枚ずつ解放され
ます。
・空白絵は1月28日（火）以降開放できます。]]
			}
		}
	},
	link_link_help_tip = {
...
きます；]]
	...
	world_boss_help = {
		...
		tip = {
			...
			{
				info = "イベント「戦え！ロイヤルメイド隊2nd」とは、<color=#92fc63>「演習Pt」</color>\nを集めて作戦進捗を進め、個人累計Pt報酬と作戦進捗報\n酬を狙うイベントになります。"
			},
			{
				info = [[
イベント期間中、ダイドーが率いる「ロイヤルメイド演
