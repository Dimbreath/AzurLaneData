...
に得られる「熟練度」が2倍になります]]
	...
	shop_street_activity_tip = {
		tip = "*<color=#A1E400FF>20.9.17-20.9.30</COLOR>では<color=#A1E400FF>装備外装箱</color>が100%出現します"
	},
	twitter_link_title = {
		tip = "連携中のツイッター：$1"
	},
...
5.周回モードでは、「出撃確認skip」機能を使用できます]]
	...
	award_max_warning = {
		tip = "所持上限を超えた分の資源・アイテムが廃棄されてしまいます。報酬を入手しますか？"
	},
	sub_item_warning = {
		...
		tip = {
			{
				info = [[
■ブリ集めとは
ブリ集めとは、「特装型ブリMKⅢ」と交換する
「特装コア」を入手できる常設キャンペーンになります。
キャンペーン開催期間中、下記の方法で「特装コア」
を入手することができ、また毎月の入手可能個数に上限
が存在します。
入手可能数上限は毎月1日0:00にリセットされます。

■「特装コア」の入手方法
①ウィークリー任務「常設デイリー任務を20/50個クリア
する」をクリアすると、「特装コア」を大量に入手するこ
とが出来ます。
②メイン海域（ノーマル・ハード）、イベント海域、作戦
履歴の常設化イベント海域に出撃し、敵中枢艦隊を撃破し
た際、「特装コア」を少し入手することが出来ます。
③科学研究室で科学研究を行うと、「特装コア」を少し入
手することがあります。
