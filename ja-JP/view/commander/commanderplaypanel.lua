...
function slot0.updateMatrtials(slot0, slot1)
	...
	slot2, slot3 = slot0:getSkillExpAndCommanderExp(slot1)
...
function slot0.updateCommanderTF(slot0, slot1)
	...
	if slot2:isMaxLevel() then
		...
		slot0.sliderExpTxt.text = slot2.exp .. (slot1 > 0 and "<color=#A9F548FF>(+" .. slot1 .. ")</color>" or "") .. "/" .. slot2:getNextLevelExp()
