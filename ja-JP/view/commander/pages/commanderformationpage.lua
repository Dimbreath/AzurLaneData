...
function slot0.OnInit(slot0)
	...
	onButton(slot0, slot0.restAllBtn, function ()
		slot3.FleetType = LevelUIConst.FLEET_TYPE_SELECT
		slot4.type = LevelUIConst.COMMANDER_OP_REST_ALL
		slot3.data = {}
		slot3.fleetId = uv0.fleet.id
...
function slot0.UpdatePrefabFleet(slot0, slot1, slot2, slot3)
	...
	onInputEndEdit(slot0, slot4, function ()
		...
		slot5.type = LevelUIConst.COMMANDER_OP_RENAME
		slot5.id = uv2.id
		slot5.str = getInputText(uv0)

		function slot5.onFailed()
			setInputText(uv0, uv1)
		end

		slot4.data = {}
		slot4.fleetId = uv1.fleet.id
	...
	onButton(slot0, slot2:Find("use_btn"), function ()
		slot3.FleetType = LevelUIConst.FLEET_TYPE_SELECT
		slot4.type = LevelUIConst.COMMANDER_OP_USE_PREFAB
		slot4.id = uv1.id
		slot3.data = {}
		slot3.fleetId = uv0.fleet.id
	...
	onButton(slot0, slot2:Find("record_btn"), function ()
		slot3.FleetType = LevelUIConst.FLEET_TYPE_SELECT
		slot4.type = LevelUIConst.COMMANDER_OP_RECORD_PREFAB
		slot4.id = uv1.id
		slot3.data = {}
		slot3.fleetId = uv0.fleet.id
