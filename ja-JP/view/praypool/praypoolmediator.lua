...
function slot0.register(slot0)
	...
	slot0:bind(PrayPoolConst.START_BUILD_SHIP_EVENT, function (slot0, slot1, slot2)
		slot6.buildId = slot1
		slot6.activity_id = ActivityConst.ACTIVITY_PRAY_POOL
		slot6.arg1 = slot2
	...
	slot2 = getProxy(PrayProxy)

	if slot2:getPageState() ~= PrayProxy.STAGE_BUILD_SUCCESS and getProxy(ActivityProxy):getActivityById(ActivityConst.ACTIVITY_PRAY_POOL) then
...
function slot0.listNotificationInterests(slot0)
	slot1[1] = PrayPoolConst.BUILD_PRAY_POOL_SUCCESS
