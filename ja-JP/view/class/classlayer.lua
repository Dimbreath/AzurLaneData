...
function slot0.didEnter(slot0)
	onButton(slot0, slot0.btnBack, function ()
		if not uv0.course:inClass() and #uv0.course.students > 0 then
			slot2.content = i18n("course_exit_confirm")
	...
	onButton(slot0, slot0.btnHelp, function ()
		...
		slot2.helps = i18n("course_class_help")
	...
	onButton(slot0, slot0.btnStart, function ()
		if uv0.course:inClass() then
			slot3.content = i18n("course_stop_confirm")
...
function slot0.updateMainView(slot0)
	...
	slot0:updateShipModel(slot0.teacher:Find("ship"), Ship.New({}):getPrefab(), function (slot0)
	...
	onButton(slot0, slot0.teacher:Find("pop"), function ()
		slot2.content = uv0:getConfig("name")
