...
function slot0.OnSendMiniGameOPDone(slot0)
	...
	slot7.id = MiniGameDataCreator.ShrineGameID
	slot8.count = (getProxy(MiniGameProxy):GetMiniGameData(MiniGameDataCreator.ShrineGameID):GetRuntimeData("count") or 0) + 1
	slot7.map = {}
...
function slot0.onBackPressed(slot0)
	...
	slot3.content = i18n("tips_summergame_exit")
...
function slot0.addListener(slot0)
	...
	onButton(slot0, slot0.helpBtn, function ()
		...
		slot2.helps = pg.gametip.help_summer_food.tip
...
function slot0.openResultView(slot0)
	slot1.orderIDList = slot0.orderIDList
	slot1.selectedIDList = slot0.selectedIDList
	slot1.countTime = slot0.countTime
	slot1.score = slot0.score
	slot1.correctNumToEXValue = slot0:GetMGData():getConfig("simple_config_data").correct_value
	slot1.scoreLevel = slot0:GetMGData():getConfig("simple_config_data").score_level

	function slot1.onSubmit(slot0)
