...
function slot6(slot0)
	...
	slot1._content = slot1._tf:Find("content")
	slot1._mask = slot1._tf:Find("mask")
	slot1._icon = slot1._tf:Find("content/main/bg/icon"):GetComponent(typeof(Image))
	slot1._priceTF = slot1._tf:Find("content/main/bg/price")
	...
	slot1._opriceTxt = slot1._priceTF:Find("originalprice"):GetComponent(typeof(Text))
	slot1._tagTFs = {
		slot1._tf:Find("content/top/tags/tag_hot"),
		slot1._tf:Find("content/top/tags/tag_new"),
		slot1._tf:Find("content/top/tags/tag_advice"),
		slot1._tf:Find("content/top/tags/tag_activity"),
		slot1._tf:Find("content/top/tags/tag_discount"),
		slot1._tf:Find("content/top/tags/tag_nothing"),
		slot1._tf:Find("content/top/tags/tag_bought"),
		slot1._tf:Find("content/top/tags/tag_limit"),
		slot1._tf:Find("content/top/tags/tag_timelimit")
	}
...
function slot0.updateBuyBtn(slot0, slot1)
	...
	onToggle(slot0, slot0.hideObjToggleTF, function (slot0)
		uv0:loadPainting(uv0.painting .. (slot0 and "" or "_n"))
