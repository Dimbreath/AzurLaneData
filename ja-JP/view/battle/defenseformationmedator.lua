...
function slot0.register(slot0)
	...
	slot0:bind(uv0.CHANGE_FLEET_SHIP, function (slot0, slot1, slot2)
		...
		slot13 = uv1
		slot17.activeShipId = slot4
		slot17.quitTeam = slot3 ~= 0
		slot17.teamFilter = slot2
		slot17.ignoredIds = slot8
		slot17.flags = {
			inExercise = true,
			inChapter = false,
			inPvp = false,
		...
		slot17.leftTopInfo = i18n("word_formation")
...
function slot0.configDockYardFunc(slot0, slot1, slot2, slot3, slot4, slot5)
	return function (slot0, slot1)
		...
		if #slot0 > 0 then
			...
			slot6.content = i18n("exercise_clear_fleet_tip")
...
function slot0.listNotificationInterests(slot0)
	slot1[1] = GAME.EXERCISE_FLEET_RESET
