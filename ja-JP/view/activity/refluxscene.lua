...
function slot0.init(slot0)
	slot1[1] = slot0:findTF("left/left_bar/tabs/sign")
	slot1[2] = slot0:findTF("left/left_bar/tabs/task")
	slot1[MULTRES] = slot0:findTF("left/left_bar/tabs/pt")
	slot0.tabs = {}
	slot1[1] = slot0:findTF("panel_sign")
	slot1[2] = slot0:findTF("panel_task")
	slot1[MULTRES] = slot0:findTF("panel_pt")
	slot0.tabPanels = {}
...
function slot0.UpdateSign(slot0)
	setText(slot0.tabPanels[uv0.TabSign]:Find("reduce/text"), slot0.reduceSignDays)

	for slot6 = 0, slot1:Find("days").childCount - 1, 1 do
		...
		for slot15 = 0, slot10.Length - 1, 1 do
			slot10[slot15].color = slot6 + 1 <= slot0.reduceSignDays and Color.gray or Color.white
		end
...
function slot0.UpdatePt(slot0)
	for slot7 = slot0.tabPanels[uv0.TabPt]:Find("scrollview/viewport/list").childCount, #pg.return_pt_template.all - 1, 1 do
	...
	for slot8 = 0, slot3.childCount - 1, 1 do
		...
		slot17.type = slot10[1]
		slot17.id = slot10[2]
		slot17.count = slot10[3]
