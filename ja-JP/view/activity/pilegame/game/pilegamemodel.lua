...
function slot0.AddPile(slot0, slot1)
	...
	slot4.offset = Vector2(slot1.boundary[1], slot1.boundary[2])
	slot4.sizeDelta = Vector2(slot1.boundary[3], slot1.boundary[4])
	slot3.collider = {}
	slot3.speActionCount = slot1.speActionCount or 0
...
function slot0.AddGround(slot0)
	slot1.position = Vector3(0, -slot0.screen.y / 2, 0)
	slot1.pivot = PileGameConst.GROUND_PIVOT
	slot1.sizeDelta = PileGameConst.GROUND_SIZE
	slot0.ground = {}
end
...
function slot0.GetInitPos(slot0)
	...
	for slot6, slot7 in ipairs(slot0.items) do
		slot10[1] = slot7
		slot10[2] = slot7.position.x - slot2
		slot10[3] = slot7.position.x + slot2
