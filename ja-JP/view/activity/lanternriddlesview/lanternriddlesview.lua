...
function slot0.SetUI(slot0, slot1)
	slot0._tf = slot1
	slot2[1] = slot0:findTF("labels/label1")
	slot2[2] = slot0:findTF("labels/label2")
	slot2[3] = slot0:findTF("labels/label3")
	slot2[4] = slot0:findTF("labels/label4")
	slot2[5] = slot0:findTF("labels/label5")
	slot2[6] = slot0:findTF("labels/label6")
	slot2[7] = slot0:findTF("labels/label7")
	slot2[8] = slot0:findTF("labels/label8")
	slot2[9] = slot0:findTF("labels/label9")
	slot2[10] = slot0:findTF("labels/label10")
	slot2[11] = slot0:findTF("labels/label11")
	slot2[12] = slot0:findTF("labels/label12")
	slot2[13] = slot0:findTF("labels/label13")
	...
	onButton(slot0, slot0:findTF("back/help"), function ()
		...
		slot2.helps = pg.gametip.lanternRiddles_gametip.tip
