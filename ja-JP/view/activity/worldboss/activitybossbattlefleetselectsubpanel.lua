...
function slot0.UpdateView(slot0)
	...
	slot1 = pg.SystemOpenMgr.GetInstance():isOpenSystem(getProxy(PlayerProxy):getRawData().level, "CommandRoomMediator") and slot0.useCMD
...
function slot0.OnShow(slot0)
	slot5.groupName = LayerWeightConst.GROUP_FORMATION_PAGE
