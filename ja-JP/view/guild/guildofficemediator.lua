...
function slot0.listNotificationInterests(slot0)
	return {
		...
		GAME.GUILD_DONATE_LIST_UPDATE_DONE,
...
function slot0.handleNotification(slot0, slot1)
	...
	elseif slot2 == PlayerProxy.UPDATED then
		slot0.viewComponent:setPlayer(getProxy(PlayerProxy):getRawData())
	elseif slot2 == GAME.GUILD_COMMIT_DONATE_DONE or slot2 == GAME.GUILD_DONATE_LIST_UPDATE_DONE then
	...
	elseif slot2 == GAME.ZERO_HOUR_OP_DONE then
		slot0:sendNotification(GAME.GUILD_DONATE_LIST_UPDATE, {
			callback = callback
		})
