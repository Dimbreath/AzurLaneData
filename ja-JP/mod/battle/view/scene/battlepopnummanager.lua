...
slot3[1] = slot2.POP_NORMAL
slot3[2] = slot2.POP_PIERCE
slot3[3] = slot2.POP_EXPLO
slot3[4] = slot2.POP_UNBREAK
slot2.FontIndex = {}
slot3[1] = slot2.POP_CT_NORMAL
slot3[2] = slot2.POP_CT_PIERCE
slot3[3] = slot2.POP_CT_EXPLO
slot3[4] = slot2.POP_UNBREAK
slot2.CTFontIndex = {}
...
function slot2.GetPop(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	if slot6 ~= uv0.POP_MISS then
		slot0._allPool[slot6]:GetObject():SetText(slot4)
	end
...
function slot2.generatePool(slot0, slot1, slot2, slot3, slot4)
	slot7.template = slot3:Find(slot1).gameObject
	slot7.parentTF = slot2
	slot7.mgr = slot0

	return pg.LuaObPool.New(uv0.Battle.BattlePopNum, {}, slot4)
end

function slot2.generateTempPool(slot0, slot1, slot2, slot3, slot4)
	slot7.template = slot3.transform:Find(slot1).gameObject
	slot7.parentTF = slot2
	slot7.mgr = slot0
