...
function slot2.SetArgs(slot0, slot1, slot2)
	...
	if slot3.effect then
		...
		slot11 = nil
		slot0._unit = slot1
		slot12.effect = slot3.effect
		slot12.posFun = (not slot9 or function (slot0)
			slot1 = nil

			return uv0.centerPosFun(slot0):Add(uv1)
		end) and slot3.centerPosFun
		slot12.index = slot0._effectIndex
		slot12.rotationFun = slot3.rotationFun
		slot0._evtData = {}
...
function slot2.Deactive(slot0)
	if slot0._effectIndex then
		slot1.index = slot0._effectIndex
