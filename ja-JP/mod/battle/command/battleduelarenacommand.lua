...
function slot3.onUpdateCountDown(slot0, slot1)
	if slot0._dataProxy:GetCountDown() <= 0 then
		slot2 = slot0._userFleet
		slot8, slot10 = slot2:GetDamageRatioResult()
		slot4 = slot0._rivalFleet
		slot9, slot11 = slot4:GetDamageRatioResult()
