return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "是啊……最后结果还是一样，什么有用的结论都没的出来。所有试图探讨塞壬本源的研究最后一定都是这个结果。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "一种说法认为，在过去神话中出现的生物其实在历史各种各样佣兵团的夸张表现哦，比如名叫塞壬的佣兵团之类的。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "再说了，既然面前就有这么多非人的塞壬站着，谁又能保证说神话时代提到的塞壬没有真实存在过呢~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
