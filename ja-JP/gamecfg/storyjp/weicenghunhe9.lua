return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "沿岸航路とはいえ、それまでは大陸沿いで回り道しなければならなかったけど、通る距離が短くなるだけでどれだけありがたいことか…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "その運河を守る要塞がどんどん増築、改修されるのも自然というべきでしょう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "猫探しからヴィランを倒すまで、全力でこなしてこそ人類の親愛なる隣人こと…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "この航路が通行不可となれば、場合によっては文明の逆戻りもありうる",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "カサブランカは湾内の輸送船の退避を。リノはセイレーンの航空攻撃の対処を",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
