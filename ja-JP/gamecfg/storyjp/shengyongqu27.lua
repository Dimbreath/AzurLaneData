return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あのとき…カタパルト作戦のとき、本部の指示があったとはいえ、私たちは選ばなければなりませんでした",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "鉄血の行動を見逃し、危険なセイレーン技術がアイリスを飲み込むのを座視してアイリスの未来を天に委ねるか、",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "私たちの「因子」に従い、ヒトの天性を裏切り憎まれる決断をしてでも、ヴィシアの…アイリスの人々を傷つけるか",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "皆さんからすれば、そんな押し付けられたものが例えどんな結果をもたらそうと、理不尽であり、決してそのまま受け入れるべきではないでしょう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "それでも…私たちは決断しなければならなかったのです。アズールレーンの…人々の未来のために",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "フッド様も、アーク・ロイヤル様も、あの場にいたロイヤルの全員、そして陛下も………「申し訳ない」と、心を痛めておりました",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "ロイヤルめ！メルス・エル・ケビールとか、カサブランカとかに行ってみんなに直接謝罪してこい！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "まず、気持ちは嬉しい――これをみんなに伝えれば無駄な戦いも減るかな？楽しくないけど",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "「あなたがたはこう祈りなさい、天におわしますわれらの父よ、御名があがめられますように」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "「御国が来ますように。みこころが天に行われるとおり、地にも行われますように」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "「わたしたちに負債のある者をゆるしましたように、わたしたちの負債をもおゆるしください」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "「わたしたちを試みに遭わせず、悪しき者からお救いください」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "黒紫色へと変わった聖堂を背に、ヴィシアの護教騎士がこの場に君臨した。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
