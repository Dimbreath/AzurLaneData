return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そこまで気圧されることはなかろう？向こうが伝説の大妖怪と聞いて驚いてはいたが、話してみれば意外と親しみやすかったぞ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "せっかく伝説の存在が相手だ。艦隊の「後輩」たちにも手合わせの機会を与えてはどうだ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
