return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "鉄血や帝国の連中だけがオレたちを陥れようとしているのではなく、",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "アズールレーンから攻撃された時点で、既に答えは見えていた！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "ヴィシア聖座は今存亡の危機に直面している――我々の周りには敵だらけだ。だがそれがどうした！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "あのとき、戦艦ジャン・バールはたしかにトゥーロンで沈んだ――そのはずだった。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "戦艦ジャン・バールのフネとしての人生はトゥーロンで幕を閉じました。しかし彼女はまだ新しい人生の一歩を踏み出さずにいる……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=51>「あなたが過ちを犯したとしても　神にとってどれほどのことだろうか」</size>",
					2.5
				},
				{
					"<size=51>「繰り返し背いたとしても　神にとってそれが何であろう」</size>",
					4
				},
				{
					"<size=51>「あなたが正しくあっても　それで神に何かを与えることになり」</size> ",
					5.5
				},
				{
					"<size=51>「神があなたの手から　何かを受け取ることになるだろうか」</size>",
					7
				},
				{
					"<size=51>神穹（しんきょう）を仰ぐ、そして己の小ささを見つめる。</size>",
					8.5
				},
				{
					"<size=51>ああ、私たちはどれだけ罪深き存在なのだろうか――</size>",
					10
				}
			}
		},
