return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "…あっ。アルジェリーさま、編隊から離脱して単身でこちらに向かってきますわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ええ、本当に久しぶりですね。アルジェリー。この前は確か――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ルピニャ―トとル・テメレールがマジックでちょっと失敗したとき、危うく仕掛けの火薬が爆発しそうになったけど――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "枢機卿はあのお菓子を覚えているかしら。甘くてふんわりとした舌触り、戦闘中の彼女からは想像できないほど、柔らかくて優しい味",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "私たちが生きているのは、神を敬い、仲間たちとアイリスを守るためであって、決して争うためではないはずです",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "たしかに、アイリスとヴィシアが争う必要など無いし、私たちは共に協力し合うべきよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "言い訳はできません。ダンケルクたちの一件はたしかに私にも責任があります",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "鉄血が全て正しいとは言わなくても、アズールレーンにはない合理性が力になるわよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "本国を鉄血に支配され、鉄血の代理人に成り下がった聖座など、アイリスに身を捧げる者が従うべきではありません",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
