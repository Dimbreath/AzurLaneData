return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（鉄血の秘密基地――浮島要塞。基地の施設更新が今終わろうとしている）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "施設の利用方法は手元に送ってあるから熟読するように。それと、最初の訓練がてらに島の施設の点検も行うから、",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "経験論で言うなら、このサロンにいないなら大体「特訓」しているはずであろう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あのコらしいわ。…卿らは引き続き準備を続けなさい、こちらからハインリヒに知らせるわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（このコースを走るのに17秒、ドリフトしながら主砲を撃つつもりなら次の射撃までに照準できる時間ははわずか3秒間――）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ペーター？あ、ちょうどいい所にやってきた！射撃標的を復活させてくれないかな！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そんなに驚くことかしら？いつも訓練に使っているじゃない",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "よぉし、次の戦闘でみんなに特訓の成果を見せちゃうぞー！アイゼンくん！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "卿が私の話を聞かないから行動に出たまでよ。今日の訓練の集合場所は――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
