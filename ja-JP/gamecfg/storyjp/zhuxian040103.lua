return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ううん、元々夜間戦闘は空母よりこっちのほうがやりやすいですから",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……にしても、いくら敵対状態のレッドアクシズとはいえ、同じ艦船であんな戦い方は…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "それってつまり…今の重桜の子たちはセイレーンが化けてたってこと？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
