return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff0000",
			actorName = "？？？",
			say = "あら、バグで作られた「駒」だと思ってたけど、小魚が二匹入ってきてるじゃない。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff0000",
			actorName = "オブザーバー",
			say = "どうかしら？新しい「駒」になってみない？新種の「駒」が混じったら、テストデータはもっと面白くなるわよ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
