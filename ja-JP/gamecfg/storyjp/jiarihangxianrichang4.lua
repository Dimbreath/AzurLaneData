return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "瑞鶴、気持ちはわかるけど、大先輩たちの前で失礼のないようにね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "すぐに使いこなせていたな。まるで戦いには慣れてるようだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
