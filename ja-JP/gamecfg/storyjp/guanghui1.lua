return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "黙って付いてきていらしたのですね。声をかけてくださればよかったのに",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "この場所はつい先日見つけた、私のとっておきの絶景スポットなんです",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "指揮官さまは、陛下や私たちが定期的にお茶会を開いていることをすでにご承知だと思いますが",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "次回のお茶会はぜひこの場所で開催しようかと思っているんです",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "指揮官さまからそう仰っていただけてとても嬉しいですわ。では、さっそく色々と準備のほうを――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あ、ありがとうございます指揮官さま。私どうしても足元が不注意になりがちで……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そろそろランチタイムの時間ですので戻りましょうか。皆も心配しているかもしれませんし",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "来た時とは違って今度は二人で並び歩きながら、彼女のとっておきの絶景スポットを後にした――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
