return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "最後の最後まで粘られましたね…ホロサーバーの力、恐るべしです",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "でも、敵の戦力を減らせないのは厄介ですね。回復されて何回も戦わされると、こっちのほうが先に力尽きますから",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（ときのそら、昨日と違って今日は吹っ切れている感じね…よかった）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そうですね。自分ならともかく、仲間の形をした敵をやっつけるのはストレスがたまりますね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "セイレーンの卑怯さは今日始まったことじゃないからね。帰ってピュリっちに愚痴ってやる！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "セイレーンの待ち伏せに遭って、それを片付けて今探索を再開しようとしたところ。基地の方こそ何かあったの？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
