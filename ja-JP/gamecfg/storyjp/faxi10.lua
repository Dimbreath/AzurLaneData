return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "上層部にも考えはあるでしょう。まだ艤装が完成していないあなたは安全な場所で隠れなくては…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "なぜ戦わない！オレには主砲が一門あるし！それにリシュリュー姉もいる！連中を倒すには十分じゃないか！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "状況は思っていたより複雑……命令に従ってください。あなたの装備が完全になったら、私のところに来て。ずっと待っていますから。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "「船」である私たちの「名前」は人類の偉人から預かった、大いなる期待を込められたもの…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
