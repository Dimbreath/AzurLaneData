return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ボルチモアさんはいかがしますか？参考にさせてくださいませ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "まだ決めていないよ。ただでさえ助っ人がおろそかになってたし、しばらく時間を置いてから考えても良さそうだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ところで、せっかく楽しかったですし、名前の方も何かつけたほうがいいでしょうか…？いつまでも「何々演習」のままでは、混乱しちゃいそうで…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
