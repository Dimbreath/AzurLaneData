	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			say = "「μ兵装」合同演習という名目でもあるライブ大会に向けてそれぞれ準備し始めた艦船たち――",
			flashin = {
				delay = 1,
				dur = 1,
				black = true,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "はい！『サラトガちゃんのボーカルレッスン特別映像vol.1-15』ね！よかったらみんなで見てね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "ああ、ありがたい。こちらのユニットのパフォーマンスがかかっているからな",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "（イラストリアス様、トップヘビーですからこういう動きが苦手なのも頷けますね…）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "今回のステージコンセプトは「宇宙」でいいんじゃないかなー",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "あっそ。言うのは簡単よ…タシュケントたち、そこまでする必要なんてあるわけ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "なるほど、「μ兵装」実験に参加するのは3ユニットで、私たち以外に大鳳とローンのユニット、そしてアイリスからも1ユニット、と",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "リットリオさんも申し込んだようですけどヴェネトさんに引き止められたようです……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			hidePaintObj = true,
			say = "こうして、艦船たちの準備が一歩、また一歩と着実に進んでいった。",
			flashout = {
				dur = 0.5,
				black = true,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "そうね。これで方向性が決まればあとはレッスンとリハーサルで精度を高めていくだけだわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
