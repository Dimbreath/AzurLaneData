return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "この子はウサ吉で、この子はウサ美、どちらもすごくいい子だよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ウサ美とウサ吉、散歩すると部屋のあちこちに跡を残しちゃうの。もうしょうがないなー",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "…でもウサウサたちがこんなに可愛く育っているのを見ると、ベイリーも報われた気持ちになるの！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
