return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そうだよ。みんながピンチの時に急に現れて、ほかの量産型のセイレーンを全部やっつけてくれて驚いたよ…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ジャベリンも信じられなかったけど、でもこのピュリファイア―…ええと、ピュリっちは本当にみんなのことを守ってくれて、だから…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……非常事態だ。それなりの融通は利かせてもらう。ジャベリンこそ油断するでないぞ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
