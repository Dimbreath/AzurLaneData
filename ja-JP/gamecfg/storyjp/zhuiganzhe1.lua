return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "10球超えたあたりから数えるのもバカバカしくなって、正確な数なんて覚えてませんわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ふふ♪わたくしの記憶が確かなら、これで16球目のホームランだわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あらあら。ずいぶんと早い泣き言じゃない？始める前はとっても自信たっぷりな様子だったのに",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "褒めてくれて光栄よ――とはいえ、ボーグの球は全然打ち返せないのだけどね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "良かった。それでは指揮官、エスコートをお願いしてもよろしいかしら？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "冗談めかした口調で言う彼女にうなずくと、そのままリアンダーたちに別れを告げて執務室へと向かった。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
