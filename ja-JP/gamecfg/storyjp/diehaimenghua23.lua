return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（【ワタツミ】も、祭儀もなく…自身がフネか、それともヒトか、その境界線すら薄れている……）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "おかしいわね…ユニオンの潜水艦を捕捉してたのに、もう諦めたの？あと一つの方向もよろしく頼むわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "信濃さん、再び敵の潜水艦の反応だ！たかが潜水艦一隻、この磯風が……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
