return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "戦闘には、ね。……たしかにちょっと邪魔だけど。美しいと思う",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "次の任務もあるし、ここにとどまる余裕はないはずですからっ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
