return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "うちのピロシキの様子を見に行こうかしら…あのもふもふの触り心地が懐かしく……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "確かに私達北方連合の空母に関する運用ノウハウが乏しいのは事実ですわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "今の問題は、北方連合とユニオンがお互いの戦い方をまだ十分理解できていない、ということでしょう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "今度の対抗演習で、一回模擬戦を行ってみてはいかがでしょうか？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
