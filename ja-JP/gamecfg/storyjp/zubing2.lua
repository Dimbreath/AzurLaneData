return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "色々バタバタしたが、足柄はなんとか書類の山から脱出できた。",
			flashout = {
				dur = 0.5,
				black = true,
				alpha = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "すみません！私のドジで指揮官の仕事を邪魔してしまって……二度とこんなことにならないよう注意します！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
