return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "航空写真から判断すると、この海域では二桁にものぼるセイレーン艦隊が展開中ね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ううん、こちらが敵を多く引き付ければ、先輩とボルチモアの隊の相手も相対的に弱くなる……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "まあ、本当はもっと準備をしたかったのですけど、戦場を選べない時もありますしね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
