...
ERROR_MESSAGE = {
	...
	[4201.0] = "交換可能期間外のシリアルコードです",
	[4010.0] = "艦のデータにエラーが発生しました。",
	[4203.0] = "シリアルコードが存在しません",
	[9999.0] = "不明なエラーが発生しました。",
	[4205.0] = "シリアルコード交換に失敗しました",
	[4206.0] = "同じアイテムを2回以上交換できません",
	[3010.0] = "戦闘不能な艦があります。",
	[3020.0] = "解放するためのステージはまだクリアしていません。",
	[4207.0] = "シリアルコード設定（URL）が存在しません",
	[4204.0] = "使用済みのシリアルコードです",
	[4050.0] = "同じ艦です。",
	[4040.0] = "出撃艦隊に編成されていません。",
	[1020.0] = "パスワードに間違いがありました。",
	[4202.0] = "現在の提供元では交換できないシリアルコードです",
	[1012.0] = "数字のみのアカウントです。"
}
SPECIAL_DATE = {
	{
