...
function slot13.serialise_value(slot0, slot1, slot2)
	if slot1 == nil then
		slot1 = ""
	end
...
function slot13.file_load(slot0)
	slot1 = nil
...
function slot13.file_save(slot0, slot1)
	slot2 = nil
...
function slot13.compare_values(slot0, slot1)
...
function slot13.run_test_summary()
	return uv0, uv1
end

function slot13.run_test(slot0, slot1, slot2, slot3, slot4)
	...
	if table.remove({}, 1) == slot3 and uv1(slot6, slot4) then
		slot8 = true
		uv2 = uv2 + 1
	end
...
function slot13.run_test_group(slot0)
...
function slot13.run_script(slot0, slot1)
	if _G.setfenv then
