...
function slot0.init(slot0)
	...
	slot3[1] = slot0:findTF("panel/fleet/1")
	slot3[MULTRES] = slot0:findTF("panel/fleet/2")
	slot1[FleetType.Normal] = {}
	slot3[MULTRES] = slot0:findTF("panel/sub/1")
	slot1[FleetType.Submarine] = {}
	slot0.tfFleets = {}
...
function slot0.initAddButton(slot0, slot1, slot2, slot3, slot4)
	...
	for slot17 = 1, 3, 1 do
		...
		slot24.onReleased:AddListener(function ()
			slot1.shipType = uv1
			slot1.fleet = uv2
			slot1.chapter = uv0.chapter
			slot1.shipVO = uv3
			slot1.fleetIndex = uv4
			slot1.teamType = uv5
		...
		if slot11 then
			...
			onButton(slot0, slot6, function ()
				if #uv0.eliteFleetList[uv1] ~= 0 then
					slot2.content = i18n("battle_preCombatLayer_clear_confirm")

					function slot2.onYes()
						slot1.index = uv1
						slot1.chapterVO = uv0.chapter
			...
			onButton(slot0, slot7, function ()
				if #uv0.eliteFleetList[uv1] ~= 6 then
					if slot0 ~= 0 then
						slot3.content = i18n("battle_preCombatLayer_auto_confirm")
