...
function slot0.init(slot0)
	...
	slot1[1] = slot0:findTF("layout/sort", slot0.panel)
	slot1[2] = slot0:findTF("layout/index", slot0.panel)
	slot1[3] = slot0:findTF("layout/camp", slot0.panel)
	slot1[4] = slot0:findTF("layout/rarity", slot0.panel)
	slot1[5] = slot0:findTF("layout/EquipSkinSort", slot0.panel)
	slot1[6] = slot0:findTF("layout/EquipSkinIndex", slot0.panel)
...
function slot0.didEnter(slot0)
	onButton(slot0, slot0.btnConfirm, function ()
		if uv0.contextData.callback then
			slot1.sort = Clone(uv0.contextData.sort)
			slot1.index = Clone(uv0.contextData.index)
			slot1.camp = Clone(uv0.contextData.camp)
			slot1.rarity = Clone(uv0.contextData.rarity)
			slot1.equipSkinSort = Clone(uv0.contextData.equipSkinSort)
			slot1.equipSkinIndex = Clone(uv0.contextData.equipSkinIndex)
			slot1.equipSkinTheme = Clone(uv0.contextData.equipSkinTheme)
