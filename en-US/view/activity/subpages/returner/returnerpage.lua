...
function slot0.Init(slot0)
	onButton(slot0, slot0.confirmBtn, function ()
		...
		slot4.cmd = ActivityConst.RETURN_AWARD_OP_SET_RETRUNER
		slot4.arg1 = tonumber(slot0)

		uv0._event:emit(ActivityMediator.RETURN_AWARD_OP, {})
	end, SFX_PANEL)
	onButton(slot0, slot0.awrdOverviewBtn, function ()
		slot3.cmd = ActivityConst.RETURN_AWARD_OP_SHOW_RETURNER_AWARD_OVERVIEW
		slot4.tasklist = uv0.config.task_list
		slot4.ptId = pg.activity_template_headhunting[uv0.activity.id].pt
		slot4.totalPt = uv0.pt
		slot3.arg1 = {}
	...
	onButton(slot0, slot0.matchBtn, function ()
		...
		slot2.content = i18n("returner_match_tip")

		function slot2.onYes()
			slot3.activity_id = uv0.activity.id
			slot3.cmd = ActivityConst.RETURN_AWARD_OP_MATCH
...
function slot0.AcceptTasks(slot0)
	slot4.activity_id = slot0.activity.id
	slot4.cmd = ActivityConst.RETURN_AWARD_OP_RETURNER_GET_AWARD
