...
function slot0.listNotificationInterests(slot0)
	...
	slot1[9] = GAME.ACT_NEW_PT_DONE
	slot1[10] = GAME.BEGIN_STAGE_DONE
	slot1[11] = GAME.RETURN_AWARD_OP_DONE
	slot1[12] = VoteProxy.VOTE_ORDER_BOOK_DELETE
	slot1[13] = VoteProxy.VOTE_ORDER_BOOK_UPDATE
	slot1[14] = GAME.REMOVE_LAYERS
	slot1[15] = GAME.SEND_MINI_GAME_OP_DONE
	slot1[16] = GAME.MONOPOLY_AWARD_DONE
