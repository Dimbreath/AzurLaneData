...
function slot0.didEnter(slot0)
	...
	slot0.InitFacility(slot0._map, slot0._upper, "shudian", function ()
		uv0.upgradePanel:Set(uv0.activity, 5)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "youxidian", function ()
		uv0.upgradePanel:Set(uv0.activity, 6)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "moxingdian", function ()
		uv0.upgradePanel:Set(uv0.activity, 7)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "kafeiting", function ()
		uv0.upgradePanel:Set(uv0.activity, 8)
	end)
	slot0.InitFacility(slot0._map, slot0._upper, "jiejiting", function ()
