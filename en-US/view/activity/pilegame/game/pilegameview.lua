...
function slot0.SetUI(slot0, slot1)
	...
	slot2[1] = slot0._tf:Find("AD/score_panel/heart1")
	slot2[2] = slot0._tf:Find("AD/score_panel/heart2")
	slot2[MULTRES] = slot0._tf:Find("AD/score_panel/heart3")
	slot0.heats = {}
...
function slot0.OnEnterGame(slot0)
	...
	onButton(slot0, slot0.helpBtn, function ()
		...
		slot2.helps = pg.gametip.pile_game_notice.tip
...
function slot0.OnStartDrop(slot0, slot1, slot2, slot3)
	if slot3 then
		slot4 = slot0.manjuuAnim

		slot4.SetBool(slot4, "despair", PileGameController.DROP_AREA_WARN == slot2)
	else
...
function slot0.OnShake(slot0, slot1)
	slot5.x = getAnchoredPosition(slot0.anikiAnim).x + slot1
...
function slot0.OnCollapse(slot0, slot1, slot2, slot3)
	...
	slot6[2] = function (slot0, slot1)
		table.sort(_.values(uv0.items), function (slot0, slot1)
