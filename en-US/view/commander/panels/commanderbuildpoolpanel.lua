...
function slot0.Ctor(slot0, slot1, slot2)
	...
	onButton(slot0.parent, slot0.startBtn, function ()
		...
		slot3.content = i18n("commander_select_box_tip", #uv0.selected)
	...
	slot4[1] = slot0._tf:Find("frame/bg/content/list/1/icon/iconImg"):GetComponent(typeof(Image)).sprite
	slot4[2] = slot0._tf:Find("frame/bg/content/list/2/icon/iconImg"):GetComponent(typeof(Image)).sprite
	slot4[3] = slot0._tf:Find("frame/bg/content/list/3/icon/iconImg"):GetComponent(typeof(Image)).sprite
	slot0.sprites = {}
end
...
function slot0.AutoSelect(slot0)
	...
	for slot7 = 1, uv0 - #slot0.selected, 1 do
		if function ()
			slot0 = nil
