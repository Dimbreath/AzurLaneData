...
function slot1(slot0)
	...
	function (slot0)
		...
		slot1[1] = findTF(slot0._go, "info/tags/new")
		slot1[MULTRES] = findTF(slot0._go, "info/tags/e")
		slot0.tags = {}
		...
		Update = function (slot0, slot1)
			slot0.uiList:make(function (slot0, slot1, slot2)
				if slot0 == UIItemList.EventUpdate then
					...
					LoadImageSpriteAsync("medal/s_" .. Trophy.New({}):getConfig("icon"), findTF(slot2, "icon"), true)
				end
			end)
