...
function slot0.init(slot0)
	...
	slot5[1] = slot0.rightPanelBlurBg
	slot4.pbList = {}
	slot4.overlayType = LayerWeightConst.OVERLAY_UI_ADAPT
...
function slot0.createMemberCard(slot0, slot1)
	...
	function slot2.update(slot0, slot1, slot2, slot3)
		...
		slot6.configId = slot1.icon
		slot6.skin_id = slot1.skinId
		slot6.propose = slot1.proposeTime
...
function slot0.loadPainting(slot0, slot1)
	...
	slot5.configId = slot1.icon
	slot5.skin_id = slot1.skinId

	pg.UIMgr.GetInstance():LoadingOn()
	setPaintingPrefabAsync(slot0.paintingTF, Ship.New({}):getPainting(), "chuanwu", function ()
		pg.UIMgr.GetInstance():LoadingOff()
	end)
...
function slot0.showAppointPanel(slot0, slot1)
	...
	slot9.configId = slot1.icon
	slot9.skin_id = slot1.skinId
...
function slot0.showFirePanel(slot0, slot1)
	...
	onButton(slot0, slot0.fireconfirmBtn, function ()
		...
		slot2.content = i18n("guild_fire_tip")
...
function slot0.showImpeachPanel(slot0, slot1)
	...
	onButton(slot0, slot0.impeachconfirmBtn, function ()
		...
		slot2.content = i18n("guild_impeach_tip")
...
slot3 = {}
slot4.tag = i18n("friend_resume_ship_count")
slot3[1] = {
	value = "shipCount",
	type = 1
}
slot4.tag = i18n("friend_resume_collection_rate")
slot4.value = {
	"collectionCount"
}
slot3[2] = {
...
slot4.tag = i18n("friend_resume_attack_count")
slot3[3] = {
	value = "attackCount",
	type = 1
}
slot4.tag = i18n("friend_resume_attack_win_rate")
slot4.value = {
	"attackCount",
	"winCount"
}
...
slot4.tag = i18n("friend_resume_manoeuvre_count")
slot3[5] = {
	value = "pvp_attack_count",
	type = 1
}
slot4.tag = i18n("friend_resume_manoeuvre_win_rate")
slot4.value = {
	"pvp_attack_count",
	"pvp_win_count"
}
...
slot4.tag = i18n("friend_event_count")
slot3[7] = {
...
function slot0.showInfoPanel(slot0, slot1)
	...
	slot6.configId = slot2.icon
	slot6.skin_id = slot2.skinId
