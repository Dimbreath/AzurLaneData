...
function slot0.getGradeList(slot0)
	slot1.activityMaxScore = slot0._activityMaxScore
	slot1.activityMaxLevel = slot0._activityMaxLevel
	slot1.seasonMaxScore = slot0._seasonMaxScore
	slot1.seasonMaxLevel = slot0._seasonMaxLevel
