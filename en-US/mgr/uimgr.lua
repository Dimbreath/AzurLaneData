...
function slot1.Init(slot0, slot1)
	...
	slot7[1] = slot3:GetComponent("BlurOptimized")
	slot7[MULTRES] = slot3:GetComponent("UIStaticBlur")
	slot5[uv0.CameraLevel] = {}
	slot7[1] = slot4:GetComponent("BlurOptimized")
	slot7[MULTRES] = slot4:GetComponent("UIStaticBlur")
	slot5[uv0.CameraOverlay] = {}
	slot0.cameraBlurs = {}
	slot5[uv0.CameraLevel] = 0
	slot5[uv0.CameraOverlay] = 0
	...
	slot6[4] = function (slot0)
		uv0:SetActive(true)

		uv1._loadPanel = LoadingPanel.New(slot0)
	end

	slot6[5] = function (slot0)
...
function slot1.UnOverlayPanel(slot0, slot1, slot2)
	slot3 = uv0.LayerWeightMgr.GetInstance()

	slot3.DelFromOverlay(slot3, slot1, slot2 or slot0.UIMain)
end
...
function slot1.UnblurPanel(slot0, slot1, slot2)
	...
	slot3 = uv2.LayerWeightMgr.GetInstance()
