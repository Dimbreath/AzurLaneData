...
pg.commander_skill_template = {
	...
	[40022] = {
		...
		exp = 3,
		prev_id = 40021,
		desc = "When assigned as the Staff Cat to a fleet that has at least 1 BB, BC, or BBV: 15.0% chance to launch a preemptive volley when engaging an enemy Vanguard Fleet. The DMG of the volley is based on the Directives stat as well as the Level and Fleet Power of b",
		id = 40022,
		icon = "4002",
		lv = 2,
		effect_tactic = {
