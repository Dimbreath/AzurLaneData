...
slot1.main_navalAcademyScene_full = {
...
slot1.ship_formationUI_fleetName_world = {
	tip = "大世界舰队",
...
slot2.tip = {}
slot1.world_help_tip = {
	key = "world_help_tip"
}
slot1.world_stamina_exchange = {
	tip = "行动力不足，是否花费<icon name=oil w=0.7 h=0.7/>$1兑换行动力*$2？",
	key = "world_stamina_exchange"
}
slot1.world_stamina_not_enough = {
	tip = "行动力不足",
	key = "world_stamina_not_enough"
}
slot1.world_map_dangerous = {
	tip = "该海域过于危险，禁止进入",
	key = "world_map_dangerous"
}
slot1.world_item_allocate_panel_fleet_info_text = {
...
slot1.ship_remould_warning_201514 = {
...
slot2.tip = {}
slot1.help_chunjie_jiulou = {
	key = "help_chunjie_jiulou"
}
slot1.special_animal1 = {
...
slot2.tip = {}
slot1.lanternRiddles_gametip = {
	key = "lanternRiddles_gametip"
}
slot1.LanternRiddle_wait_time_tip = {
	tip = "Next Attempt: ",
