...
require("Mod/Battle/Data/Weapon/BattleFleetSonar")
...
require("Mod/Battle/Data/Environment/BattleEnvironmentBehaviourPlaySFX")
...
require("Mod/Battle/View/UI/FormationPanel/BattleSubmarineView")
