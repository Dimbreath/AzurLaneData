...
function slot7.SetTemplate(slot0, slot1, slot2)
	...
	uv2.SetCurrent(slot0, "srcShipType", slot0._tmpData.type)
...
function slot7.InitCldComponent(slot0)
	...
	slot1.type = uv1.CldType.SHIP
	slot1.IFF = slot0:GetIFF()
	slot1.UID = slot0:GetUniqueID()
	slot1.Mass = uv1.CldMass.L2
