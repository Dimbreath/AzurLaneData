...
function slot1.Active(slot0, slot1)
	...
	slot3.X1 = slot0._randomPoint.X1 + slot2.x
	slot3.X2 = slot0._randomPoint.X2 + slot2.x
	slot3.Z1 = slot0._randomPoint.Z1 + slot2.z
	slot3.Z2 = slot0._randomPoint.Z2 + slot2.z
