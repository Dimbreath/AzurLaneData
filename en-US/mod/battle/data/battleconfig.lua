...
slot0.AIM_BIAS_FLEET_RANGE_MOD = 0.15
slot0.AIM_BIAS_SUB_RANGE_MOD = 1.5
slot0.AIM_BIAS_MONSTER_RANGE_MOD = 0.5
slot0.AIM_BIAS_DECAY_MOD = 0.02
slot0.AIM_BIAS_DECAY_MOD_MONSTER = 0.01
slot0.AIM_BIAS_DECAY_BASE = 0
slot0.AIM_BIAS_DECAY_SUB_CONST = 50
slot0.AIM_BIAS_ENEMY_INIT_TIME = 3
