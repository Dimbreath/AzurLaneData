...
function slot0.LoadBoatPart(slot0, slot1, slot2, slot3)
	slot4 = {}
	slot5[2] = Vector3(0, 250, 0)
	slot5[MULTRES] = Vector3(1, 1, 1)
	slot4[1] = {
		"addition"
	}
	slot5[2] = Vector3(145, 290, 0)
	slot5[MULTRES] = Vector3(0, 0, 0)
	slot4[2] = {
		"chat"
	}
	slot5[2] = Vector3(0, 130, 0)
	slot5[MULTRES] = Vector3(1, 1, 1)
	slot4[3] = {
		"click"
	}
	slot5[2] = Vector3(145, 290, 0)
	slot5[MULTRES] = Vector3(2, 2, 2)
	slot4[4] = {
		"intimacy"
	}
	slot5[2] = Vector3(145, 290, 0)
