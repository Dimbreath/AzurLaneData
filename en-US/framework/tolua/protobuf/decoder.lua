	...
	if slot1 then
		...
		return function (slot0, slot1, slot2, slot3, slot4)
			...
			while true do
				...
				if slot8:_InternalParse(slot0, slot1, slot7) ~= slot7 then
...
function _FieldSkipper()
	slot0[1] = _SkipVarint
	slot0[2] = _SkipFixed64
	slot0[3] = _SkipLengthDelimited
	slot0[4] = _SkipGroup
	slot0[5] = _EndGroup
	slot0[6] = _SkipFixed32
	slot0[7] = _RaiseInvalidWireType
	slot0[8] = _RaiseInvalidWireType
	WIRETYPE_TO_SKIPPER = {}
	slot0 = uv0.byte
	slot1 = uv0.sub
