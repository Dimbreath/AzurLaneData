return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The closer we get to the core sector, the more intense the Sirens are fighting back...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "We've besieged the Sirens on all fronts, and this is their last holdout. I'd be worried if they didn't try to put up a fight.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "The harder the prey struggles before its demise, the sweeter the thrill of the hunt.~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yes, a struggle is all this will amount to. We've already secured zone after zone, just like we planned.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Once we finish establishing the Outpost, We'll have a foothold in the heart of the NA Ocean.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Everything’s been going smoothly. At this rate, we'll be done with the first phase of the operation soon.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Then, all that remains is to launch an all-out attack against the Sirens.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "No smoke without fire, as they say. If the Eagle Union is sending fleets to investigate, they must know something we don't.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Let’s not overthink things and just focus on the battle, since we have problems of our own. Hood, take a look at this.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "This message arrived at about the same time as Her Majesty’s transmission. Extreme weather suddenly kicked up around the Outpost.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "More of this abnormal weather? ...I wonder if this is due to a Mirror Sea. Considering how we're practically in the Sirens’ front yard...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I'll look into it. Hood, please take command of the fleet.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "It shall be done. Best of luck.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
